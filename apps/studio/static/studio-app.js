...
(() => {
	...
	for (let t = 0, n = 0; t < e.length; t++) (t % 2 ? g : h).push(n += e[t]);
})();
function _(e) {
	if (e < 768) return !1;
	for (let t = 0, n = h.length;;) {
		let r = t + n >> 1;
		if (e < h[r]) n = r;
		else if (e >= g[r]) t = r + 1;
		else return !0;
...
function b(e, t, n) {
	...
	for (t += ae(r); t < e.length;) {
		let i = ne(e, t);
		if (r == y || i == y || n && _(i)) t += ae(i), r = i;
		else if (v(i)) {
			let n = 0, r = t - 2;
			for (; r >= 0 && v(ne(e, r));) n++, r -= 2;
			if (n % 2 == 0) break;
			t += 2;
		} else break;
	}
...
var x = class e {
	...
	replace(e, t, n) {
		[e, t] = me(this, e, t);
		let r = [];
		return this.decompose(0, e, r, 2), n.length && n.decompose(0, n.length, r, 3), this.decompose(t, this.length, r, 1), oe.from(r, this.length - (t - e) + n.length);
	}
	append(e) {
	...
	slice(e, t = this.length) {
		[e, t] = me(this, e, t);
		let n = [];
		return this.decompose(e, t, n, 0), oe.from(n, t - e);
	}
	eq(e) {
		if (e == this) return !0;
		if (e.length != this.length || e.lines != this.lines) return !1;
		let t = this.scanIdentical(e, 1), n = this.length - this.scanIdentical(e, -1), r = new ue(this), i = new ue(e);
		for (let e = t, a = t;;) {
	...
	static of(t) {
		...
		return t.length == 1 && !t[0] ? e.empty : t.length <= 32 ? new S(t) : oe.from(S.split(t, []));
	}
}, S = class e extends x {
	constructor(e, t = se(e)) {
	...
	lineInner(e, t, n, r) {
		for (let i = 0;; i++) {
			...
			if ((t ? n : o) >= e) return new pe(r, o, n, a);
			r = o + 1, n++;
		}
	}
	decompose(t, n, r, i) {
		let a = t <= 0 && n >= this.length ? this : new e(le(this.text, t, n), Math.min(n, this.length) - Math.max(0, t));
		if (i & 1) {
			let t = r.pop(), n = ce(a.text, t.text.slice(), 0, a.length);
	...
	replace(t, n, r) {
		...
		[t, n] = me(this, t, n);
		let i = ce(this.text, ce(r.text, le(this.text, 0, t)), n), a = this.length + r.length - (n - t);
		return i.length <= 32 ? new e(i, a) : oe.from(e.split(i, []), a);
	}
	...
	replace(t, n, r) {
		if ([t, n] = me(this, t, n), r.lines < this.lines) for (let i = 0, a = 0; i < this.children.length; i++) {
			let o = this.children[i], s = a + o.length;
			if (t >= a && n <= s) {
...
var ue = class {
	...
	constructor(e, t, n) {
		this.value = "", this.done = !1, this.cursor = new ue(e, t > n ? -1 : 1), this.pos = t > n ? e.length : 0, this.from = Math.min(t, n), this.to = Math.max(t, n);
	}
	nextInner(e, t) {
...
typeof Symbol < "u" && (x.prototype[Symbol.iterator] = function() {
	return this.iter();
}, ue.prototype[Symbol.iterator] = de.prototype[Symbol.iterator] = fe.prototype[Symbol.iterator] = function() {
	return this;
});
var pe = class {
	constructor(e, t, n, r) {
...
function w(e, t) {
	let n = e.charCodeAt(t);
	if (!ge(n) || t + 1 == e.length) return n;
	let r = e.charCodeAt(t + 1);
	return he(r) ? (n - 55296 << 10) + (r - 56320) + 65536 : n;
}
function _e(e) {
	...
	filter(t) {
		let n = [], r = [], i = [], a = new De(this);
			...
			for (; o < s || o == s && a.len == 0;) {
				...
				T(n, e, t), t > 0 && Ce(r, n, a.text), a.forward(e), o += e;
			}
			let c = t[e++];
			for (; o < c;) {
				if (a.done) break done;
	...
	static of(t, n, r) {
		...
		function l(t) {
			if (Array.isArray(t)) for (let e of t) l(e);
				...
				let u = l ? typeof l == "string" ? x.of(l.split(r || ye)) : l : x.empty, d = u.length;
				if (e == s && d == 0) return;
				e < o && c(), e > o && T(i, e - o, -1), T(i, s - e, d), Ce(a, i, u), o = s;
			}
		}
		return l(t), c(!s), s;
	}
...
function Te(e, t, n, r = !1) {
	...
	for (let e = -1;;) if (o.done && s.len || s.done && o.len) throw Error("Mismatched change set lengths");
		...
		for (T(i, s.ins, -1); t;) {
			...
			o.ins >= 0 && e < o.i && o.len <= n && (T(i, 0, o.ins), a && Ce(a, i, o.text), e = o.i), o.forward(n), t -= n;
		}
		s.next();
	} else if (o.ins >= 0) {
		let t = 0, n = o.len;
		...
		T(i, t, e < o.i ? o.ins : 0), a && e < o.i && Ce(a, i, o.text), e = o.i, o.forward(o.len - n);
...
function Ee(e, t, n = !1) {
	...
	for (let e = !1;;) if (a.done && o.done) return i ? Se.createSet(r, i) : xe.create(r);
	...
	else if (o.len == 0 && !o.done) T(r, 0, o.ins, e), i && Ce(i, r, o.text), o.next();
		...
		if (a.ins == -1) {
			...
			T(r, t, n, e), i && n && Ce(i, r, o.text);
		} else o.ins == -1 ? (T(r, a.off ? 0 : a.len, t, e), i && Ce(i, r, a.textBit(t))) : (T(r, a.off ? 0 : a.len, o.off ? 0 : o.ins, e), i && !o.off && Ce(i, r, o.text));
	...
	dynamicSlot(e) {
		...
		return {
			...
			reconfigure: (e, o) => {
				...
				if (c != null) {
					let r = Ke(o, c);
					if (this.dependencies.every((t) => t instanceof D ? o.facet(t) === e.facet(t) : t instanceof O ? o.field(t, !1) == e.field(t, !1) : !0) || (a ? Ne(s = t(e), r, n) : n(s = t(e), r))) return e.values[i] = r, 0;
				} else s = t(e);
...
var Ie = /*@__PURE__*/ D.define({ static: !0 }), O = class e {
	constructor(e, t, n, r, i) {
...
var ze = {
	highest: /*@__PURE__*/ Re(Le.highest),
	high: /*@__PURE__*/ Re(Le.high),
	default: /*@__PURE__*/ Re(Le.default),
	low: /*@__PURE__*/ Re(Le.low),
	lowest: /*@__PURE__*/ Re(Le.lowest)
}, Be = class {
	constructor(e, t) {
	...
	static resolve(t, n, r) {
		...
		for (let e of We(t, n, o)) e instanceof O ? i.push(e) : (a[e.facet.id] || (a[e.facet.id] = [])).push(e);
...
function We(e, t, n) {
	...
	function a(e, o) {
		...
		if (s != null) {
			if (s <= o) return;
			let t = r[s].indexOf(e);
			t > -1 && r[s].splice(t, 1), e instanceof He && n.delete(e.compartment);
		}
		...
		} else if (e instanceof Be) a(e.inner, e.prec);
		else if (e instanceof O) r[o].push(e), e.provides && a(e.provides, o);
		else if (e instanceof Me) r[o].push(e), e.facet.extensions && a(e.facet.extensions, Le.default);
		else {
			let t = e.extension;
	...
	return a(e, Le.default), r.reduce((e, t) => e.concat(t));
}
function Ge(e, t) {
	if (t & 1) return 2;
...
var qe = /*@__PURE__*/ D.define(), Je = /*@__PURE__*/ D.define({
	combine: (e) => e.some((e) => e),
	static: !0
}), Ye = /*@__PURE__*/ D.define({
	combine: (e) => e.length ? e[0] : void 0,
	static: !0
}), Xe = /*@__PURE__*/ D.define(), Ze = /*@__PURE__*/ D.define(), Qe = /*@__PURE__*/ D.define(), $e = /*@__PURE__*/ D.define({ combine: (e) => e.length ? e[0] : !1 }), et = class {
	constructor(e, t) {
...
rt.time = /*@__PURE__*/ et.define(), rt.userEvent = /*@__PURE__*/ et.define(), rt.addToHistory = /*@__PURE__*/ et.define(), rt.remote = /*@__PURE__*/ et.define();
function it(e, t) {
	let n = [];
	for (let r = 0, i = 0;;) {
		let a, o;
...
function at(e, t, n) {
	...
	return n ? (r = t.changes, i = Se.empty(t.changes.length), a = e.changes.compose(t.changes)) : (r = t.changes.map(e.changes), i = e.changes.mapDesc(t.changes, !0), a = e.changes.compose(r)), {
		...
		effects: k.mapEffects(e.effects, r).concat(k.mapEffects(t.effects, i)),
...
function ot(e, t, n) {
	...
	return t.userEvent && (i = i.concat(rt.userEvent.of(t.userEvent))), {
		changes: t.changes instanceof Se ? t.changes : Se.of(t.changes || [], n, e.facet(Ye)),
...
function st(e, t, n) {
	let r = ot(e, t.length ? t[0] : {}, e.doc.length);
	t.length && t[0].filter === !1 && (n = !1);
	for (let i = 1; i < t.length; i++) {
		t[i].filter === !1 && (n = !1);
		let a = !!t[i].sequential;
		r = at(r, ot(e, t[i], a ? r.changes.newLength : e.doc.length), a);
	}
	let i = rt.create(e, r.changes, r.selection, r.effects, r.annotations, r.scrollIntoView);
	return lt(n ? ct(i) : i);
}
function ct(e) {
	let t = e.startState, n = !0;
	for (let r of t.facet(Xe)) {
		let t = r(e);
		if (t === !1) {
			n = !1;
			break;
		}
		Array.isArray(t) && (n = n === !0 ? t : it(n, t));
	}
	if (n !== !0) {
		let r, i;
		...
		e = rt.create(t, r, e.selection && e.selection.map(i), k.mapEffects(e.effects, i), e.annotations, e.scrollIntoView);
	}
	let r = t.facet(Ze);
	for (let n = r.length - 1; n >= 0; n--) {
		let i = r[n](e);
		e = i instanceof rt ? i : Array.isArray(i) && i.length == 1 && i[0] instanceof rt ? i[0] : st(t, dt(i), !1);
	}
	return e;
}
function lt(e) {
	let t = e.startState, n = t.facet(Qe), r = e;
	for (let i = n.length - 1; i >= 0; i--) {
		let a = n[i](e);
		a && Object.keys(a).length && (r = at(r, ot(t, a, e.changes.newLength), !0));
	}
	return r == e ? e : rt.create(t, e.changes, e.selection, r.effects, r.annotations, r.scrollIntoView);
}
var ut = [];
function dt(e) {
	return e == null ? ut : Array.isArray(e) ? e : [e];
}
var A = /*@__PURE__*/ (function(e) {
	return e[e.Word = 0] = "Word", e[e.Space = 1] = "Space", e[e.Other = 2] = "Other", e;
})(A ||= {}), ft = /[\u00df\u0587\u0590-\u05f4\u0600-\u06ff\u3040-\u309f\u30a0-\u30ff\u3400-\u4db5\u4e00-\u9fcc\uac00-\ud7af]/, pt;
try {
	pt = /*@__PURE__*/ RegExp("[\\p{Alphabetic}\\p{Number}_]", "u");
} catch {}
function mt(e) {
	if (pt) return pt.test(e);
	for (let t = 0; t < e.length; t++) {
		let n = e[t];
		if (/\w/.test(n) || n > "" && (n.toUpperCase() != n.toLowerCase() || ft.test(n))) return !0;
	}
	return !1;
}
function ht(e) {
...
var j = class e {
	constructor(e, t, n, r, i, a) {
		...
		for (let e = 0; e < this.config.dynamicSlots.length; e++) Ge(this, e << 1);
	...
	applyTransaction(t) {
		...
		for (let e of t.effects) e.is(Ve.reconfigure) ? (n &&= (i = /* @__PURE__ */ new Map(), n.compartments.forEach((e, t) => i.set(t, e)), null), i.set(e.value.compartment, e.value.extension)) : e.is(k.reconfigure) ? (n = null, r = e.value) : e.is(k.appendConfig) && (n = null, r = dt(r).concat(e.value));
		let a;
		n ? a = t.startState.values.slice() : (n = Ue.resolve(r, i, this), a = new e(n, this.doc, this.selection, n.dynamicSlots.map(() => null), (e, t) => t.reconfigure(e, this), null).values);
		let o = t.startState.facet(Je) ? t.newSelection : t.newSelection.asSingle();
	...
	changeByRange(e) {
		...
		for (let n = 1; n < t.ranges.length; n++) {
			...
			let l = r.mapDesc(s, !0);
			i.push(o.range.map(l)), r = r.compose(c), a = k.mapEffects(a, c).concat(k.mapEffects(dt(o.effects), l));
		}
		return {
			changes: r,
	...
	toText(t) {
		return x.of(t.split(this.facet(e.lineSeparator) || ye));
	}
	...
	facet(e) {
		...
		return t == null ? e.default : (Ge(this, t), Ke(this, t));
	}
	toJSON(e) {
		let t = {
			doc: this.sliceDoc(),
	...
	static create(t = {}) {
		let n = Ue.resolve(t.extensions || [], /* @__PURE__ */ new Map()), r = t.doc instanceof x ? t.doc : x.of((t.doc || "").split(n.staticFacet(e.lineSeparator) || ye)), i = t.selection ? t.selection instanceof E ? t.selection : E.single(t.selection.anchor, t.selection.head) : E.single(0);
		return ke(i, r.length), n.staticFacet(Je) || (i = i.asSingle()), new e(n, r, i, n.dynamicSlots.map(() => null), (e, t) => t.create(e), null);
	}
	get tabSize() {
	...
	languageDataAt(e, t, n = -1) {
		let r = [];
		for (let i of this.facet(qe)) for (let a of i(this, t, n)) Object.prototype.hasOwnProperty.call(a, e) && r.push(a[e]);
		return r;
	}
	charCategorizer(e) {
		let t = this.languageDataAt("wordChars", e);
		return ht(t.length ? t[0] : "");
	}
	wordAt(e) {
...
j.allowMultipleSelections = Je, j.tabSize = /*@__PURE__*/ D.define({ combine: (e) => e.length ? e[0] : 4 }), j.lineSeparator = Ye, j.readOnly = $e, j.phrases = /*@__PURE__*/ D.define({ compare(e, t) {
	let n = Object.keys(e), r = Object.keys(t);
	return n.length == r.length && n.every((n) => e[n] == t[n]);
} }), j.languageData = qe, j.changeFilter = Xe, j.transactionFilter = Ze, j.transactionExtender = Qe, Ve.reconfigure = /*@__PURE__*/ k.define();
function gt(e, t, n = {}) {
	let r = {};
...
var _t = class {
	...
	range(e, t = e) {
		return yt.create(e, t, this);
	}
};
_t.prototype.startSide = _t.prototype.endSide = 0, _t.prototype.point = !1, _t.prototype.mapMode = be.TrackDel;
function vt(e, t) {
...
var xt = class e {
	...
	update(t) {
		...
		if (r && (n = n.slice().sort(bt)), this.isEmpty) return n.length ? e.of(n) : this;
		let s = new Tt(this, null, -1).goto(0), c = 0, l = [], u = new Ct();
		...
		} else s.rangeIndex == 1 && s.chunkIndex < this.chunk.length && (c == n.length || this.chunkEnd(s.chunkIndex) < n[c].from) && (!o || i > this.chunkEnd(s.chunkIndex) || a < this.chunkPos[s.chunkIndex]) && u.addChunk(this.chunkPos[s.chunkIndex], this.chunk[s.chunkIndex]) ? s.nextChunk() : ((!o || i > s.to || a < s.from || o(s.from, s.to, s.value)) && (u.addInner(s.from, s.to, s.value) || l.push(yt.create(s.from, s.to, s.value))), s.next());
	...
	iter(e = 0) {
		return Et.from([this]).goto(e);
	}
	get isEmpty() {
		return this.nextLayer == this;
	}
	static iter(e, t = 0) {
		return Et.from(e).goto(t);
	}
	static compare(e, t, n, r, i = -1) {
		let a = e.filter((e) => e.maxPoint > 0 || !e.isEmpty && e.maxPoint >= i), o = t.filter((e) => e.maxPoint > 0 || !e.isEmpty && e.maxPoint >= i), s = wt(a, o, n), c = new Ot(a, s, i), l = new Ot(o, s, i);
	...
	static eq(e, t, n = 0, r) {
		...
		let o = wt(i, a), s = new Ot(i, o, 0).goto(n), c = new Ot(a, o, 0).goto(n);
		for (;;) {
			if (s.to != c.to || !At(s.active, c.active) || s.point && (!c.point || !vt(s.point, c.point))) return !1;
			if (s.to > r) return !0;
			s.next(), c.next();
		}
	}
	static spans(e, t, n, r, i = -1) {
		let a = new Ot(e, null, i).goto(t), o = t, s = a.openStart;
		for (;;) {
	...
	static of(e, t = !1) {
		let n = new Ct();
		for (let r of e instanceof yt ? [e] : t ? St(e) : e) n.add(r.from, r.to, r.value);
		return n.finish();
	}
	static join(t) {
...
function St(e) {
	if (e.length > 1) for (let t = e[0], n = 1; n < e.length; n++) {
		let r = e[n];
		if (bt(t, r) > 0) return e.slice().sort(bt);
		t = r;
	}
	return e;
}
...
var Ct = class e {
	finishChunk(e) {
		this.chunks.push(new xt(this.from, this.to, this.value, this.maxPoint)), this.chunkPos.push(this.chunkStart), this.chunkStart = -1, this.setMaxPoint = Math.max(this.setMaxPoint, this.maxPoint), this.maxPoint = -1, e && (this.from = [], this.to = [], this.value = []);
	}
	constructor() {
...
var Tt = class {
	...
	static from(t, n = null, r = -1) {
		let i = [];
		for (let e = 0; e < t.length; e++) for (let a = t[e]; !a.isEmpty; a = a.nextLayer) a.maxPoint >= r && i.push(new Tt(a, n, r, e));
	...
	goto(e, t = -1e9) {
		...
		for (let e = this.heap.length >> 1; e >= 0; e--) Dt(this.heap, e);
	...
	next() {
		if (this.heap.length == 0) this.from = this.to = 1e9, this.value = null, this.rank = -1;
			...
			let e = this.heap[0];
			this.from = e.from, this.to = e.to, this.value = e.value, this.rank = e.rank, e.value && e.next(), Dt(this.heap, 0);
		}
	}
};
function Dt(e, t) {
...
var Ot = class {
	constructor(e, t, n) {
		this.minPoint = n, this.active = [], this.activeTo = [], this.activeRank = [], this.minActive = -1, this.point = null, this.pointFrom = 0, this.pointRank = 0, this.to = -1e9, this.endSide = 0, this.openStart = -1, this.cursor = Et.from(e, t, n);
	}
	goto(e, t = -1e9) {
	...
	removeActive(e) {
		jt(this.active, e), jt(this.activeTo, e), jt(this.activeRank, e), this.minActive = Nt(this.active, this.activeTo);
	}
	addActive(e) {
		let t = 0, { value: n, to: r, rank: i } = this.cursor;
		for (; t < this.activeRank.length && (i - this.activeRank[t] || r - this.activeTo[t]) > 0;) t++;
		Mt(this.active, t, n), Mt(this.activeTo, t, r), Mt(this.activeRank, t, i), e && Mt(e, t, this.cursor.from), this.minActive = Nt(this.active, this.activeTo);
	}
	next() {
...
function kt(e, t, n, r, i, a) {
	...
	for (let t = !1;;) {
		...
		if (e.point || n.point ? (e.point && n.point && vt(e.point, n.point) && At(e.activeForPoint(e.to), n.activeForPoint(n.to)) || a.comparePoint(s, d, e.point, n.point), t = !1) : (t && a.boundChange(s), d > s && !At(e.active, n.active) && a.compareRange(s, d, e.active, n.active), l && d < o && (r || e.openEnd(u) != n.openEnd(u)) && (t = !0)), u > o) break;
		s = u, i <= 0 && e.next(), i >= 0 && n.next();
	}
}
function At(e, t) {
	if (e.length != t.length) return !1;
	for (let n = 0; n < e.length; n++) if (e[n] != t[n] && !vt(e[n], t[n])) return !1;
	return !0;
}
function jt(e, t) {
...
for (var It = "ͼ", Lt = typeof Symbol > "u" ? "__ͼ" : Symbol.for(It), Rt = typeof Symbol > "u" ? "__styleSet" + Math.floor(Math.random() * 1e8) : Symbol("styleSet"), zt = typeof globalThis < "u" ? globalThis : typeof window < "u" ? window : {}, Bt = class {
	constructor(e, t) {
		this.rules = [];
		let { finish: n } = t || {};
		function r(e) {
	...
	static newName() {
		let e = zt[Lt] || 1;
		return zt[Lt] = e + 1, It + e.toString(36);
	}
	static mount(e, t, n) {
		let r = e[Rt], i = n && n.nonce;
		r ? i && r.setNonce(i) : r = new Ht(e, i), r.mount(Array.isArray(t) ? t : [t], e);
	}
}, Vt = /* @__PURE__ */ new Map(), Ht = class {
	constructor(e, t) {
		let n = e.ownerDocument || e, r = n.defaultView;
		if (!e.head && e.adoptedStyleSheets && r.CSSStyleSheet) {
			let t = Vt.get(n);
			if (t) return e[Rt] = t;
			this.sheet = new r.CSSStyleSheet(), Vt.set(n, this);
		} else this.styleTag = n.createElement("style"), t && this.styleTag.setAttribute("nonce", t);
		this.modules = [], e[Rt] = this;
	}
	mount(e, t) {
	...
	221: "}",
	222: "\""
}, Gt = typeof navigator < "u" && /Mac/.test(navigator.platform), Kt = typeof navigator < "u" && /MSIE \d|Trident\/(?:[7-9]|\d{2,})\..*rv:(\d+)/.exec(navigator.userAgent), N = 0; N < 10; N++) Ut[48 + N] = Ut[96 + N] = String(N);
for (var N = 1; N <= 24; N++) Ut[N + 111] = "F" + N;
for (var N = 65; N <= 90; N++) Ut[N] = String.fromCharCode(N + 32), Wt[N] = String.fromCharCode(N);
for (var qt in Ut) Wt.hasOwnProperty(qt) || (Wt[qt] = Ut[qt]);
function Jt(e) {
	var t = !(Gt && e.metaKey && e.shiftKey && !e.ctrlKey && !e.altKey || Kt && e.shiftKey && e.key && e.key.length == 1 || e.key == "Unidentified") && e.key || (e.shiftKey ? Wt : Ut)[e.keyCode] || e.key || "Unidentified";
...
function P() {
	...
	for (; t < arguments.length; t++) Yt(e, arguments[t]);
	return e;
}
function Yt(e, t) {
	if (typeof t == "string") e.appendChild(document.createTextNode(t));
		...
		else if (Array.isArray(t)) for (var n = 0; n < t.length; n++) Yt(e, t[n]);
...
var F = typeof navigator < "u" ? navigator : {
	...
	vendor: "",
	platform: ""
}, Xt = typeof document < "u" ? document : { documentElement: { style: {} } }, Zt = /*@__PURE__*/ /Edge\/(\d+)/.exec(F.userAgent), Qt = /*@__PURE__*/ /MSIE \d/.test(F.userAgent), $t = /*@__PURE__*/ /Trident\/(?:[7-9]|\d{2,})\..*rv:(\d+)/.exec(F.userAgent), en = !!(Qt || $t || Zt), tn = !en && /*@__PURE__*/ /gecko\/(\d+)/i.test(F.userAgent), nn = !en && /*@__PURE__*/ /Chrome\/(\d+)/.exec(F.userAgent), rn = "webkitFontSmoothing" in Xt.documentElement.style, an = !en && /*@__PURE__*/ /Apple Computer/.test(F.vendor), on = an && (/*@__PURE__*/ /Mobile\/\w+/.test(F.userAgent) || F.maxTouchPoints > 2), I = {
	mac: on || /*@__PURE__*/ /Mac/.test(F.platform),
	...
	gecko: tn,
	gecko_version: tn ? +(/*@__PURE__*/ /Firefox\/(\d+)/.exec(F.userAgent) || [0, 0])[1] : 0,
	chrome: !!nn,
	chrome_version: nn ? +nn[1] : 0,
	ios: on,
	android: /*@__PURE__*/ /Android\b/.test(F.userAgent),
	webkit: rn,
	webkit_version: rn ? +(/*@__PURE__*/ /\bAppleWebKit\/(\d+)/.exec(F.userAgent) || [0, 0])[1] : 0,
	safari: an,
	safari_version: an ? +(/*@__PURE__*/ /\bVersion\/(\d+(\.\d+)?)/.exec(F.userAgent) || [0, 0])[1] : 0,
...
var pn = class {
	...
	static replace(e) {
		...
		if (e.isBlockGap) n = -5e8, r = 4e8;
			...
			let { start: i, end: a } = _n(e, t);
			n = (i ? t ? -3e8 : -1 : 5e8) - 1, r = (a ? t ? 2e8 : 1 : -6e8) + 1;
		}
		return new gn(e, n, r, t, e.widget || null, !0);
	}
	static line(e) {
		return new hn(e);
	}
...
R.none = M.empty;
var mn = class e extends R {
	constructor(e) {
		let { start: t, end: n } = _n(e);
...
hn.prototype.mapMode = be.TrackBefore, hn.prototype.point = !0;
var gn = class e extends R {
	constructor(e, t, n, r, i, a) {
...
bn.prototype.startSide = bn.prototype.endSide = -1;
function xn(e) {
	let t;
...
function wn(e) {
	return e.nodeType == 3 ? Vn(e, 0, e.nodeValue.length).getClientRects() : e.nodeType == 1 ? e.getClientRects() : [];
}
function Tn(e, t, n, r) {
	return n ? On(e, t, n, r, -1) || On(e, t, n, r, 1) : !1;
}
function En(e) {
...
var Rn = null;
I.safari && I.safari_version >= 26 && (Rn = !1);
function zn(e) {
	if (e.setActive) return e.setActive();
	if (Rn) return e.focus(Rn);
	let t = In(e);
	e.focus(Rn == null ? { get preventScroll() {
		return Rn = { preventScroll: !0 }, !0;
	} } : void 0), Rn || (Rn = !1, Ln(t));
}
var Bn;
function Vn(e, t, n = t) {
	let r = Bn ||= document.createRange();
...
function Wn(e, t) {
	...
	for (r = Math.min(r, kn(n));;) if (r) {
		if (n.nodeType != 1) return !1;
		let e = n.childNodes[r - 1];
		e.contentEditable == "false" ? r-- : (n = e, r = kn(n));
	} else if (n == e) return !0;
	else r = En(n), n = n.parentNode;
}
function Gn(e) {
...
function Kn(e, t) {
	...
	} else if (n.parentNode && !Dn(n)) r = En(n), n = n.parentNode;
	else return null;
}
function qn(e, t) {
	...
	} else if (n.parentNode && !Dn(n)) r = En(n) + 1, n = n.parentNode;
	else return null;
}
var Jn = class e {
	constructor(e, t, n = !0) {
	...
	static before(t, n) {
		return new e(t.parentNode, En(t), n);
	}
	static after(t, n) {
		return new e(t.parentNode, En(t) + 1, n);
	}
...
var Qn = /*@__PURE__*/ Zn("88888888888888888888888888888888888666888888787833333333337888888000000000000000000000000008888880000000000000000000000000088888888888888888888888888888888888887866668888088888663380888308888800000000000000000000000800000000000000000000000000000008"), $n = /*@__PURE__*/ Zn("4444448826627288999999999992222222222222222222222222222222222222222222222229999999999999999999994444444444644222822222222222222222222222222222222222222222222222222222222222222222222222222222222222222222222222222222999999949999999229989999223333333333"), er = /*@__PURE__*/ Object.create(null), tr = [];
for (let e of [
	"()",
	"[]",
	"{}"
...
function nr(e) {
	return e <= 247 ? Qn[e] : 1424 <= e && e <= 1524 ? 2 : 1536 <= e && e <= 1785 ? $n[e - 1536] : 1774 <= e && e <= 2220 ? 4 : 8192 <= e && e <= 8204 ? 256 : 64336 <= e && e <= 65023 ? 4 : 1;
}
var rr = /[\u0590-\u05f4\u0600-\u06ff\u0700-\u08ac\ufb50-\ufdff]/, ir = class {
	get dir() {
		return this.level % 2 ? Xn : Yn;
	}
	constructor(e, t, n) {
...
function ar(e, t) {
	...
	for (let n = 0; n < e.length; n++) {
		let r = e[n], i = t[n];
		if (r.from != i.from || r.to != i.to || r.direction != i.direction || !ar(r.inner, i.inner)) return !1;
	}
	return !0;
}
var B = [];
...
function sr(e, t, n, r, i) {
	...
	for (let o = 0, s = 0, c = 0; o <= r.length; o++) {
		...
		for (let t = l, n, r, o; t < u; t++) if (r = er[n = e.charCodeAt(t)]) {
			if (r < 0) {
				for (let e = s - 3; e >= 0; e -= 3) if (tr[e + 1] == -r) {
					let n = tr[e + 2], r = n & 2 ? i : n & 4 ? n & 1 ? a : i : 0;
					r && (B[t] = B[tr[e]] = r), s = e;
					break;
				}
			} else if (tr.length == 189) break;
			else tr[s++] = t, tr[s++] = n, tr[s++] = c;
		} else if ((o = B[t]) == 2 || o == 1) {
			let e = o == i;
			c = +!e;
...
function lr(e, t, n, r, i, a, o) {
	...
	if (r % 2 == i % 2) for (let c = t, l = 0; c < n;) {
		...
		run: for (;;) if (l < a.length && p == a[l].from) {
			...
			l++, d ? d.push(m) : (m.from > c && o.push(new ir(c, m.from, f)), ur(e, m.direction == Yn == !(f % 2) ? r : r + 1, i, m.inner, m.from, m.to, o), c = m.to), p = m.to;
		} else if (p == n || (t ? B[p] != s : B[p] == s)) break;
		else p++;
		d ? lr(e, c, p, r + 1, i, d, o) : c < p && o.push(new ir(c, p, f)), c = p;
	}
		...
		run: for (;;) if (l && p == a[l - 1].to) {
			...
			d ? d.push(m) : (m.to < c && o.push(new ir(m.to, c, f)), ur(e, m.direction == Yn == !(f % 2) ? r : r + 1, i, m.inner, m.from, m.to, o), c = m.from), p = m.from;
		} else if (p == t || (n ? B[p - 1] != s : B[p - 1] == s)) break;
		else p--;
		d ? lr(e, p, c, r + 1, i, d, o) : p < c && o.push(new ir(p, c, f)), c = p;
	}
}
function ur(e, t, n, r, i, a, o) {
	let s = t % 2 ? 2 : 1;
	or(e, i, a, r, s), sr(e, i, a, r, s), cr(i, a, r, s), lr(e, i, a, t, n, r, o);
}
function dr(e, t, n) {
	if (!e) return [new ir(0, 0, +(t == Xn))];
	if (t == Yn && !n.length && !rr.test(e)) return fr(e.length);
	if (n.length) for (; e.length > B.length;) B[B.length] = 256;
	let r = [], i = t == Yn ? 0 : 1;
	return ur(e, i, i, n, 0, e.length, r), r;
}
function fr(e) {
	return [new ir(0, e, 0)];
}
...
function mr(e, t, n, r, i) {
	let a = r.head - e.from, o = ir.find(t, a, r.bidiLevel ?? -1, r.assoc), s = t[o], c = s.side(i, n);
	if (a == c) {
		let e = o += i ? 1 : -1;
	...
	(l < s.from || l > s.to) && (l = c), pr = e.text.slice(Math.min(a, l), Math.max(a, l));
...
function hr(e, t, n) {
	for (let r = t; r < n; r++) {
		let t = nr(e.charCodeAt(r));
		if (t == 1) return Yn;
		if (t == 2 || t == 4) return Xn;
	}
	return Yn;
}
var gr = /*@__PURE__*/ D.define(), _r = /*@__PURE__*/ D.define(), vr = /*@__PURE__*/ D.define(), yr = /*@__PURE__*/ D.define(), br = /*@__PURE__*/ D.define(), xr = /*@__PURE__*/ D.define(), Sr = /*@__PURE__*/ D.define(), Cr = /*@__PURE__*/ D.define(), wr = /*@__PURE__*/ D.define(), Tr = /*@__PURE__*/ D.define({ combine: (e) => e.some((e) => e) }), Er = /*@__PURE__*/ D.define({ combine: (e) => e.some((e) => e) }), Dr = /*@__PURE__*/ D.define(), Or = class e {
...
}, kr = /*@__PURE__*/ k.define({ map: (e, t) => e.map(t) }), Ar = /*@__PURE__*/ k.define();
function jr(e, t, n) {
	let r = e.facet(yr);
	r.length ? r[0](t) : window.onerror && window.onerror(String(t), n, void 0, void 0, t) || (n ? console.error(n + ":", t) : console.error(t));
}
var Mr = /*@__PURE__*/ D.define({ combine: (e) => !e.length || e[0] }), Nr = 0, Pr = /*@__PURE__*/ D.define({ combine(e) {
	return e.filter((t, n) => {
	...
	constructor(e, t, n, r, i) {
		this.id = e, this.create = t, this.domEventHandlers = n, this.domEventObservers = r, this.baseExtensions = i(this), this.extension = this.baseExtensions.concat(Pr.of({
			plugin: this,
			arg: void 0
		}));
	}
	of(e) {
		return this.baseExtensions.concat(Pr.of({
			plugin: this,
			arg: e
		}));
	}
	static define(t, n) {
		...
		return new e(Nr++, t, r, i, (e) => {
			let t = [];
			return o && t.push(Rr.of((t) => {
				let n = t.plugin(e);
				return n ? o(n) : R.none;
			})), a && t.push(a(e)), t;
		});
	...
	update(e) {
		if (!this.value) {
			if (this.spec) try {
				...
				jr(e.state, t, "CodeMirror plugin crashed"), this.deactivate();
			}
			...
			if (this.mustUpdate = null, this.value.update) try {
				...
				if (jr(e.state, t, "CodeMirror plugin crashed"), this.value.destroy) try {
					this.value.destroy();
				} catch {}
				this.deactivate();
			}
	...
	destroy(e) {
		if (this.value?.destroy) try {
			...
			jr(e.state, t, "CodeMirror plugin crashed");
		}
	}
	deactivate() {
		this.spec = this.value = null;
	}
}, Ir = /*@__PURE__*/ D.define(), Lr = /*@__PURE__*/ D.define(), Rr = /*@__PURE__*/ D.define(), zr = /*@__PURE__*/ D.define(), Br = /*@__PURE__*/ D.define(), Vr = /*@__PURE__*/ D.define(), Hr = /*@__PURE__*/ D.define();
function Ur(e, t) {
	...
	return M.spans(r, t.from, t.to, {
		...
		span(e, n, r, a) {
			...
			for (let e = r.length - 1; e >= 0; e--, a--) {
				...
				if (n ??= hr(t.text, o, s), a > 0 && c.length && (i = c[c.length - 1]).to == o && i.direction == n) i.to = s, c = i.inner;
				else {
					let e = {
						from: o,
						to: s,
...
var Wr = /*@__PURE__*/ D.define();
function Gr(e) {
	let t = 0, n = 0, r = 0, i = 0;
	for (let a of e.state.facet(Wr)) {
		let o = a(e);
...
var Kr = /*@__PURE__*/ D.define(), qr = class e {
	constructor(e, t, n, r) {
	...
	constructor(e, t, n) {
		...
		let r = [];
		this.changes.iterChangedRanges((e, t, n, i) => r.push(new qr(e, t, n, i))), this.changedRanges = r;
	}
	static create(t, n, r) {
		return new e(t, n, r);
	}
	...
	domPosFor(e, t) {
		let n = En(this.dom), r = this.length ? e > 0 : t > 0;
	...
	get root() {
		for (let e = this; e; e = e.parent) if (e instanceof Qr) return e;
		return null;
	}
	static get(e) {
		return e.cmTile;
	...
	sync(e) {
		...
		for (let o of this.children) {
			if (o.sync(e), a += o.length + o.breakAfter, r = n ? n.nextSibling : t.firstChild, i && r != o.dom && (i.written = !0), o.dom.parentNode == t) for (; r && r != o.dom;) r = Zr(r);
			else t.insertBefore(o.dom, r);
			n = o.dom;
		}
		for (r = n ? n.nextSibling : t.firstChild, i && r && (i.written = !0); r;) r = Zr(r);
		this.length = a;
	}
};
function Zr(e) {
...
var Qr = class extends Xr {
	...
	blockTiles(e) {
		for (let t = [], n = this, r = 0, i = 0;;) if (r == n.children.length) {
			...
			let a = n.children[r++];
			if (a instanceof $r) t.push(r), n = a, r = 0;
			else {
	...
	resolveInline(e, t, n) {
		...
		function s(e, c) {
			for (let l = 0, u = 0; l < e.children.length && u <= c; l++) {
				...
				f >= c && (d.isComposite() ? s(d, c - u) : (!a || a.isHidden && (t > 0 && !(a.flags & 32) || n && ni(a, d))) && (f > c || d.flags & 32 && t <= 1) ? (a = d, o = c - u) : (u < c || d.flags & 16 && !d.isHidden && t >= -1) && (r = d, i = c - u)), u = f;
			}
		}
		s(this, e);
		let c = (t < 0 ? r : a) || r || a;
	...
	coordsIn(e, t, n) {
		...
		return r ? r.tile.coordsIn(Math.max(0, r.offset), t, n) : ti(this);
	}
	domIn(e, t) {
...
var ri = class e extends Xr {
	...
	coordsIn(e, t, n) {
		...
		let s = Vn(this.dom, i, a).getClientRects();
		if (!s.length) return null;
		let c = s[(o ? o < 0 : t >= 0) ? 0 : s.length - 1];
		return I.safari && !o && c.width == 0 && (c = Array.prototype.find.call(s, (e) => e.width) || c), n == null ? c : An(c, (o ? o > 0 : t < 0) == n);
	}
	static of(t, n) {
		let r = new e(n || document.createTextNode(t), t);
		return n || (r.flags |= 2), r;
	}
}, ai = class e extends H {
	constructor(e, t, n, r) {
	...
	coordsInWidget(e, t, n) {
		...
		if (r) return r;
		if (n) return An(this.dom.getBoundingClientRect(), this.length ? e == 0 : t <= 0);
		{
	...
	addText(e, t, n, r) {
		...
		if (a && a.isText() && !(a.flags & 8) && a.length + e.length < 512) {
			...
			let t = i.children[i.children.length - 1] = new ii(a.dom, a.text + e);
			t.parent = i;
		} else i.append(r || ii.of(e, this.cache.find(ii)?.dom));
		this.pos += e.length, this.afterWidget = null;
	}
	addComposition(e, t) {
		let n = this.curLine;
		n.dom != t.line.dom && (n.setDOM(this.cache.reused.has(t.line) ? yi(t.line.dom) : t.line.dom), this.cache.reused.set(t.line, 2));
		let r = n;
		for (let e = t.marks.length - 1; e >= 0; e--) {
			let n = t.marks[e], i = r.lastChild;
			if (i instanceof ri && i.mark.eq(n.mark)) i.dom != n.dom && i.setDOM(yi(n.dom)), r = i;
			else {
				if (this.cache.reused.get(n)) {
					let e = H.get(n.dom);
					e && e.setDOM(yi(n.dom));
				}
				let e = ri.of(n.mark, n.dom);
				r.append(e), r = e;
			}
		...
		let a = new ii(e.text, e.text.nodeValue);
	...
	addLineStart(e, t) {
		e ||= gi;
		let n = ei.start(e, t || this.cache.find(ei)?.dom, !!t);
	...
	ensureMarks(e, t) {
		...
		for (let r = e.length - 1; r >= 0; r--) {
			let i = e[r], a;
			if (t > 0 && (a = n.lastChild) && a instanceof ri && a.mark.eq(i)) n = a, t--;
			else {
				let e = ri.of(i, this.cache.find(ri, (e) => e.mark.eq(i))?.dom);
				n.append(e), n = e, t = 0;
			}
		}
		return n;
	...
	endLine() {
		if (this.curLine) {
			...
			(!e || !mi(this.curLine, !1) || e.dom.nodeName != "BR" && e.isWidget() && !(I.ios && mi(this.curLine, !0))) && this.curLine.append(this.cache.findWidget(xi, 0, 32) || new ai(xi.toDOM(), 0, xi, 32)), this.curLine = this.afterWidget = null;
		}
	}
	updateBlockWrappers() {
		...
		for (let e = this.blockWrappers; e.value && e.from <= this.pos; e.next()) if (e.to >= this.pos) {
			let t = e.rank * 102 + e.value.rank, n = new ci(e.from, e.to, e.value, t), r = this.wrappers.length;
	...
	getBlockPos() {
		...
		for (let t of this.wrappers) {
			let n = e.lastChild;
			if (t.from < this.pos && n instanceof $r && n.wrapper.eq(t.wrapper)) e = n;
			else {
				let n = $r.of(t.wrapper, this.cache.find($r, (e) => e.wrapper.eq(t.wrapper))?.dom);
				e.append(n), e = n;
			}
		}
		return e;
...
for (let e = 0; e < di.length; e++) di[e].bucket = e;
var fi = class {
	constructor(e) {
		this.view = e, this.buckets = di.map(() => []), this.index = di.map(() => 0), this.reused = /* @__PURE__ */ new Map();
	}
	add(e) {
	...
	findWidget(e, t, n) {
		...
		if (r.length) for (let i = 0, a = 0;; i++) {
			...
			let o = r[i];
			if (!this.reused.has(o) && (a == 0 ? o.widget.compare(e) : o.widget.constructor == e.constructor && e.updateDOM(o.dom, this.view, o.widget))) return r.splice(i, 1), i < this.index[0] && this.index[0]--, o.widget == e && o.length == t && (o.flags & 497) == n ? (this.reused.set(o, 1), o) : (this.reused.set(o, 2), new ai(o.dom, t, e, o.flags & -498 | n));
		}
	}
	reuse(e) {
	...
	constructor(e, t, n, r, i) {
		this.view = e, this.decorations = r, this.disallowBlockEffectsFor = i, this.openWidget = !1, this.openMarks = 0, this.cache = new fi(e), this.text = new ui(e.state.doc), this.builder = new li(this.cache, new Qr(e, e.contentDOM), M.iter(n)), this.cache.reused.set(t, 2), this.old = new si(t), this.reuseWalker = {
			skip: (e, t, n) => {
	...
	preserve(e, t, n) {
		let r = vi(this.old), i = this.openMarks;
		this.old.advance(e, n ? 1 : -1, {
			skip: (e, t, n) => {
				if (e.isWidget()) {
					if (this.openWidget) this.builder.continueWidget(n - t);
					else {
						let a = n > 0 || t < e.length ? ai.of(e.widget, this.view, n - t, e.flags & 496, this.cache.maybeReuse(e)) : this.cache.reuse(e);
				...
				else if (e instanceof ri) this.builder.ensureLine(null), this.builder.addMark(e, r, i), this.cache.reused.set(e, 1), i = r.length;
				else return !1;
				this.openWidget = !1;
			},
			enter: (e) => {
				e.isLine() ? this.builder.addLineStart(e.attrs, this.cache.maybeReuse(e)) : (this.cache.add(e), e instanceof ri && r.unshift(e.mark)), this.openWidget = !1;
			},
			leave: (e) => {
				e.isLine() ? r.length &&= i = 0 : e instanceof ri && (r.shift(), i = Math.min(i, r.length));
			},
			break: () => {
			...
			point: (e, t, a, o, s, c) => {
				if (a instanceof gn) {
					...
					if (i = o.length, s > o.length) r.continueWidget(t - e);
						...
						let i = a.widget || (a.block ? bi.block : bi.inline), c = hi(a), l = this.cache.findWidget(i, t - e, c) || ai.of(i, this.view, t - e, c);
	...
	getCompositionContext(e) {
		...
		for (let r = e.parentNode;; r = r.parentNode) {
			...
			e instanceof ri ? t.push(e) : e?.isLine() ? n = e : e instanceof $r || (r.nodeName == "DIV" && !n && r != this.view.contentDOM ? n = new ei(r, gi) : n || t.push(ri.of(new mn({
...
bi.inline = /*@__PURE__*/ new bi("span"), bi.block = /*@__PURE__*/ new bi("div");
var xi = /*@__PURE__*/ new class extends pn {
	toDOM() {
	...
	update(e) {
		...
		let n = -1;
		this.view.inputState.composing >= 0 && !this.view.observer.editContext && (this.domChanged?.newSel ? n = this.domChanged.newSel.head : !Ni(e.changes, this.hasComposition) && !e.selectionSet && (n = e.state.selection.main.head));
		let r = n > -1 ? Ei(this.view, e.changes, n) : null;
		if (this.domChanged = null, this.hasComposition) {
			let { from: n, to: r } = this.hasComposition;
			t = new qr(n, r, e.changes.mapPos(n, -1), e.changes.mapPos(r, 1)).addToSet(t.slice());
		}
		...
		this.updateDeco();
		let o = ki(i, this.decorations, e.changes);
		o.length && (t = qr.extendWithRanges(t, o));
		let s = ji(a, this.blockWrappers, e.changes);
		return s.length && (t = qr.extendWithRanges(t, s)), r && !t.some((e) => e.fromA <= r.range.fromA && e.toA >= r.range.toA) && (t = r.range.addToSet(t.slice())), this.tile.flags & 2 && t.length == 0 ? !1 : (this.updateInner(t, r), e.transactions.length && (this.lastUpdate = Date.now()), !0);
	}
	updateInner(e, t) {
		...
		n.ignore(() => {
			if (t || e.length) {
				...
				t && H.get(t.text) && r.cache.reused.set(H.get(t.text), 2), this.tile = r.run(e, t), Ci(n, r.cache.reused);
			}
		...
		let r = [];
		if (this.view.viewport.from || this.view.viewport.to < this.view.state.doc.length) for (let e of this.tile.children) e.isWidget() && e.widget instanceof Pi && r.push(e.dom);
		n.updateGaps(r);
	}
	updateEditContextFormatting(e) {
		this.editContextFormatting = this.editContextFormatting.map(e.changes);
		for (let t of e.transactions) for (let e of t.effects) e.is(Ar) && (this.editContextFormatting = e.value);
	}
	updateSelection(e = !1, t = !1) {
		(e || !this.view.observer.selectionRange.focusNode) && this.view.observer.readSelectionRange();
		let { dom: n } = this.tile, r = this.view.root.activeElement, i = r == n, a = !i && !(this.view.state.facet(Mr) || n.tabIndex > -1) && Cn(n, this.view.observer.selectionRange) && !(r && n.contains(r));
		if (!(i || t || a)) return;
		let o = this.forceSelection;
		this.forceSelection = !1;
		let s = this.view.state.selection.main, c, l;
		if (s.empty ? l = c = this.inlineDOMNearPos(s.anchor, s.assoc || 1) : (l = this.inlineDOMNearPos(s.head, s.head == s.from ? 1 : -1), c = this.inlineDOMNearPos(s.anchor, s.anchor == s.from ? 1 : -1)), I.gecko && s.empty && !this.hasComposition && wi(c)) {
			let e = document.createTextNode("");
			this.view.observer.ignore(() => c.node.insertBefore(e, c.node.childNodes[c.offset] || null)), c = l = new Jn(e, 0), o = !0;
		}
		let u = this.view.observer.selectionRange;
		(o || !u.focusNode || (!Tn(c.node, c.offset, u.anchorNode, u.anchorOffset) || !Tn(l.node, l.offset, u.focusNode, u.focusOffset)) && !this.suppressWidgetCursorChange(u, s)) && (this.view.observer.ignore(() => {
			I.android && I.chrome && n.contains(u.focusNode) && Mi(u.focusNode, n) && (n.blur(), n.focus({ preventScroll: !0 }));
			let e = xn(this.view.root);
			if (e) {
				if (s.empty) {
					if (I.gecko) {
						let e = Di(c.node, c.offset);
						if (e && e != 3) {
							let t = (e == 1 ? Kn : qn)(c.node, c.offset);
	...
	enforceCursorAssoc() {
		...
		let { view: e } = this, t = e.state.selection.main, n = xn(e.root), { anchorNode: r, anchorOffset: i } = e.observer.selectionRange;
	...
	coordsAt(e, t, n) {
		...
		return r.isWidget() ? r.widget instanceof Pi ? null : r.coordsInWidget(i, t, !0) : r.coordsIn(i, t, n);
	}
	lineAt(e, t) {
	...
	coordsForChar(e) {
		...
		function r(e, t) {
			if (e.isComposite()) for (let n of e.children) {
				...
				let n = C(e.text, t);
				if (n == t) return null;
				let r = Vn(e.dom, t, n).getClientRects();
	...
	measureVisibleLineHeights(e) {
		let t = [], { from: n, to: r } = e, i = this.view.contentDOM.clientWidth, a = i > Math.max(this.view.scrollDOM.clientWidth, this.minWidth) + 1, o = -1, s = this.view.textDirection == z.LTR, c = 0, l = (e, u, d) => {
			for (let f = 0; f < e.children.length && !(u > r); f++) {
				...
				if (d && !f && (c += m.top - d.top), r instanceof $r) p > n && l(r, u, m);
				else if (u >= n && (c > 0 && t.push(-c), t.push(h + c), c = 0, a)) {
					let e = r.dom.lastChild, t = e ? wn(e) : [];
					if (t.length) {
	...
	updateDeco() {
		let e = 1, t = this.view.state.facet(Rr).map((t) => (this.dynamicDecorationMap[e++] = typeof t == "function") ? t(this.view) : t), n = !1, r = this.view.state.facet(Br).map((e, t) => {
		...
		this.blockWrappers = this.view.state.facet(zr).map((e) => typeof e == "function" ? e(this.view) : e);
	}
	scrollIntoView(e) {
		if (e.isSnapshot) {
		...
		for (let t of this.view.state.facet(Dr)) try {
			if (t(this.view, e.range, e)) return !0;
		} catch (e) {
			jr(this.view.state, e, "scroll handler");
		}
...
function Ti(e, t) {
	...
	let r = Kn(n.focusNode, n.focusOffset), i = qn(n.focusNode, n.focusOffset), a = r || i;
...
function Ei(e, t, n) {
	...
	return {
		range: new qr(c.mapPos(a), c.mapPos(o), a, o),
		text: i
	};
}
function Di(e, t) {
...
function Ii(e, t, n, r, i) {
	...
	return n.from + Ft(o, a, e.state.tabSize);
}
function Li(e, t, n) {
...
function Ri(e, t, n, r) {
	let i = Li(e, t.head, t.assoc || -1), a = !r || i.type != L.Text || !(e.lineWrapping || i.widgetLineBreaks) ? null : e.coordsAtPos(t.assoc < 0 && t.head > i.from ? t.head - 1 : t.head);
	if (a) {
...
function Ui(e, t) {
	...
	for (let r = 0; r < t.ranges.length; r++) {
		...
		if (i.empty) {
			...
			let t = Hi(e, i.from, -1), n = Hi(e, i.to, 1);
...
function Wi(e, t, n) {
	let r = Hi(e.state.facet(Vr).map((t) => t(e)), n.from, t.head > n.from ? -1 : 1);
...
function Ki(e, t, n, r) {
	...
	for (;;) {
		if (c < 0) return new Gi(0, 1);
		if (c > e.viewState.docHeight) return new Gi(e.state.doc.length, -1);
	...
	if (e.viewport.from >= l.to || e.viewport.to <= l.from) {
		...
		if (l.type == L.Text) {
			let t = Ii(e, i, l, o, s);
			return new Gi(t, t == l.from ? 1 : -1);
		}
	}
	if (l.type != L.Text) return c < (l.top + l.bottom) / 2 ? new Gi(l.from, 1) : new Gi(l.to, -1);
	let u = e.docView.lineAt(l.from, 2);
	return (!u || u.length != l.length) && (u = e.docView.lineAt(l.from, -2)), new qi(e, o, s, e.textDirectionAt(l.from)).scanTile(u, l.from);
}
var qi = class {
	constructor(e, t, n, r) {
	...
	baseDirAt(e, t) {
		...
		return r[ir.find(r, e - n.from, -1, t)].level == this.baseDir;
	}
	dirAt(e, t) {
		let { line: n, spans: r } = this.bidiSpansAt(e);
		return r[ir.find(r, e - n.from, -1, t)].dir;
	}
	bidiIn(e, t) {
	...
	scanText(e, t) {
		...
		let r = this.scan(n, (r) => {
			...
			return Vn(e.dom, i, a).getClientRects();
		});
		return r.after ? new Gi(n[r.i + 1], -1) : new Gi(n[r.i], 1);
	}
	scanTile(e, t) {
		if (!e.length) return new Gi(t, 1);
		...
		let r = this.scan(n, (t) => {
			let n = e.children[t];
			return n.flags & 48 ? null : (n.dom.nodeType == 1 ? n.dom : Vn(n.dom, 0, n.length)).getClientRects();
		}), i = e.children[r.i], a = n[r.i];
		return i.isText() ? this.scanText(i, a) : i.isComposite() ? this.scanTile(i, a) : r.after ? new Gi(n[r.i + 1], -1) : new Gi(a, 1);
	}
}, Ji = "￿", Yi = class {
	constructor(e, t) {
	...
	readRange(e, t) {
		...
		for (let r = e;;) {
			...
			let o = H.get(a);
			(i && o ? i.breakAfter : (i ? i.breakAfter : Dn(r)) || Dn(a) && (r.nodeName != "BR" || i?.isWidget()) && this.text.length > e) && !Zi(a, t) && this.lineBreak(), r = a;
		}
	...
	findPointInside(e, t) {
		for (let n of this.points) (e.nodeType == 3 ? n.node == e : e.contains(n.node)) && (n.pos = this.text.length + (Xi(e, n.node, n.offset) ? t : 0));
	}
};
function Xi(e, t, n) {
	for (;;) {
...
var Qi = class {
	...
	constructor(e, t, n, r) {
		...
		else if (t > -1 && (this.bounds = ea(e.docView.tile, t, n, 0))) {
			let t = i || a ? [] : aa(e), n = new Yi(t, e);
...
function ta(e, t) {
	...
	if (t.bounds) {
		...
		!a.empty && a.from >= e && a.to <= r && (t.typeOver || l != t.text) && l.slice(0, a.from - e) == t.text.slice(0, a.from - e) && l.slice(a.to - e) == t.text.slice(u = t.text.length - (l.length - (a.to - e))) ? n = {
			from: a.from,
			to: a.to,
			insert: x.of(t.text.slice(a.from - e, u).split(Ji))
		} : (d = ia(l, t.text, s - e, c)) && (I.chrome && o == 13 && d.toB == d.from + 2 && t.text.slice(d.from, d.toB) == "￿￿" && d.toB--, n = {
			from: e + d.from,
			to: e + d.toA,
			insert: x.of(t.text.slice(d.from, d.toB).split(Ji))
		});
	} else r && (!e.hasFocus && i.facet(Mr) || sa(r, a)) && (r = null);
	if (!n && !r) return !1;
	...
	if (r && !sa(r, a)) {
		let t = !1, n = "select";
		return e.inputState.lastSelectionTime > Date.now() - 50 && (e.inputState.lastSelectionOrigin == "select" && (t = !0), n = e.inputState.lastSelectionOrigin, n == "select.pointer" && (r = Ui(i.facet(Vr).map((t) => t(e)), r))), e.dispatch({
			selection: r,
			scrollIntoView: t,
			userEvent: n
		}), !0;
...
function na(e, t, n, r = -1) {
	...
	if (I.android && (t.to == i.to && (t.from == i.from || t.from == i.from - 1 && e.state.sliceDoc(t.from, i.from) == " ") && t.insert.length == 1 && t.insert.lines == 2 && Hn(e.contentDOM, "Enter", 13) || (t.from == i.from - 1 && t.to == i.to && t.insert.length == 0 || r == 8 && t.insert.length < t.to - t.from && t.to > i.head) && Hn(e.contentDOM, "Backspace", 8) || t.from == i.from && t.to == i.to + 1 && t.insert.length == 0 && Hn(e.contentDOM, "Delete", 46))) return !0;
	let a = t.insert.toString();
	e.inputState.composing >= 0 && e.inputState.composing++;
	let o, s = () => o ||= ra(e, t, n);
	return e.state.facet(xr).some((n) => n(e, t.from, t.to, a, s)) || e.dispatch(s()), !0;
}
function ra(e, t, n) {
	let r, i = e.state, a = i.selection.main, o = -1;
	if (t.from == t.to && t.from < a.from || t.from > a.to) {
		let n = t.from < a.from ? -1 : 1, r = n < 0 ? a.from : a.to, s = Hi(i.facet(Vr).map((t) => t(e)), r, n);
		t.from == s && (o = s);
	}
	if (o > -1) r = {
		changes: t,
		...
		if (i.selection.ranges.length > 1 && (e.inputState.composing >= 0 || e.inputState.compositionPendingChange) && t.to <= a.to + 10 && t.to >= a.to - 10) {
			let c = e.state.sliceDoc(t.from, t.to), l, u = n && Ti(e, n.main.head);
			if (u) {
...
function aa(e) {
	...
	return n && (t.push(new Qi(n, r)), (i != n || a != r) && t.push(new Qi(i, a))), t;
}
function oa(e, t) {
...
var ca = class {
	...
	ensureHandlers(e) {
		let t = da(e), n = this.handlers, r = this.view.contentDOM;
	...
	keydown(e) {
		...
		if (this.tabFocusMode > 0 && e.keyCode != 27 && ma.indexOf(e.keyCode) < 0 && (this.tabFocusMode = -1), I.android && I.chrome && !e.synthetic && (e.keyCode == 13 || e.keyCode == 8)) return this.view.observer.delayAndroidKey(e.key, e.keyCode), !0;
		if (I.ios && !e.synthetic && !e.altKey && !e.metaKey && (fa.some((t) => t.keyCode == e.keyCode) && !e.ctrlKey || pa.indexOf(e.key) > -1 && e.ctrlKey)) {
			let t = {
				ctrlKey: e.ctrlKey,
				altKey: e.altKey,
				metaKey: e.metaKey,
			...
			return t.shiftKey && I.ios && !/^(off|none)$/.test(this.view.contentDOM.autocapitalize) && la(this.view.win) && (t.shiftKey = !1), this.pendingIOSKey = {
				key: e.key,
				keyCode: e.keyCode,
				mods: t
	...
	flushIOSKey(e) {
		...
		return !t || t.key == "Enter" && e && e.from < e.to && /^\S+$/.test(e.insert.toString()) ? !1 : (this.pendingIOSKey = void 0, Hn(this.view.contentDOM, t.key, t.keyCode, t.mods));
	}
...
function da(e) {
	...
	for (let t of e) {
		...
		if (r) for (let e in r) {
			let i = r[e];
			i && n(e).handlers.push(ua(t.value, i));
		}
		if (i) for (let e in i) {
			let r = i[e];
			r && n(e).observers.push(ua(t.value, r));
		}
	}
...
var va = class {
	constructor(e, t, n, r) {
		this.view = e, this.startEvent = t, this.style = n, this.mustSelect = r, this.scrollSpeed = {
			x: 0,
			y: 0
		}, this.scrolling = -1, this.lastEvent = t, this.scrollParents = Pn(e.contentDOM), this.atoms = e.state.facet(Vr).map((t) => t(e));
		let i = e.contentDOM.ownerDocument;
		i.addEventListener("mousemove", this.move = this.move.bind(this)), i.addEventListener("mouseup", this.up = this.up.bind(this)), this.extend = t.shiftKey, this.multiple = e.state.facet(j.allowMultipleSelections) && ya(e, t), this.dragging = xa(e, t) && Na(t) == 1 ? null : !1;
	}
	start(e) {
	...
	move(e) {
		...
		if (this.dragging || this.dragging == null && _a(this.startEvent, e) < 10) return;
		...
		let s = Gr(this.view);
		e.clientX - s.left <= r + ha ? t = -ga(r - e.clientX) : e.clientX + s.right >= a - ha && (t = ga(e.clientX - a)), e.clientY - s.top <= i + ha ? n = -ga(i - e.clientY) : e.clientY + s.bottom >= o - ha && (n = ga(e.clientY - o)), this.setScrollSpeed(t, n);
	}
	up(e) {
	...
	select(e) {
		let { view: t } = this, n = Ui(this.atoms, this.style.get(e, this.extend, this.multiple));
...
var Ca = /*@__PURE__*/ Object.create(null), U = /*@__PURE__*/ Object.create(null), wa = I.ie && I.ie_version < 15 || I.ios && I.webkit_version < 604;
function Ta(e) {
...
U.scroll = (e) => {
...
}, Ca.keydown = (e, t) => (e.inputState.setSelectionOrigin("select"), t.keyCode == 27 && e.inputState.tabFocusMode != 0 && (e.inputState.tabFocusMode = Date.now() + 2e3), !1), U.touchstart = (e, t) => {
	...
	if (!n && t.button == 0 && (n = Pa(e, t)), n) {
		let r = !e.hasFocus;
		e.inputState.startMouseSelection(new va(e, t, n, r)), r && e.observer.ignore(() => {
			zn(e.contentDOM);
...
var ka = I.ie && I.ie_version <= 11, Aa = null, ja = 0, Ma = 0;
function Na(e) {
...
function Pa(e, t) {
	...
	return {
		...
		get(t, a, o) {
			...
			return a ? i.replaceRange(i.main.extend(l.from, l.to, l.assoc)) : o && r == 1 && i.ranges.length > 1 && (c = Fa(i, s.pos)) ? c : o ? i.addRange(l) : E.create([l]);
		}
	};
}
function Fa(e, t) {
...
Ca.dragstart = (e, t) => {
	...
	let { inputState: r } = e;
	return r.mouseSelection && (r.mouseSelection.dragging = !0), r.draggedContent = n, t.dataTransfer && (t.dataTransfer.setData("Text", Ea(e.state, wr, e.state.sliceDoc(n.from, n.to))), t.dataTransfer.effectAllowed = "copyMove"), !1;
}, Ca.dragend = (e) => (e.inputState.draggedContent = null, !1);
function Ia(e, t, n, r) {
	if (n = Ea(e.state, Cr, n), !n) return;
	let i = e.posAtCoords({
		x: t.clientX,
		y: t.clientY
	}, !1), { draggedContent: a } = e.inputState, o = r && a && ba(e, t) ? {
		from: a.from,
		to: a.to
	} : null, s = {
		from: i,
...
function Ra(e) {
	...
	return {
		text: Ea(e, wr, t.join(e.lineBreak)),
		ranges: n,
		linewise: r
	};
}
...
U.focus = (e) => {
	...
	let n;
	if (I.chrome && I.android && (n = fa.find((e) => e.inputType == t.inputType)) && (e.observer.delayAndroidKey(n.key, n.keyCode), n.key == "Backspace" || n.key == "Delete")) {
...
Qa.prototype.size = 1;
var eo = /*@__PURE__*/ R.replace({}), to = class extends Qa {
	constructor(e, t, n) {
...
var lo = class {
	...
	comparePoint(e, t, n, r) {
		(e < t || n && n.heightRelevant || r && r.heightRelevant) && yn(e, t, this.changes, 5);
	}
};
function uo(e, t) {
...
var mo = class {
	...
	draw(e, t) {
		return R.replace({ widget: new ho(this.displaySize * (t ? e.scaleY : e.scaleX), t) }).range(this.from, this.to);
	}
}, ho = class extends pn {
	constructor(e, t) {
	...
	constructor(e, t) {
		this.view = e, this.state = t, this.pixelViewport = {
			...
			top: 0,
			bottom: 0
		}, this.inView = !0, this.paddingTop = 0, this.paddingBottom = 0, this.contentDOMWidth = 0, this.contentDOMHeight = 0, this.editorHeight = 0, this.editorWidth = 0, this.scaleX = 1, this.scaleY = 1, this.scrollOffset = 0, this.scrolledToBottom = !1, this.scrollAnchorPos = 0, this.scrollAnchorHeight = -1, this.scaler = So, this.scrollTarget = null, this.printing = !1, this.mustMeasureContent = !0, this.defaultTextDirection = z.LTR, this.visibleRanges = [], this.mustEnforceCursorAssoc = !1;
		let n = t.facet(Lr).some((e) => typeof e != "function" && e.class == "cm-lineWrapping");
		this.heightOracle = new Ja(n), this.stateDeco = Co(t), this.heightMap = Qa.empty().applyChanges(this.stateDeco, x.empty, this.heightOracle.setDoc(t.doc), [new qr(0, 0, 0, t.doc.length)]);
	...
	update(e, t = null) {
		...
		let r = e.changedRanges, i = qr.extendWithRanges(r, co(n, this.stateDeco, e ? e.changes : Se.empty(this.state.doc.length))), a = this.heightMap.height, o = this.scrolledToBottom ? null : this.scrollAnchorAt(this.scrollOffset);
		...
		this.viewport = s, e.flags |= this.updateForViewport(), (c || !e.changes.empty || e.flags & 2) && this.updateViewportLines(), (this.lineGaps.length || this.viewport.to - this.viewport.from > 4e3) && this.updateLineGaps(this.ensureLineGaps(this.mapLineGaps(this.lineGaps, e.changes))), e.flags |= this.computeVisibleRanges(e.changes), t && (this.scrollTarget = t), !this.mustEnforceCursorAssoc && (e.selectionSet || e.focusChanged) && e.view.lineWrapping && e.state.selection.main.empty && e.state.selection.main.assoc && !e.state.facet(Er) && (this.mustEnforceCursorAssoc = !0);
	}
	measure() {
		...
		let f = Pn(this.view.contentDOM, !1).y;
		f != this.scrollParent && (this.scrollParent = f, this.scrollAnchorHeight = -1, this.scrollOffset = 0);
		let p = this.getScrollOffset();
		this.scrollOffset != p && (this.scrollAnchorHeight = -1, this.scrollOffset = p), this.scrolledToBottom = Gn(this.scrollParent || e.win);
		...
		if ((this.contentDOMWidth != v || this.editorHeight != e.scrollDOM.clientHeight) && (this.contentDOMWidth = o.width, this.editorHeight = e.scrollDOM.clientHeight, c |= 16), s) {
			...
			for (let n of this.viewports) {
				...
				this.heightMap = (a ? Qa.empty().applyChanges(this.stateDeco, x.empty, this.heightOracle, [new qr(0, 0, 0, e.state.doc.length)]) : this.heightMap).updateHeight(r, 0, a, new Ya(n.from, i));
			}
			Ka && (c |= 2);
		}
	...
	getViewport(e, t) {
		let n = .5 - Math.max(-.5, Math.min(.5, e / 1e3 / 2)), r = this.heightMap, i = this.heightOracle, { visibleTop: a, visibleBottom: o } = this, s = new _o(r.lineAt(a - n * 1e3, W.ByHeight, i, 0, 0).from, r.lineAt(o + (1 - n) * 1e3, W.ByHeight, i, 0, 0).to);
		if (t) {
			let { head: e } = t.range;
			if (e < s.from || e > s.to) {
				let n = Math.min(this.editorHeight, this.pixelViewport.bottom - this.pixelViewport.top), a = r.lineAt(e, W.ByPos, i, 0, 0), o;
				o = t.y == "center" ? (a.top + a.bottom) / 2 - n / 2 : t.y == "start" || t.y == "nearest" && e < s.from ? a.top : a.bottom - n, s = new _o(r.lineAt(o - 500, W.ByHeight, i, 0, 0).from, r.lineAt(o + n + 500, W.ByHeight, i, 0, 0).to);
			}
		}
		return s;
	}
	mapViewport(e, t) {
		...
		return new _o(this.heightMap.lineAt(n, W.ByPos, this.heightOracle, 0, 0).from, this.heightMap.lineAt(r, W.ByPos, this.heightOracle, 0, 0).to);
	}
	...
	updateLineGaps(e) {
		mo.same(e, this.lineGaps) || (this.lineGaps = e, this.lineGapDeco = R.set(e.map((e) => e.draw(this, this.heightOracle.lineWrapping))));
	}
	...
	lineBlockAt(e) {
		return e >= this.viewport.from && e <= this.viewport.to && this.viewportLines.find((t) => t.from <= e && t.to >= e) || To(this.heightMap.lineAt(e, W.ByPos, this.heightOracle, 0, 0), this.scaler);
	}
	lineBlockAtHeight(e) {
		return e >= this.viewportLines[0].top && e <= this.viewportLines[this.viewportLines.length - 1].bottom && this.viewportLines.find((t) => t.top <= e && t.bottom >= e) || To(this.heightMap.lineAt(this.scaler.fromDOM(e), W.ByHeight, this.heightOracle, 0, 0), this.scaler);
	}
	getScrollOffset() {
...
function Co(e) {
	let t = e.facet(Rr).filter((e) => typeof e != "function"), n = e.facet(Br).filter((e) => typeof e != "function");
...
var Eo = /*@__PURE__*/ D.define({ combine: (e) => e.join(" ") }), Do = /*@__PURE__*/ D.define({ combine: (e) => e.indexOf(!0) > -1 }), Oo = /*@__PURE__*/ Bt.newName(), ko = /*@__PURE__*/ Bt.newName(), Ao = /*@__PURE__*/ Bt.newName(), jo = {
	"&light": "." + ko,
	"&dark": "." + Ao
};
function Mo(e, t, n) {
	return new Bt(t, { finish(t) {
...
var No = /*@__PURE__*/ Mo("." + Oo, {
...
}, Fo = I.ie && I.ie_version <= 11, Io = class {
	constructor(e) {
		...
		}), window.EditContext && I.android && e.constructor.EDIT_CONTEXT !== !1 && !(I.chrome && I.chrome_version < 126) && (this.editContext = new Bo(e), e.state.facet(Mr) && (e.contentDOM.editContext = this.editContext.editContext)), Fo && (this.onCharData = (e) => {
			this.queue.push({
				target: e.target,
				type: "characterData",
	...
	onSelectionChange(e) {
		...
		if (n.state.facet(Mr) ? n.root.activeElement != this.dom : !Cn(this.dom, r)) return;
		let i = r.anchorNode && n.docView.tile.nearest(r.anchorNode);
		if (i && i.isWidget() && i.widget.ignoreEvent(e)) {
			t || (this.selectionChanged = !1);
			return;
		}
		(I.ie && I.ie_version <= 11 || I.android && I.chrome) && !n.state.selection.main.empty && r.focusNode && Tn(r.focusNode, r.focusOffset, r.anchorNode, r.anchorOffset) ? this.flushSoon() : this.flush(!1);
	}
	readSelectionRange() {
		let { view: e } = this, t = xn(e.root);
		if (!t) return !1;
		let n = I.safari && e.root.nodeType == 11 && e.root.activeElement == this.dom && zo(this.view, t) || t;
		if (!n || this.selectionRange.eq(n)) return !1;
		let r = Cn(this.dom, n);
		return r && !this.selectionChanged && e.inputState.lastFocusTime > Date.now() - 200 && e.inputState.lastTouchTime < Date.now() - 300 && Wn(this.dom, n) ? (this.view.inputState.lastFocusTime = 0, e.docView.updateSelection(), !1) : (this.selectionRange.setRange(n), r && (this.selectionChanged = !0), !0);
	}
	...
	delayAndroidKey(e, t) {
		if (!this.delayedAndroidKey) {
			let e = () => {
				...
				e && (this.clearDelayedAndroidKey(), this.view.inputState.lastKeyCode = e.keyCode, this.view.inputState.lastKeyTime = Date.now(), !this.flush() && e.force && Hn(this.dom, e.key, e.keyCode));
			};
	...
	flush(e = !0) {
		...
		let n = this.view.state, r = ta(this.view, t);
		return this.view.state == n && (t.domChanged || t.newSel && !sa(this.view.state.selection, t.newSel.main)) && this.view.update([]), r;
	}
	readMutation(e) {
	...
	update(e) {
		this.editContext && (this.editContext.update(e), e.startState.facet(Mr) != e.state.facet(Mr) && (e.view.contentDOM.editContext = e.state.facet(Mr) ? this.editContext.editContext : null));
	}
	destroy() {
		var e, t, n;
...
function Ro(e, t) {
	...
	return Tn(o.node, o.offset, i, a) && ([n, r, i, a] = [
		i,
		a,
		n,
		r
...
var Bo = class {
	constructor(e) {
		...
		this.handlers.textupdate = (n) => {
			...
			let l = ia(e.state.sliceDoc(o, s), n.text, (c ? r.from : r.to) - o, c ? "end" : null);
			if (!l) {
			...
			if ((I.mac || I.android) && u.from == a - 1 && /^\. ?$/.test(n.text) && e.contentDOM.getAttribute("autocorrect") == "off" && (u = {
				...
				na(e, u, E.single(this.toEditorPos(n.selectionStart, t), this.toEditorPos(n.selectionEnd, t)));
			}
			...
			e.dispatch({ effects: Ar.of(R.set(n)) });
	...
	constructor(e = {}) {
		...
		let { dispatch: t } = e;
		this.dispatchTransactions = e.dispatchTransactions || t && ((e) => e.forEach((e) => t(e, this))) || ((e) => this.update(e)), this.dispatch = this.dispatch.bind(this), this._root = e.root || Un(e.parent) || document, this.viewState = new go(this, e.state || j.create(e)), e.scrollTo && e.scrollTo.is(kr) && (this.viewState.scrollTarget = e.scrollTo.value.clip(this.viewState.state)), this.plugins = this.state.facet(Pr).map((e) => new Fr(e));
		for (let e of this.plugins) e.update(this);
		this.observer = new Io(this), this.inputState = new ca(this), this.inputState.ensureHandlers(this.plugins), this.docView = new Si(this), this.mountStyles(), this.updateAttrs(), this.updateState = 0, this.requestMeasure(), document.fonts?.ready && document.fonts.ready.then(() => {
			this.viewState.mustMeasureContent = "refresh", this.requestMeasure();
		});
	}
	dispatch(...e) {
		let t = e.length == 1 && e[0] instanceof rt ? e : e.length == 1 && Array.isArray(e[0]) ? e[0] : [this.state.update(...e)];
	...
	update(t) {
		...
		try {
			...
			for (let n of t) {
				if (d &&= d.map(n.changes), n.scrollIntoView) {
					...
					d = new Or(t.empty ? t : E.cursor(t.head, t.head > t.anchor ? -1 : 1), "nearest", "nearest", i, r);
				}
				for (let e of n.effects) e.is(kr) && (d = e.value.clip(this.state));
			}
		...
		if (i.startState.facet(Eo) != i.state.facet(Eo) && (this.viewState.mustMeasureContent = !0), (n || r || d || this.viewState.mustEnforceCursorAssoc || this.viewState.mustMeasureContent) && this.requestMeasure(), n && this.docViewUpdate(), !i.empty) for (let e of this.state.facet(br)) try {
			e(i);
		} catch (e) {
			jr(this.state, e, "update listener");
		}
		(c || u) && Promise.resolve().then(() => {
			c && this.state == c.startState && this.dispatch(c), u && !ta(this, u) && l.force && Hn(this.contentDOM, l.key, l.keyCode);
		});
	}
	setState(e) {
		...
		try {
			...
			this.viewState = new go(this, e), this.plugins = e.facet(Pr).map((e) => new Fr(e)), this.pluginMap.clear();
			for (let e of this.plugins) e.update(this);
	...
	updatePlugins(e) {
		let t = e.startState.facet(Pr), n = e.state.facet(Pr);
		if (t != n) {
			let r = [];
			for (let i of n) {
				let n = t.indexOf(i);
				if (n < 0) r.push(new Fr(i));
				else {
	...
	docViewUpdate() {
		for (let e of this.plugins) {
			...
			if (t && t.docViewUpdate) try {
				...
				jr(this.state, e, "doc view update listener");
			}
		}
	}
	measure(e = !0) {
		...
		try {
			for (let e = 0;; e++) {
				if (a < 0) {
					if (Gn(n || this.win)) i = -1, a = this.viewState.heightMap.height;
					else {
		...
		if (t && !t.empty) for (let e of this.state.facet(br)) e(t);
	}
	get themeClasses() {
		return Oo + " " + (this.state.facet(Do) ? Ao : ko) + " " + this.state.facet(Eo);
	}
	updateAttrs() {
		let e = Wo(this, Ir, { class: "cm-editor" + (this.hasFocus ? " cm-focused " : " ") + this.themeClasses }), t = {
			spellcheck: "false",
			autocorrect: "off",
			autocapitalize: "off",
			writingsuggestions: "false",
			translate: "no",
			contenteditable: this.state.facet(Mr) ? "true" : "false",
			class: "cm-content",
			style: `${I.tabSize}: ${this.state.tabSize}`,
			role: "textbox",
			"aria-multiline": "true"
		};
		this.state.readOnly && (t["aria-readonly"] = "true"), Wo(this, Lr, t);
	...
	mountStyles() {
		...
		Bt.mount(this.root, this.styleModules.concat(No).reverse(), t ? { nonce: t } : void 0);
	}
	readMeasured() {
	...
	moveByChar(e, t, n) {
		return Wi(this, e, zi(this, e, t, n));
	}
	moveByGroup(e, t) {
		return Wi(this, e, zi(this, e, t, (t) => Bi(this, e.head, t)));
	}
	visualLineSide(e, t) {
	...
	moveVertically(e, t, n) {
		return Wi(this, e, Vi(this, e, t, n));
	}
	domAtPos(e, t = 1) {
	...
	coordsAtPos(e, t = 1) {
		this.readMeasured();
		let n = this.state.doc.lineAt(e), r = this.bidiSpans(n), i = r[ir.find(r, e - n.from, -1, t)];
	...
	textDirectionAt(e) {
		return !this.state.facet(Tr) || e < this.viewport.from || e > this.viewport.to ? this.textDirection : (this.readMeasured(), this.docView.textDirectionAt(e));
	}
	get lineWrapping() {
		return this.viewState.heightOracle.lineWrapping;
	}
	bidiSpans(e) {
		if (e.length > Vo) return fr(e.length);
		let t = this.textDirectionAt(e.from), n;
		for (let r of this.bidiCache) if (r.from == e.from && r.dir == t && (r.fresh || ar(r.isolates, n = Ur(this, e)))) return r.order;
		n ||= Ur(this, e);
		let r = dr(e.text, t, n);
	...
	static scrollIntoView(e, t = {}) {
		return kr.of(new Or(typeof e == "number" ? E.cursor(e) : e, t.y ?? "nearest", t.x ?? "nearest", t.yMargin ?? 5, t.xMargin ?? 5));
	}
	scrollSnapshot() {
		let { scrollTop: e, scrollLeft: t } = this.scrollDOM, n = this.viewState.scrollAnchorAt(e);
		return kr.of(new Or(E.cursor(n.from), "start", "start", n.top - e, t, !0));
	}
	setTabFocusMode(e) {
	...
	static theme(e, t) {
		let n = Bt.newName(), r = [Eo.of(n), Kr.of(Mo(`.${n}`, e))];
		return t && t.dark && r.push(Do.of(!0)), r;
	}
	static baseTheme(e) {
		return ze.lowest(Kr.of(Mo("." + Oo, e, jo)));
	}
...
G.styleModule = Kr, G.inputHandler = xr, G.clipboardInputFilter = Cr, G.clipboardOutputFilter = wr, G.scrollHandler = Dr, G.focusChangeEffect = Sr, G.perLineTextDirection = Tr, G.exceptionSink = yr, G.updateListener = br, G.editable = Mr, G.mouseSelectionStyle = vr, G.dragMovesSelection = _r, G.clickAddsSelectionRange = gr, G.decorations = Rr, G.blockWrappers = zr, G.outerDecorations = Br, G.atomicRanges = Vr, G.bidiIsolatedRanges = Hr, G.cursorScrollMargin = /*@__PURE__*/ D.define({ combine: (e) => {
	let t = 5, n = 5;
...
} }), G.scrollMargins = Wr, G.darkTheme = Do, G.cspNonce = /*@__PURE__*/ D.define({ combine: (e) => e.length ? e[0] : "" }), G.contentAttributes = Lr, G.editorAttributes = Ir, G.lineWrapping = /*@__PURE__*/ G.contentAttributes.of({ class: "cm-lineWrapping" }), G.announce = /*@__PURE__*/ k.define();
...
var Go = I.mac ? "mac" : I.windows ? "win" : I.linux ? "linux" : "key";
function Ko(e, t) {
...
var Jo = /*@__PURE__*/ ze.default(/*@__PURE__*/ G.domEventHandlers({ keydown(e, t) {
	return rs(Zo(t.state), e, t, "editor");
} })), Yo = /*@__PURE__*/ D.define({ enables: Jo }), Xo = /*@__PURE__*/ new WeakMap();
function Zo(e) {
...
function rs(e, t, n, r) {
	ns = t;
	let i = Jt(t), a = ve(w(i, 0)) == i.length && i != " ", o = "", s = !1, c = !1, l = !1;
	$o && $o.view == n && $o.scope == r && (o = $o.prefix + " ", ma.indexOf(t.keyCode) < 0 && (c = !0, $o = null));
	...
	return f && (d(f[o + qo(i, t, !a)]) ? s = !0 : a && (t.altKey || t.metaKey || t.ctrlKey) && !(I.windows && t.ctrlKey && t.altKey) && !(I.mac && t.altKey && !(t.ctrlKey || t.metaKey)) && (p = Ut[t.keyCode]) && p != i ? (d(f[o + qo(p, t, !0)]) || t.shiftKey && (m = Wt[t.keyCode]) != i && m != p && d(f[o + qo(m, t, !1)])) && (s = !0) : a && t.shiftKey && d(f[o + qo(i, t, !0)]) && (s = !0), !s && d(f._any) && (s = !0)), c && (s = !0), s && l && t.stopPropagation(), ns = null, s;
}
var is = class e {
	constructor(e, t, n, r, i) {
...
}, us = /*@__PURE__*/ D.define();
function ds(e) {
	return [V.define((t) => new ls(t, e)), us.of(e)];
}
var fs = /*@__PURE__*/ D.define({ combine(e) {
	return gt(e, {
...
var _s = /*@__PURE__*/ ds({
	...
	markers(e) {
		...
		if (I.ios && !n.empty && e.state.facet(fs).iosSelectionHandles) {
			for (let r of is.forRange(e, "cm-selectionHandle cm-selectionHandle-start", E.cursor(n.from, 1))) t.push(r);
			for (let r of is.forRange(e, "cm-selectionHandle cm-selectionHandle-end", E.cursor(n.to, 1))) t.push(r);
		}
		return t;
	},
	update(e, t) {
...
}), vs = I.gecko && I.gecko_version == 153 ? "#ffffff01" : "transparent", ys = /*@__PURE__*/ ze.highest(/*@__PURE__*/ G.theme({
	".cm-line": {
		"& ::selection, &::selection": { backgroundColor: `${vs} !important` },
...
})), bs = /*@__PURE__*/ k.define({ map(e, t) {
	return e == null ? null : t.mapPos(e);
} }), xs = /*@__PURE__*/ O.define({
	create() {
		return null;
	},
	update(e, t) {
		return e != null && (e = t.changes.mapPos(e)), t.effects.reduce((e, t) => t.is(bs) ? t.value : e, e);
	}
}), Ss = /*@__PURE__*/ V.fromClass(class {
	constructor(e) {
	...
	update(e) {
		var t;
		let n = e.state.field(xs);
		n == null ? this.cursor != null && ((t = this.cursor) == null || t.remove(), this.cursor = null) : (this.cursor || (this.cursor = this.view.scrollDOM.appendChild(document.createElement("div")), this.cursor.className = "cm-dropCursor"), (e.startState.field(xs) != n || e.docChanged || e.geometryChanged) && this.view.requestMeasure(this.measureReq));
	}
	readPos() {
		let { view: e } = this, t = e.state.field(xs), n = t != null && e.coordsAtPos(t);
		if (!n) return null;
	...
	setDropPos(e) {
		this.view.state.field(xs) != e && this.view.dispatch({ effects: bs.of(e) });
	}
}, { eventObservers: {
	dragover(e) {
...
var Es = class {
	...
	createDeco(e) {
		...
		for (let { from: t, to: r } of Ts(e, this.maxLength)) ws(e.state.doc, this.regexp, t, r, (t, r) => this.addMatch(r, e, t, n));
		return t.finish();
	}
	updateDeco(e, t) {
		let n = 1e9, r = -1;
	...
	updateRange(e, t, n, r) {
		for (let i of e.visibleRanges) {
			...
			if (o >= a) {
				...
				else ws(e.state.doc, this.regexp, s, c, (t, n) => this.addMatch(n, e, t, d));
				t = t.update({
					filterFrom: s,
					filterTo: c,
					filter: (e, t) => e < s || t > c,
...
}, Ds = /x/.unicode == null ? "g" : "gu", Os = /*@__PURE__*/ RegExp("[\0-\b\n--­؜​‎‏\u2028\u2029‭‮⁦⁧⁩﻿￹-￼]", Ds), ks = {
	0: "null",
	7: "bell",
	8: "backspace",
	10: "newline",
...
function js() {
	if (As == null && typeof document < "u" && document.body) {
		...
		As = (e.tabSize ?? e.MozTabSize) != null;
	}
	return As || !1;
}
var Ms = /*@__PURE__*/ D.define({ combine(e) {
	...
	return (t.replaceTabs = !js()) && (t.specialChars = RegExp("	|" + t.specialChars.source, Ds)), t.addSpecialChars && (t.specialChars = RegExp(t.specialChars.source + "|" + t.addSpecialChars.source, Ds)), t;
} });
function Ns(e = {}) {
	return [Ms.of(e), Fs()];
}
	...
	return Ps ||= V.fromClass(class {
		...
		makeDecorator(e) {
			return new Es({
				...
				decoration: (t, n, r) => {
					let { doc: i } = n.state, a = w(t[0], 0);
					if (a == 9) {
						let e = i.lineAt(r), t = n.state.tabSize, a = Pt(e.text, t, r - e.from);
						return R.replace({ widget: new zs((t - a % t) * this.view.defaultCharacterWidth / this.view.scaleX) });
					}
					return this.decorationCache[a] || (this.decorationCache[a] = R.replace({ widget: new Rs(e, a) }));
				},
...
var Is = "•";
function Ls(e) {
	return e >= 32 ? Is : e == 10 ? "␤" : String.fromCharCode(9216 + e);
}
var Rs = class extends pn {
	constructor(e, t) {
	...
	toDOM(e) {
		let t = Ls(this.code), n = e.state.phrase("Control character") + " " + (ks[this.code] || "0x" + this.code.toString(16)), r = this.options.render && this.options.render(this.code, n, t);
		if (r) return r;
...
var Vs = /*@__PURE__*/ R.line({ class: "cm-activeLine" }), Hs = /*@__PURE__*/ V.fromClass(class {
	constructor(e) {
...
}, { decorations: (e) => e.decorations }), Us = 2e3;
function Ws(e, t, n) {
	let r = Math.min(t.line, n.line), i = Math.max(t.line, n.line), a = [];
	if (t.off > Us || n.off > Us || t.col < 0 || n.col < 0) {
		...
		for (let t = r; t <= i; t++) {
			let n = e.doc.line(t), r = Ft(n.text, o, e.tabSize, !0);
			if (r < 0) a.push(E.cursor(n.to));
			else {
				let t = Ft(n.text, s, e.tabSize);
...
function Ks(e, t) {
	let n = e.posAtCoords({
		x: t.clientX,
		y: t.clientY
	}, !1), r = e.state.doc.lineAt(n), i = n - r.from, a = i > Us ? -1 : i == r.length ? Gs(e, t.clientX) : Pt(r.text, e.state.tabSize, n - r.from);
	return {
		line: r.number,
		col: a,
		off: i
...
function Js(e) {
	...
	return G.mouseSelectionStyle.of((e, n) => t(n) ? qs(e, n) : null);
}
var Ys = {
	Alt: [18, (e) => !!e.altKey],
	...
	Meta: [91, (e) => !!e.metaKey]
}, Xs = { style: "cursor: crosshair" };
function Zs(e = {}) {
	let [t, n] = Ys[e.key || "Alt"], r = V.fromClass(class {
		constructor(e) {
	...
	return [r, G.contentAttributes.of((e) => e.plugin(r)?.isDown ? Xs : null)];
}
var Qs = "-10000px", $s = class {
	constructor(e, t, n, r) {
...
var tc = /*@__PURE__*/ D.define({ combine: (e) => ({
	position: I.ios ? "absolute" : e.find((e) => e.position)?.position || "fixed",
	parent: e.find((e) => e.parent)?.parent || null,
	tooltipSpace: e.find((e) => e.tooltipSpace)?.tooltipSpace || ec
}) }), nc = /*@__PURE__*/ new WeakMap(), rc = /*@__PURE__*/ V.fromClass(class {
	constructor(e) {
		...
		this.position = t.position, this.parent = t.parent, this.classes = e.themeClasses, this.createContainer(), this.measureReq = {
			...
			key: this
		}, this.resizeObserver = typeof ResizeObserver == "function" ? new ResizeObserver(() => this.measureSoon()) : null, this.manager = new $s(e, sc, (e, t) => this.createTooltip(e, t), (e) => {
	...
	update(e) {
		...
		let n = t || e.geometryChanged, r = e.state.facet(tc);
	...
	createTooltip(e, t) {
		...
		return n.dom.style.position = this.position, n.dom.style.top = Qs, n.dom.style.left = "0px", this.container.insertBefore(n.dom, r), n.mount && n.mount(this.view), this.resizeObserver && this.resizeObserver.observe(n.dom), n;
	}
	destroy() {
		var e, t, n;
	...
	readMeasure() {
		...
		let r = this.view.scrollDOM.getBoundingClientRect(), i = Gr(this.view);
		return {
			visible: {
				left: r.left + i.left,
				top: r.top + i.top,
			...
			space: this.view.state.facet(tc).tooltipSpace(this.view),
			scaleX: e,
			scaleY: t,
			makeAbsolute: n
		};
	...
	writeMeasure(e) {
		...
		for (let o = 0; o < this.manager.tooltips.length; o++) {
			...
			let f = s.arrow ? c.dom.querySelector(".cm-tooltip-arrow") : null, p = f ? 7 : 0, m = d.right - d.left, h = nc.get(c) ?? d.bottom - d.top, g = c.offset || oc, _ = this.view.textDirection == z.LTR, v = d.width > n.right - n.left ? _ ? n.left : n.right - d.width : _ ? Math.max(n.left, Math.min(u.left - (f ? 14 : 0) + g.x, n.right - m)) : Math.min(Math.max(n.left, u.left - m + (f ? 14 : 0) - g.x), n.right - m), y = this.above[o];
			...
			if (ee < h && c.resize !== !1) {
				...
				nc.set(c, h), l.style.height = (h = ee) / i + "px";
			...
			if (this.position == "absolute" ? (l.style.top = (b - e.parent.top) / i + "px", ic(l, (v - e.parent.left) / r)) : (l.style.top = b / i + "px", ic(l, v / r)), f) {
	...
	maybeMeasure() {
		if (this.manager.tooltips.length && (this.view.inView && this.view.requestMeasure(this.measureReq), this.inView != this.view.inView && (this.inView = this.view.inView, !this.inView))) for (let e of this.manager.tooltipViews) e.dom.style.top = Qs;
	}
...
var ac = /*@__PURE__*/ G.baseTheme({
	...
	x: 0,
	y: 0
}, sc = /*@__PURE__*/ D.define({ enables: [rc, ac] }), cc = /*@__PURE__*/ D.define({ combine: (e) => e.reduce((e, t) => e.concat(t), []) }), lc = class e {
	static create(t) {
		return new e(t);
	}
	constructor(e) {
		this.view = e, this.mounted = !1, this.dom = document.createElement("div"), this.dom.classList.add("cm-tooltip-hover"), this.manager = new $s(e, cc, (e, t) => this.createHostedView(e, t), (e) => e.dom.remove());
	}
	...
	activateHover(e, t, n, r) {
		...
		if (i && "then" in i) {
			...
			}, (t) => jr(e.state, t, "hover tooltip"));
		} else a(i);
	}
	get tooltip() {
		let e = this.view.plugin(rc), t = e ? e.manager.tooltips.findIndex((e) => e.create == lc.create) : -1;
	...
	mousemove(e) {
		...
		if (t.length && !this.locked.has(t) && n && !mc(n.dom, e) || this.pending) {
			let { pos: n } = t[0] || this.pending, r = t[0]?.end ?? n;
			(n == r ? this.view.posAtCoords(this.lastMove) != n : !hc(this.view, n, r, e.clientX, e.clientY)) && (this.view.dispatch({ effects: this.setHover.of([]) }), this.pending = null);
		}
	}
	mouseleave(e) {
	...
	let n = k.define(), r = /* @__PURE__ */ new WeakMap(), i = O.define({
		...
		update(e, a) {
			...
			if (e.length && (t.hideOnChange && (a.docChanged || a.selection) || o && o(a) ? e = [] : t.hideOn && (e = e.filter((e) => !t.hideOn(a, e)))), a.docChanged && e.length) {
				let t = [];
				for (let n of e) {
					let e = a.changes.mapPos(n.pos, -1, be.TrackDel);
					if (e != null) {
			...
			for (let t of a.effects) t.is(n) && (e = t.value, o = void 0), (t.is(yc) && !t.value || t.value == i) && (e = []);
			return e.length && o && r.set(e, o), e;
		},
		provide: (e) => cc.from(e)
	}), a = V.define((a) => new fc(a, e, i, r, n, t.hoverTime || 300));
	return {
		active: i,
		extension: [
			i,
...
function _c(e, t, n, r = {}) {
	let i = e.state.facet(dc).map((t) => e.plugin(t)).filter((e) => !!e);
...
var yc = /*@__PURE__*/ k.define(), bc = /*@__PURE__*/ D.define({ combine(e) {
	let t, n;
...
function xc(e, t) {
	let n = e.plugin(Sc), r = n ? n.specs.indexOf(t) : -1;
	return r > -1 ? n.panels[r] : null;
}
var Sc = /*@__PURE__*/ V.fromClass(class {
	constructor(e) {
		this.input = e.state.facet(Tc), this.specs = this.input.filter((e) => e), this.panels = this.specs.map((t) => t(e));
		let t = e.state.facet(bc);
		this.top = new Cc(e, !0, t.topContainer), this.bottom = new Cc(e, !1, t.bottomContainer), this.top.sync(this.panels.filter((e) => e.top)), this.bottom.sync(this.panels.filter((e) => !e.top));
		for (let e of this.panels) e.dom.classList.add("cm-panel"), e.mount && e.mount();
	}
	update(e) {
		let t = e.state.facet(bc);
		this.top.container != t.topContainer && (this.top.sync([]), this.top = new Cc(e.view, !0, t.topContainer)), this.bottom.container != t.bottomContainer && (this.bottom.sync([]), this.bottom = new Cc(e.view, !1, t.bottomContainer)), this.top.syncClasses(), this.bottom.syncClasses();
		let n = e.state.facet(Tc);
		if (n != this.input) {
...
var Tc = /*@__PURE__*/ D.define({ enables: Sc });
function Ec(e, t) {
	let n, r = new Promise((e) => n = e), i = (e) => Ac(e, t, n);
	e.state.field(Dc, !1) ? e.dispatch({ effects: Oc.of(i) }) : e.dispatch({ effects: k.appendConfig.of(Dc.init(() => [i])) });
	let a = kc.of(i);
	return {
		close: a,
		result: r.then((t) => ((e.win.queueMicrotask || ((t) => e.win.setTimeout(t, 10)))(() => {
			e.state.field(Dc).indexOf(i) > -1 && e.dispatch({ effects: a });
		}), t))
	};
}
var Dc = /*@__PURE__*/ O.define({
	create() {
		return [];
	},
	update(e, t) {
		for (let n of t.effects) n.is(Oc) ? e = [n.value].concat(e) : n.is(kc) && (e = e.filter((e) => e != n.value));
		return e;
	},
	provide: (e) => Tc.computeN([e], (t) => t.field(e))
}), Oc = /*@__PURE__*/ k.define(), kc = /*@__PURE__*/ k.define();
function Ac(e, t, n) {
...
jc.prototype.elementClass = "", jc.prototype.toDOM = void 0, jc.prototype.mapMode = be.TrackBefore, jc.prototype.startSide = jc.prototype.endSide = -1, jc.prototype.point = !0;
var Mc = /*@__PURE__*/ D.define(), Nc = /*@__PURE__*/ D.define(), Pc = {
	class: "",
...
var Lc = /*@__PURE__*/ D.define({ combine: (e) => e.some((e) => e) });
function Rc(e) {
	let t = [zc];
	return e && e.fixed === !1 && t.push(Lc.of(!0)), t;
}
var zc = /*@__PURE__*/ V.fromClass(class {
	constructor(e) {
		this.view = e, this.domAfter = null, this.prevViewport = e.viewport, this.dom = document.createElement("div"), this.dom.className = "cm-gutters cm-gutters-before", this.dom.setAttribute("aria-hidden", "true"), this.dom.style.minHeight = this.view.contentHeight / this.view.scaleY + "px", this.gutters = e.state.facet(Fc).map((t) => new Uc(e, t)), this.fixed = !e.state.facet(Lc);
	...
	update(e) {
		...
		this.view.state.facet(Lc) != !this.fixed && (this.fixed = !this.fixed, this.dom.style.position = this.fixed ? "sticky" : "", this.domAfter && (this.domAfter.style.position = this.fixed ? "sticky" : "")), this.prevViewport = e.view.viewport;
	}
	syncGutters(e) {
		let t = this.dom.nextSibling;
		e && (this.dom.remove(), this.domAfter && this.domAfter.remove());
		let n = M.iter(this.view.state.facet(Mc), this.view.viewport.from), r = [], i = this.gutters.map((e) => new Hc(e, this.view.viewport, -this.view.documentPadding.top));
	...
	updateGutters(e) {
		let t = e.startState.facet(Fc), n = e.state.facet(Fc), r = e.docChanged || e.heightChanged || e.viewportChanged || !M.eq(e.startState.facet(Mc), e.state.facet(Mc), e.view.viewport.from, e.view.viewport.to);
		if (t == n) for (let t of this.gutters) t.update(e) && (r = !0);
			...
			for (let r of n) {
				let n = t.indexOf(r);
				n < 0 ? i.push(new Uc(this.view, r)) : (this.gutters[n].update(e), i.push(this.gutters[n]));
			}
...
var Hc = class {
	...
	line(e, t, n) {
		let r = [];
		Vc(this.cursor, r, t.from), n.length && (r = r.concat(n));
	...
	constructor(e, t) {
		...
		this.markers = Bc(t.markers(e)), t.initialSpacer && (this.spacer = new Wc(e, 0, 0, [t.initialSpacer(e)]), this.dom.appendChild(this.spacer.dom), this.spacer.dom.style.cssText += "visibility: hidden; pointer-events: none");
	}
	update(e) {
		let t = this.markers;
		if (this.markers = Bc(this.config.markers(e.view)), this.spacer && this.config.updateSpacer) {
	...
	update(e, t, n, r) {
		this.height != t && (this.height = t, this.dom.style.height = t + "px"), this.above != n && (this.dom.style.marginTop = (this.above = n) ? n + "px" : ""), Gc(this.markers, r) || this.setMarkers(e, r);
	}
	setMarkers(e, t) {
...
var Kc = /*@__PURE__*/ D.define(), qc = /*@__PURE__*/ D.define(), Jc = /*@__PURE__*/ D.define({ combine(e) {
	return gt(e, {
		formatNumber: String,
		domEventHandlers: {}
...
var Zc = /*@__PURE__*/ Fc.compute([Jc], (e) => ({
	...
	lineMarker(e, t, n) {
		return n.some((e) => e.toDOM) ? null : new Yc(Xc(e, e.state.doc.lineAt(t.from).number));
	},
	widgetMarker: (e, t, n) => {
		for (let r of e.state.facet(qc)) {
			let i = r(e, t, n);
			if (i) return i;
		}
		return null;
	...
	initialSpacer(e) {
		return new Yc(Xc(e, $c(e.state.doc.lines)));
	},
	updateSpacer(e, t) {
		let n = Xc(t.view, $c(t.view.state.doc.lines));
		return n == e.number ? e : new Yc(n);
	},
...
var el = /*@__PURE__*/ new class extends jc {
	constructor() {
		super(...arguments), this.elementClass = "cm-activeLineGutter";
	}
}(), tl = /*@__PURE__*/ Mc.compute(["selection"], (e) => {
	let t = [], n = -1;
	for (let r of e.selection.ranges) {
		let i = e.doc.lineAt(r.head).from;
		i > n && (n = i, t.push(el.range(i)));
	}
	return M.of(t);
});
function nl() {
...
var rl = 1024, il = 0, al = class {
	constructor(e, t) {
		this.from = e, this.to = t;
	}
}, K = class {
	constructor(e = {}) {
		this.id = il++, this.perNode = !!e.perNode, this.deserialize = e.deserialize || (() => {
	...
	add(e) {
		...
		return typeof e != "function" && (e = cl.match(e)), (t) => {
			let n = e(t);
...
}, sl = Object.create(null), cl = class e {
	constructor(e, t, n, r = 0) {
		this.name = e, this.props = t, this.id = n, this.flags = r;
	}
	static define(t) {
		let n = t.props && t.props.length ? Object.create(null) : sl, r = !!t.top | (t.skipped ? 2 : 0) | (t.error ? 4 : 0) | (t.name == null ? 8 : 0), i = new e(t.name || "", n, t.id, r);
		if (t.props) {
...
cl.none = new cl("", Object.create(null), 0, 8);
var ll = /* @__PURE__ */ new WeakMap(), ul = /* @__PURE__ */ new WeakMap(), q;
(function(e) {
...
var dl = class e {
	...
	cursorAt(e, t = 0, n = 0) {
		let r = new Tl(ll.get(this) || this.topNode);
		return r.moveTo(e, t), ll.set(this, r._tree), r;
	}
	get topNode() {
		return new _l(this, 0, 0, null);
	}
	resolve(e, t = 0) {
		let n = hl(ll.get(this) || this.topNode, e, t, !1);
		return ll.set(this, n), n;
	}
	resolveInner(e, t = 0) {
		let n = hl(ul.get(this) || this.topNode, e, t, !0);
		return ul.set(this, n), n;
	}
	resolveStack(e, t = 0) {
		return wl(this, e, t);
	}
	...
	balance(t = {}) {
		return this.children.length <= 8 ? this : Al(cl.none, this.children, this.positions, 0, this.children.length, 0, this.length, (t, n, r) => new e(this.type, t, n, r, this.propValues), t.makeTree || ((t, n, r) => new e(cl.none, t, n, r)));
	}
	static build(e) {
		return Dl(e);
	}
};
dl.empty = new dl(cl.none, [], [], 0);
var fl = class e {
	constructor(e, t) {
	...
	findChild(e, t, n, r, i) {
		...
		for (let s = e; s != t && !(ml(i, r, a[s + 1], a[s + 2]) && (o = s, n > 0)); s = a[s + 3]);
		return o;
	}
	slice(t, n, r) {
...
function hl(e, t, n, r) {
	for (; e.from == e.to || (n < 1 ? e.from >= t : e.from > t) || (n > -1 ? e.to <= t : e.to < t);) {
		let t = !r && e instanceof _l && e.index < 0 ? null : e.parent;
		if (!t) return e;
		e = t;
	}
	let i = r ? 0 : q.IgnoreOverlays;
	if (r) for (let r = e, a = r.parent; a; r = a, a = r.parent) r instanceof _l && r.index < 0 && a.enter(t, n, i)?.from != r.from && (e = a);
	for (;;) {
		let r = e.enter(t, n, i);
		if (!r) return e;
		e = r;
...
var gl = class {
	...
	nextChild(t, n, r, i, a = 0) {
		for (let o = this;;) {
			for (let { children: s, positions: c } = o._tree, l = n > 0 ? s.length : -1; t != l; t += n) {
				...
				if (!(!(a & q.EnterBracketed && l instanceof dl && (d = ol.get(l)) && !d.overlay && d.bracketed && r >= u && r <= u + l.length) && !ml(i, r, u, u + l.length))) {
					if (l instanceof pl) {
						if (a & q.ExcludeBuffers) continue;
						let e = l.findChild(0, l.buffer.length, n, r - u, i);
						if (e > -1) return new xl(new bl(o, l, t, u), null, e);
					} else if (a & q.IncludeAnonymous || !l.type.isAnonymous || El(l)) {
						let s;
						if (!(a & q.IgnoreMounts) && (s = ol.get(l)) && !s.overlay) return new e(s.tree, u, t, o);
						let c = new e(l, u, t, o);
	...
	enter(t, n, r = 0) {
		let i;
		if (!(r & q.IgnoreOverlays) && (i = ol.get(this._tree)) && i.overlay) {
...
var bl = class {
	...
	toTree() {
		...
		return new dl(this.type, e, t, this.to - this.from);
	}
	toString() {
...
function Sl(e) {
	...
	let r = n instanceof _l && n.index < 0 ? null : n.parent, i = e.slice();
	return r ? i[t] = r : i.splice(t, 1), new Cl(i, n);
}
var Cl = class {
	constructor(e, t) {
	...
	get next() {
		return Sl(this.heads);
	}
};
function wl(e, t, n) {
	let r = e.resolveInner(t, n), i = null;
	for (let e = r instanceof _l ? r : r.context.parent; e; e = e.parent) if (e.index < 0) {
		let a = e.parent;
		(i ||= [r]).push(a.resolve(t, n)), e = a;
	} else {
		let a = ol.get(e.tree);
		if (a && a.overlay && a.overlay[0].from <= t && a.overlay[a.overlay.length - 1].to >= t) {
			let o = new _l(a.tree, a.overlay[0].from + e.from, -1, e);
			(i ||= [r]).push(hl(o, t, n, !1));
		}
	}
	return i ? Sl(i) : r;
...
var Tl = class {
	...
	constructor(e, t = 0) {
		if (this.buffer = null, this.stack = [], this.index = 0, this.bufferNode = null, this.mode = t & ~q.EnterBracketed, e instanceof _l) this.yieldNode(e);
		else {
	...
	yield(e) {
		return e ? e instanceof _l ? (this.buffer = null, this.yieldNode(e)) : (this.buffer = e.context, this.yieldBuf(e.index, e.type)) : !1;
	}
	toString() {
	...
	atLastNode(e) {
		...
		for (; n; {index: t, _parent: n} = n) if (t > -1) for (let r = t + e, i = e < 0 ? -1 : n._tree.children.length; r != i; r += e) {
			...
			if (this.mode & q.IncludeAnonymous || e instanceof pl || !e.type.isAnonymous || El(e)) return !1;
		}
		return !0;
	}
	move(e, t) {
	...
	get node() {
		...
		for (let e = n; e < this.stack.length; e++) t = new xl(this.buffer, t, this.stack[e]);
		return this.bufferNode = new xl(this.buffer, t, this.index);
	}
	get tree() {
	...
	matchContext(e) {
		...
		for (let r = e.length - 1, i = this.stack.length - 1; r >= 0; i--) {
			if (i < 0) return yl(this._tree, e, r);
...
function El(e) {
	return e.children.some((e) => e instanceof pl || !e.type.isAnonymous || El(e));
}
function Dl(e) {
	let { buffer: t, nodeSet: n, maxBufferLength: r = rl, reused: i = [], minRepeatType: a = n.types.length } = e, o = Array.isArray(t) ? new fl(t, t.length) : t, s = n.types, c = 0, l = 0;
	function u(e, t, _, v, y, ee) {
		...
		if (ne - te <= r && (oe = h(o.pos - t, y))) {
			...
			if (i >= 0 && s > 0 && s < t.length && p(t, n, te, s, te, c, i, ie, ae), t.reverse(), n.reverse(), i > -1 && s > 0) {
				let e = f(x, ae);
				S = Al(x, t, n, 0, t.length, 0, ne - te, e, e);
			} else S = m(x, t, n, ne - te, ie - ne, ae);
		}
		_.push(S), v.push(se);
	}
	function d(e, t, i, a) {
		...
		if (c) {
			...
			i.push(new pl(t, s[2] - r, n)), a.push(r - e);
		}
	}
	function f(e, t) {
		return (n, r, i) => {
			let a = 0, o = n.length - 1, s, c;
			if (o >= 0 && (s = n[o]) instanceof dl) {
	...
	return new dl(s[e.topID], _.reverse(), v.reverse(), y);
}
var Ol = /* @__PURE__ */ new WeakMap();
function kl(e, t) {
	if (!e.isAnonymous || t instanceof pl || t.type != e) return 1;
	let n = Ol.get(t);
	if (n == null) {
		n = 1;
		for (let r of t.children) {
			if (r.type != e || !(r instanceof dl)) {
				n = 1;
				break;
			}
			n += kl(e, r);
...
function Al(e, t, n, r, i, a, o, s, c) {
	let l = 0;
	for (let n = r; n < i; n++) l += kl(e, t[n]);
	let u = Math.ceil(l * 1.5 / 8), d = [], f = [];
	function p(t, n, r, i, o) {
		for (let s = r; s < i;) {
			let r = s, l = n[s], m = kl(e, t[s]);
			for (s++; s < i; s++) {
				let n = kl(e, t[s]);
				if (m + n >= u) break;
				m += n;
			...
			if (s == r + 1) {
				...
				d.push(Al(e, t, n, r, s, l, i, null, c));
			}
			f.push(l + o - a);
		}
	}
...
var jl = class e {
	...
	startParse(e, t, n) {
		return typeof e == "string" && (e = new Nl(e)), n = n ? n.length ? n.map((e) => new al(e.from, e.to)) : [new al(0, 0)] : [new al(0, e.length)], this.createParse(e, t || [], n);
	}
	parse(e, t, n) {
...
var Pl = 0, Fl = class e {
	...
	static defineModifier(e) {
		let t = new Ll(e);
		return (e) => e.modified.indexOf(t) > -1 ? e : Ll.get(e.base || e, e.modified.concat(t).sort((e, t) => e.id - t.id));
	}
}, Il = 0, Ll = class e {
	constructor(e) {
		this.name = e, this.instances = [], this.id = Il++;
	}
	static get(t, n) {
		if (!n.length) return t;
		let r = n[0].instances.find((e) => e.base == t && Rl(n, e.modified));
		if (r) return r;
		let i = [], a = new Fl(t.name, i, t, n);
...
function Bl(e) {
	...
	for (let n in e) {
		...
		for (let e of n.split(" ")) if (e) {
			...
			t[s] = new Hl(r, i, o > 0 ? n.slice(0, o) : null).sort(t[s]);
		}
	}
	return Vl.add(t);
}
var Vl = new K({ combine(e, t) {
	let n, r, i;
	for (; e || t;) {
		if (!e || t && e.depth >= t.depth ? (i = t, t = t.next) : (i = e, e = e.next), n && n.mode == i.mode && !i.context && !n.context) continue;
		let a = new Hl(i.tags, i.mode, i.context);
		n ? n.next = a : r = a, n = a;
	}
	return r;
} }), Hl = class {
...
function Gl(e, t, n, r = 0, i = e.length) {
...
var Kl = class {
	...
	highlightRange(e, t, n, r, i) {
		...
		let c = r, l = ql(e) || Hl.empty, u = Wl(i, l.tags);
...
var J = Fl.define, Jl = J(), Yl = J(), Xl = J(Yl), Zl = J(Yl), Ql = J(), $l = J(Ql), eu = J(Ql), tu = J(), nu = J(tu), ru = J(), iu = J(), au = J(), ou = J(au), su = J(), Y = {
	comment: Jl,
	lineComment: J(Jl),
	blockComment: J(Jl),
	docComment: J(Jl),
	...
	unit: J(ru),
	modifier: J(ru),
	operatorKeyword: J(ru),
	controlKeyword: J(ru),
	definitionKeyword: J(ru),
	moduleKeyword: J(ru),
	operator: iu,
	derefOperator: J(iu),
	arithmeticOperator: J(iu),
	logicOperator: J(iu),
	bitwiseOperator: J(iu),
	compareOperator: J(iu),
	updateOperator: J(iu),
	definitionOperator: J(iu),
	typeOperator: J(iu),
	controlOperator: J(iu),
	punctuation: au,
	separator: J(au),
	bracket: ou,
	angleBracket: J(ou),
	...
	documentMeta: J(su),
	annotation: J(su),
	processingInstruction: J(su),
	definition: Fl.defineModifier("definition"),
	constant: Fl.defineModifier("constant"),
	function: Fl.defineModifier("function"),
	standard: Fl.defineModifier("standard"),
	local: Fl.defineModifier("local"),
	special: Fl.defineModifier("special")
};
for (let e in Y) {
	let t = Y[e];
	t instanceof Fl && (t.name = e);
}
Ul([
	{
		tag: Y.link,
...
var cu = /*@__PURE__*/ new K(), lu = /*@__PURE__*/ new K(), uu = class {
	constructor(e, t, n = [], r = "") {
		this.data = e, this.name = r, j.prototype.hasOwnProperty("tree") || Object.defineProperty(j.prototype, "tree", { get() {
			return X(this);
		} }), this.parser = t, this.extension = [bu.of(this), j.languageData.of((e, t, n) => {
			let r = du(e, t, n), i = r.type.prop(cu);
			if (!i) return [];
			let a = e.facet(i), o = r.type.prop(lu);
			if (o) {
	...
	isActiveAt(e, t, n = -1) {
		return du(e, t, n).type.prop(cu) == this.data;
	}
	findRegions(e) {
		let t = e.facet(bu);
		...
		let n = [], r = (e, t) => {
			...
			for (let n = 0; n < e.children.length; n++) {
				let i = e.children[n];
				i instanceof dl && r(i, e.positions[n] + t);
			}
		};
		return r(X(e), 0), n;
	}
...
uu.setState = /*@__PURE__*/ k.define();
function du(e, t, n) {
	let r = e.facet(bu), i = X(e).topNode;
	if (!r || r.allowsNesting) for (let e = i; e; e = e.enter(t, n, q.ExcludeBuffers | q.EnterBracketed)) e.type.isTop && (i = e);
	return i;
}
function X(e) {
	let t = e.field(uu.state, !1);
	return t ? t.tree : dl.empty;
}
var fu = class {
	constructor(e) {
	...
	static create(t, n, r) {
		return new e(t, n, [], dl.empty, 0, r, [], null);
	}
	startParse() {
		return this.parser.startParse(new fu(this.state.doc), this.fragments);
	}
	work(e, t) {
		return t != null && t >= this.state.doc.length && (t = void 0), this.tree != dl.empty && this.isDone(t ?? this.state.doc.length) ? (this.takeTree(), !0) : this.withContext(() => {
			if (typeof e == "number") {
				let t = Date.now() + e;
				e = () => Date.now() > t;
			}
			for (this.parse ||= this.startParse(), t != null && (this.parse.stoppedAt == null || this.parse.stoppedAt > t) && t < this.state.doc.length && this.parse.stopAt(t);;) {
				...
				if (n) {
					if (this.fragments = this.withoutTempSkipped(jl.addTree(n, this.fragments, this.parse.stoppedAt != null)), this.treeLen = this.parse.stoppedAt ?? this.state.doc.length, this.tree = n, this.parse = null, this.treeLen < (t ?? this.state.doc.length)) this.parse = this.startParse();
					else return !0;
				}
				if (e()) return !1;
			}
	...
	changes(t, n) {
		...
		if (this.takeTree(), !t.empty) {
			...
			if (t.iterChangedRanges((t, n, r, i) => e.push({
				...
				fromB: r,
				toB: i
			})), r = jl.applyChanges(r, e), i = dl.empty, a = 0, o = {
	...
	updateViewport(e) {
		...
		for (let t = 0; t < this.skipped.length; t++) {
			...
			n < e.to && r > e.from && (this.fragments = hu(this.fragments, n, r), this.skipped.splice(t--, 1));
		}
			...
			createParse(t, n, r) {
				...
				return {
					...
					advance() {
						...
						return this.parsedPos = a, new dl(cl.none, [], [], a - i);
					},
					stoppedAt: null,
					stopAt() {}
				};
...
var gu = class e {
	...
	static init(t) {
		let n = Math.min(3e3, t.doc.length), r = mu.create(t.facet(bu).parser, t, {
			from: 0,
			to: n
		});
...
uu.state = /*@__PURE__*/ O.define({
	create: gu.init,
	update(e, t) {
		for (let e of t.effects) if (e.is(uu.setState)) return e.value;
		return t.startState.facet(bu) == t.state.facet(bu) ? e.apply(t) : gu.init(t.state);
	}
});
var _u = (e) => {
...
typeof requestIdleCallback < "u" && (_u = (e) => {
	let t = -1, n = setTimeout(() => {
		t = requestIdleCallback(e, { timeout: 400 });
	}, 100);
	return () => t < 0 ? clearTimeout(n) : cancelIdleCallback(t);
});
var vu = typeof navigator < "u" && navigator.scheduling?.isInputPending ? () => navigator.scheduling.isInputPending() : null, yu = /*@__PURE__*/ V.fromClass(class {
	constructor(e) {
		this.view = e, this.working = null, this.workScheduled = 0, this.chunkEnd = -1, this.chunkBudget = -1, this.work = this.work.bind(this), this.scheduleWork();
	}
	update(e) {
		let t = this.view.state.field(uu.state).context;
		(t.updateViewport(e.view.viewport) || this.view.viewport.to > t.treeLen) && this.scheduleWork(), (e.docChanged || e.selectionSet) && (this.view.hasFocus && (this.chunkBudget += 50), this.scheduleWork()), this.checkAsyncSchedule(t);
	}
	scheduleWork() {
		if (this.working) return;
		let { state: e } = this.view, t = e.field(uu.state);
		(t.tree != t.context.tree || !t.context.isDone(e.doc.length)) && (this.working = _u(this.work));
	}
	work(e) {
		this.working = null;
		let t = Date.now();
		if (this.chunkEnd < t && (this.chunkEnd < 0 || this.view.hasFocus) && (this.chunkEnd = t + 3e4, this.chunkBudget = 3e3), this.chunkBudget <= 0) return;
		let { state: n, viewport: { to: r } } = this.view, i = n.field(uu.state);
		if (i.tree == i.context.tree && i.context.isDone(r + 1e5)) return;
		let a = Date.now() + Math.min(this.chunkBudget, 100, e && !vu ? Math.max(25, e.timeRemaining() - 5) : 1e9), o = i.context.treeLen < r && n.doc.length > r + 1e3, s = i.context.work(() => vu && vu() || Date.now() > a, r + (o ? 0 : 1e5));
		this.chunkBudget -= Date.now() - t, (s || this.chunkBudget <= 0) && (i.context.takeTree(), this.view.dispatch({ effects: uu.setState.of(new gu(i.context)) })), this.chunkBudget > 0 && !(s && !o) && this.scheduleWork(), this.checkAsyncSchedule(i.context);
	}
	checkAsyncSchedule(e) {
		e.scheduleOn &&= (this.workScheduled++, e.scheduleOn.then(() => this.scheduleWork()).catch((e) => jr(this.view.state, e)).then(() => this.workScheduled--), null);
	}
	destroy() {
...
}), xu = /*@__PURE__*/ D.define(), Su = /*@__PURE__*/ D.define({ combine: (e) => {
	if (!e.length) return "  ";
	let t = e[0];
...
function wu(e, t) {
	let n = "", r = e.tabSize, i = e.facet(Su)[0];
	if (i == "	") {
		for (; t >= r;) n += "	", t -= r;
		i = " ";
	}
...
function Tu(e, t) {
	e instanceof j && (e = new Eu(e));
	for (let n of e.state.facet(xu)) {
		let r = n(e, t);
		if (r !== void 0) return r;
	}
	let n = X(e.state);
	return n.length >= t ? Ou(e, n, t) : null;
}
var Eu = class {
	constructor(e, t = {}) {
		this.state = e, this.options = t, this.unit = Cu(e);
	}
	lineAt(e, t = 1) {
	...
	countColumn(e, t = e.length) {
		return Pt(e, this.state.tabSize, t);
	}
	lineIndent(e, t = 1) {
...
var Nu = class e extends Eu {
	...
	continue() {
		return ku(this.context.next, this.base, this.pos);
	}
};
function Pu(e, t) {
...
function Iu(e, t, n, r, i) {
	let a = e.textAfter, o = a.match(/^\s*/)[0].length, s = r && a.slice(o, o + r.length) == r || i == e.pos + o, c = t ? Fu(e) : null;
...
function Ru() {
	return j.transactionFilter.of((e) => {
		...
		for (let { head: e } of o.selection.ranges) {
			...
			let n = Tu(o, t.from);
			if (n == null) continue;
			let r = /^\s*/.exec(t.text)[0], i = wu(o, n);
			r != i && c.push({
				from: t.from,
				to: t.from + r.length,
				insert: i
...
var zu = /*@__PURE__*/ D.define(), Bu = /*@__PURE__*/ new K();
function Vu(e, t, n) {
	let r = X(e);
...
var Gu = /*@__PURE__*/ k.define({ map: Wu }), Ku = /*@__PURE__*/ k.define({ map: Wu });
function qu(e) {
	let t = [];
	for (let { head: n } of e.state.selection.ranges) t.some((e) => e.from <= n && e.to >= n) || t.push(e.lineBlockAt(n));
	return t;
}
var Ju = /*@__PURE__*/ O.define({
	create() {
		return R.none;
	},
	update(e, t) {
		t.isUserEvent("delete") && t.changes.iterChangedRanges((t, n) => e = Yu(e, t, n)), e = e.map(t.changes);
		let n = [];
		for (let r of t.effects) r.is(Gu) && !Zu(e, r.value.from, r.value.to) ? n.push(r.value) : r.is(Ku) && (e = e.update({
			filter: (e, t) => r.value.from != e || r.value.to != t,
			filterFrom: r.value.from,
			filterTo: r.value.to
		}));
		if (n.length) {
			let { preparePlaceholder: r } = t.state.facet(id), i = n.map((e) => (r ? R.replace({ widget: new cd(r(t.state, e)) }) : sd).range(e.from, e.to));
			e = e.update({ add: i });
		}
		return t.selection && (e = Yu(e, t.selection.main.head)), e;
	},
...
function Xu(e, t, n) {
	var r;
	let i = null;
	return (r = e.field(Ju, !1)) == null || r.between(t, n, (e, t) => {
		(!i || i.from > e) && (i = {
			from: e,
			to: t
		});
...
function Qu(e, t) {
	return e.field(Ju, !1) ? t : t.concat(k.appendConfig.of(ad()));
}
var $u = (e) => {
	for (let t of qu(e)) {
		let n = Uu(e.state, t.from, t.to);
		if (n) return e.dispatch({ effects: Qu(e.state, [Gu.of(n), td(e, n)]) }), !0;
	}
	return !1;
}, ed = (e) => {
	if (!e.state.field(Ju, !1)) return !1;
	let t = [];
	for (let n of qu(e)) {
		let r = Xu(e.state, n.from, n.to);
		r && t.push(Ku.of(r), td(e, r, !1));
	}
...
var nd = [
	...
	},
	{
		...
		run: (e) => {
			...
			for (let r = 0; r < t.doc.length;) {
				let i = e.lineBlockAt(r), a = Uu(t, i.from, i.to);
				a && n.push(Gu.of(a)), r = (a ? e.lineBlockAt(a.to) : i).to + 1;
			}
			return n.length && e.dispatch({ effects: Qu(e.state, n) }), !!n.length;
		}
	},
	{
		key: "Ctrl-Alt-]",
		run: (e) => {
			let t = e.state.field(Ju, !1);
	...
	placeholderText: "…"
}, id = /*@__PURE__*/ D.define({ combine(e) {
	return gt(e, rd);
} });
function ad(e) {
	let t = [Ju, fd];
	return e && t.push(id.of(e)), t;
}
function od(e, t) {
	let { state: n } = e, r = n.facet(id), i = (t) => {
		let n = e.lineBlockAt(e.posAtDOM(t.target)), r = Xu(e.state, n.from, n.to);
		r && e.dispatch({ effects: Ku.of(r) }), t.preventDefault();
	};
...
var sd = /*@__PURE__*/ R.replace({ widget: /*@__PURE__*/ new class extends pn {
	toDOM(e) {
		return od(e, null);
	}
}() }), cd = class extends pn {
...
function dd(e = {}) {
	let t = {
		...ld,
		...e
	}, n = new ud(t, !0), r = new ud(t, !1), i = V.fromClass(class {
		constructor(e) {
			this.from = e.viewport.from, this.markers = this.buildMarkers(e);
		}
		update(e) {
			(e.docChanged || e.viewportChanged || e.startState.facet(bu) != e.state.facet(bu) || e.startState.field(Ju, !1) != e.state.field(Ju, !1) || X(e.startState) != X(e.state) || t.foldingChanged(e)) && (this.markers = this.buildMarkers(e.view));
		}
		buildMarkers(e) {
			let t = new Ct();
			for (let i of e.viewportLineBlocks) {
				let a = Xu(e.state, i.from, i.to) ? r : Uu(e.state, i.from, i.to) ? n : null;
		...
		Ic({
			...
			domEventHandlers: {
				...
				click: (e, t, n) => {
					...
					if (r) return e.dispatch({ effects: Ku.of(r) }), !0;
					let i = Uu(e.state, t.from, t.to);
					return i ? (e.dispatch({ effects: Gu.of(i) }), !0) : !1;
				}
			}
		}),
		ad()
...
var fd = /*@__PURE__*/ G.baseTheme({
	...
	constructor(e, t) {
		...
		this.scope = a instanceof uu ? (e) => e.prop(cu) == a.data : a ? (e) => e == a : void 0, this.style = Ul(e.map((e) => ({
			tag: e.tag,
			class: e.class || r(Object.assign({}, e, { tag: null }))
		})), { all: i }).style, this.module = n ? new Bt(n) : null, this.themeType = t.themeType;
	}
	static define(t, n) {
		return new e(t, n || {});
	}
}, md = /*@__PURE__*/ D.define(), hd = /*@__PURE__*/ D.define({ combine(e) {
	return e.length ? [e[0]] : null;
} });
function gd(e) {
	let t = e.facet(md);
	return t.length ? t : e.facet(hd);
}
function _d(e, t) {
	let n = [yd], r;
	return e instanceof pd && (e.module && n.push(G.styleModule.of(e.module)), r = e.themeType), t?.fallback ? n.push(hd.of(e)) : r ? n.push(md.computeN([G.darkTheme], (t) => t.facet(G.darkTheme) == (r == "dark") ? [e] : [])) : n.push(md.of(e)), n;
}
var vd = class {
	constructor(e) {
		this.markCache = Object.create(null), this.tree = X(e.state), this.decorations = this.buildDeco(e, gd(e.state)), this.decoratedTo = e.viewport.to;
	}
	update(e) {
		let t = X(e.state), n = gd(e.state), r = n != gd(e.startState), { viewport: i } = e.view, a = e.changes.mapPos(this.decoratedTo, 1);
	...
	buildDeco(e, t) {
		...
		let n = new Ct();
		for (let { from: r, to: i } of e.visibleRanges) Gl(this.tree, t, (e, t, r) => {
			n.add(e, t, this.markCache[r] || (this.markCache[r] = R.mark({ class: r })));
		}, r, i);
		return n.finish();
	}
}, yd = /*@__PURE__*/ ze.high(/*@__PURE__*/ V.fromClass(vd, { decorations: (e) => e.decorations })), bd = /*@__PURE__*/ pd.define([
	{
		tag: Y.meta,
		color: "#404740"
	},
...
]), xd = /*@__PURE__*/ G.baseTheme({
	"&.cm-focused .cm-matchingBracket": { backgroundColor: "#328c8252" },
	"&.cm-focused .cm-nonmatchingBracket": { backgroundColor: "#bb555544" }
}), Sd = 1e4, Cd = "()[]{}", wd = /*@__PURE__*/ D.define({ combine(e) {
	return gt(e, {
		afterCursor: !0,
		brackets: Cd,
		maxScanDistance: Sd,
...
} }), Td = /*@__PURE__*/ R.mark({ class: "cm-matchingBracket" }), Ed = /*@__PURE__*/ R.mark({ class: "cm-nonmatchingBracket" });
function Dd(e) {
	let t = [], n = e.matched ? Td : Ed;
...
function Od(e) {
	...
	for (let r of e.selection.ranges) {
		if (!r.empty) continue;
		let i = Pd(e, r.head, -1, n) || r.head > 0 && Pd(e, r.head - 1, 1, n) || n.afterCursor && (Pd(e, r.head, 1, n) || r.head < e.doc.length && Pd(e, r.head + 1, -1, n));
		i && (t = t.concat(n.renderMatch(i, e)));
	}
	return R.set(t, !0);
}
var kd = [/* @__PURE__ */ V.fromClass(class {
	constructor(e) {
		this.paused = !1, this.decorations = Od(e.state);
	}
	update(e) {
		(e.docChanged || e.selectionSet || this.paused) && (e.view.composing ? (this.decorations = this.decorations.map(e.changes), this.paused = !0) : (this.decorations = Od(e.state), this.paused = !1));
	}
}, { decorations: (e) => e.decorations }), xd];
function Ad(e = {}) {
	return [wd.of(e), kd];
}
var jd = /*@__PURE__*/ new K();
function Md(e, t, n) {
...
function Pd(e, t, n, r = {}) {
	let i = r.maxScanDistance || Sd, a = r.brackets || Cd, o = X(e), s = o.resolveInner(t, n);
	for (let r = s; r; r = r.parent) {
		let i = Md(r.type, n, a);
		if (i && r.from < r.to) {
			let o = Nd(r);
			if (o && (n > 0 ? t >= o.from && t < o.to : t > o.from && t <= o.to)) return Fd(e, t, n, r, o, i, a);
		}
	}
...
var Ld = /*@__PURE__*/ Object.create(null), Rd = [cl.none], zd = [], Bd = /*@__PURE__*/ Object.create(null), Vd = /*@__PURE__*/ Object.create(null);
for (let [e, t] of [
...
]) Vd[e] = /*@__PURE__*/ Ud(Ld, t);
function Hd(e, t) {
	zd.indexOf(e) > -1 || (zd.push(e), console.warn(t));
}
function Ud(e, t) {
	let n = [];
	for (let r of t.split(" ")) {
		...
		for (let n of r.split(".")) {
			let r = e[n] || Y[n];
			r ? typeof r == "function" ? t.length ? t = t.map(r) : Hd(n, `Modifier ${n} used at start of tag`) : t.length ? Hd(n, `Tag ${n} used as modifier`) : t = Array.isArray(r) ? r : [r] : Hd(n, `Unknown highlighting tag ${n}`);
		}
		for (let e of t) n.push(e);
	}
	if (!n.length) return 0;
	let r = t.replace(/ /g, "_"), i = r + " " + n.map((e) => e.id), a = Bd[i];
	if (a) return a.id;
	let o = Bd[i] = cl.define({
		id: Rd.length,
		name: r,
		props: [Bl({ [r]: n })]
	});
	return Rd.push(o), o.id;
}
z.RTL, z.LTR;
//#endregion
//#region node_modules/@codemirror/commands/dist/index.js
var Wd = (e) => {
	let { state: t } = e, n = t.doc.lineAt(t.selection.main.from), r = Yd(e.state, n.from);
	return r.line ? Kd(e) : r.block ? Jd(e) : !1;
};
function Gd(e, t) {
...
var Kd = /*@__PURE__*/ Gd(ef, 0), qd = /*@__PURE__*/ Gd($d, 0), Jd = /*@__PURE__*/ Gd((e, t) => $d(e, t, Qd(t)), 0);
function Yd(e, t) {
...
function Zd(e, { open: t, close: n }, r, i) {
	let a = e.sliceDoc(r - Xd, r), o = e.sliceDoc(i, i + Xd), s = /\s*$/.exec(a)[0].length, c = /^\s*/.exec(o)[0].length, l = a.length - s;
	...
	let u, d;
	i - r <= 100 ? u = d = e.sliceDoc(r, i) : (u = e.sliceDoc(r, r + Xd), d = e.sliceDoc(i - Xd, i));
...
function ef(e, t, n = t.selection.ranges) {
	...
	ranges: for (let { from: e, to: a } of n) {
		...
		for (let n = e; n <= a;) {
			...
			if (s == null && (s = Yd(t, c.from).line, !s)) continue ranges;
...
var tf = /*@__PURE__*/ et.define(), nf = /*@__PURE__*/ et.define(), rf = /*@__PURE__*/ D.define(), af = /*@__PURE__*/ D.define({ combine(e) {
	return gt(e, {
		minDepth: 100,
		newGroupDelay: 500,
		joinToEvent: (e, t) => t
...
} }), of = /*@__PURE__*/ O.define({
	create() {
		return Tf.empty;
	},
	update(e, t) {
		let n = t.state.facet(af), r = t.annotation(tf);
		if (r) {
			let i = pf.fromTransaction(t, r.selection), a = r.side, o = a == 0 ? e.undone : e.done;
			return o = i ? mf(o, o.length, n.minDepth, i) : bf(o, t.startState.selection), new Tf(a == 0 ? r.rest : o, a == 0 ? o : r.rest);
		}
		let i = t.annotation(nf);
		if ((i == "full" || i == "before") && (e = e.isolate()), t.annotation(rt.addToHistory) === !1) return t.changes.empty ? e : e.addMapping(t.changes.desc);
		let a = pf.fromTransaction(t), o = t.annotation(rt.time), s = t.annotation(rt.userEvent);
...
function sf(e = {}) {
	return [
		...
		G.domEventHandlers({ beforeinput(e, t) {
			let n = e.inputType == "historyUndo" ? lf : e.inputType == "historyRedo" ? uf : null;
...
var lf = /*@__PURE__*/ cf(0, !1), uf = /*@__PURE__*/ cf(1, !1), df = /*@__PURE__*/ cf(0, !0), ff = /*@__PURE__*/ cf(1, !0), pf = class e {
	constructor(e, t, n, r, i) {
	...
	static fromJSON(t) {
		return new e(t.changes && Se.fromJSON(t.changes), [], t.mapped && xe.fromJSON(t.mapped), t.startSelection && E.fromJSON(t.startSelection), t.selectionsAfter.map(E.fromJSON));
	}
	static fromTransaction(t, n) {
		...
		return !r.length && t.changes.empty ? null : new e(t.changes.invert(t.startState.doc), r, void 0, n || t.startState.selection, vf);
	}
	static selection(t) {
		return new e(void 0, vf, void 0, void 0, t);
	}
};
function mf(e, t, n, r) {
...
function bf(e, t) {
	if (e.length) {
		let n = e[e.length - 1], r = n.selectionsAfter.slice(Math.max(0, n.selectionsAfter.length - yf));
		return r.length && r[r.length - 1].eq(t) ? e : (r.push(t), mf(e, e.length - 1, 1e9, n.setSelAfter(r)));
	}
...
function Sf(e, t) {
	...
	return r.length ? [pf.selection(r)] : vf;
}
function Cf(e, t, n) {
	let r = _f(e.selectionsAfter.length ? e.selectionsAfter.map((e) => e.map(t)) : vf, n);
	if (!e.changes) return pf.selection(r);
	let i = e.changes.map(t), a = t.mapDesc(e.changes, !0), o = e.mapped ? e.mapped.composeDesc(a) : a;
	return new pf(i, k.mapEffects(e.effects, t), o, e.startSelection.map(a), r);
}
var wf = /^(input\.type|delete)($|\.)/, Tf = class e {
	...
	addChanges(t, n, r, i, a) {
		...
		return o = s && s.changes && !s.changes.empty && t.changes && (!r || wf.test(r)) && (!s.selectionsAfter.length && n - this.prevTime < i.newGroupDelay && i.joinToEvent(a, hf(s.changes, t.changes)) || r == "input.type.compose") ? mf(o, o.length - 1, i.minDepth, new pf(t.changes.compose(s.changes), _f(k.mapEffects(t.effects, s.changes), s.effects), s.mapped, s.startSelection, vf)) : mf(o, o.length, i.minDepth, t), new e(o, vf, n, r);
	}
	addSelection(t, n, r, i) {
		let a = this.done.length ? this.done[this.done.length - 1].selectionsAfter : vf;
		return a.length > 0 && n - this.prevTime < i && r == this.prevUserEvent && r && /^select($|\.)/.test(r) && gf(a[a.length - 1], t) ? this : new e(bf(this.done, t), this.undone, n, r);
	}
	addMapping(t) {
		return new e(Sf(this.done, t), Sf(this.undone, t), this.prevTime, this.prevUserEvent);
	}
	pop(e, t, n) {
		...
		if (i.changes) {
			let n = r.length == 1 ? vf : r.slice(0, r.length - 1);
			return i.mapped && (n = Sf(n, i.mapped)), t.update({
				changes: i.changes,
...
Tf.empty = /*@__PURE__*/ new Tf(vf, vf);
var Ef = [
	{
		key: "Mod-z",
		run: lf,
...
function kf({ state: e, dispatch: t }, n) {
	let r = Df(e.selection, n);
	return !r.eq(e.selection, !0) && (t(Of(e, r)), !0);
}
function Af(e, t) {
	return E.cursor(t ? e.to : e.from);
}
function jf(e, t) {
	return kf(e, (n) => n.empty ? e.moveByChar(n, t) : Af(n, t));
}
function Z(e) {
	return e.textDirectionAt(e.state.selection.main.head) == z.LTR;
}
var Mf = (e) => jf(e, !Z(e)), Nf = (e) => jf(e, Z(e));
function Pf(e, t) {
	return kf(e, (n) => n.empty ? e.moveByGroup(n, t) : Af(n, t));
}
var Ff = (e) => Pf(e, !Z(e)), If = (e) => Pf(e, Z(e));
...
function Rf(e, t, n) {
	...
	for (let a = t.head;;) {
		...
		if (!t) break;
		Lf(e, t, i) ? r = t : a = n ? t.to : t.from;
	}
	let a = r.type.prop(i), o, s;
	return s = a && (o = n ? Pd(e, r.from, 1) : Pd(e, r.to, -1)) && o.matched ? n ? o.end.to : o.end.from : n ? r.to : r.from, E.cursor(s, n ? -1 : 1);
}
var zf = (e) => kf(e, (t) => Rf(e.state, t, !Z(e))), Bf = (e) => kf(e, (t) => Rf(e.state, t, Z(e)));
function Vf(e, t) {
	return kf(e, (n) => {
		if (!n.empty) return Af(n, t);
		let r = e.moveVertically(n, t);
		return r.head == n.head ? e.moveToLineBoundary(n, t) : r;
	});
}
var Hf = (e) => Vf(e, !1), Uf = (e) => Vf(e, !0);
function Wf(e) {
...
function Gf(e, t) {
	let n = Wf(e), { state: r } = e, i = Df(r.selection, (r) => r.empty ? e.moveVertically(r, t, n.height) : Af(r, t));
	...
	return e.dispatch(Of(r, i), { effects: a }), !0;
}
var Kf = (e) => Gf(e, !1), qf = (e) => Gf(e, !0);
function Jf(e, t, n) {
...
var Yf = (e) => kf(e, (t) => Jf(e, t, !0)), Xf = (e) => kf(e, (t) => Jf(e, t, !1)), Zf = (e) => kf(e, (t) => Jf(e, t, !Z(e))), Qf = (e) => kf(e, (t) => Jf(e, t, Z(e))), $f = (e) => kf(e, (t) => E.cursor(e.lineBlockAt(t.head).from, 1)), ep = (e) => kf(e, (t) => E.cursor(e.lineBlockAt(t.head).to, -1));
function tp(e, t, n) {
	let r = !1, i = Df(e.selection, (t) => {
		let i = Pd(e, t.head, -1) || Pd(e, t.head, 1) || t.head > 0 && Pd(e, t.head - 1, 1) || t.head < e.doc.length && Pd(e, t.head + 1, -1);
		if (!i || !i.end) return t;
		r = !0;
		let a = i.start.from == t.head ? i.end.to : i.end.from;
		return n ? E.range(t.anchor, a) : E.cursor(a);
	});
	return r ? (t(Of(e, i)), !0) : !1;
}
var np = ({ state: e, dispatch: t }) => tp(e, t, !1);
function rp(e, t, n) {
	...
	return !r.eq(e.state.selection) && (e.dispatch(Of(e.state, r)), !0);
}
function ip(e, t) {
	return rp(e, t, (n) => e.moveByChar(n, t));
}
var ap = (e) => ip(e, !Z(e)), op = (e) => ip(e, Z(e));
function sp(e, t) {
	return rp(e, t, (n) => e.moveByGroup(n, t));
}
var cp = (e) => sp(e, !Z(e)), lp = (e) => sp(e, Z(e)), up = (e) => {
	let t = !Z(e);
...
var pp = (e) => fp(e, !1), mp = (e) => fp(e, !0);
function hp(e, t) {
	return rp(e, t, (n) => e.moveVertically(n, t, Wf(e).height));
}
var gp = (e) => hp(e, !1), _p = (e) => hp(e, !0), vp = (e) => rp(e, !0, (t) => Jf(e, t, !0)), yp = (e) => rp(e, !1, (t) => Jf(e, t, !1)), bp = (e) => {
	let t = !Z(e);
	return rp(e, t, (n) => Jf(e, n, t));
}, xp = (e) => {
	let t = Z(e);
	return rp(e, t, (n) => Jf(e, n, t));
}, Sp = (e) => rp(e, !1, (t) => E.cursor(e.lineBlockAt(t.head).from)), Cp = (e) => rp(e, !0, (t) => E.cursor(e.lineBlockAt(t.head).to)), wp = ({ state: e, dispatch: t }) => (t(Of(e, { anchor: 0 })), !0), Tp = ({ state: e, dispatch: t }) => (t(Of(e, { anchor: e.doc.length })), !0), Ep = ({ state: e, dispatch: t }) => (t(Of(e, {
	anchor: e.selection.main.anchor,
	head: 0
})), !0), Dp = ({ state: e, dispatch: t }) => (t(Of(e, {
	anchor: e.selection.main.anchor,
	head: e.doc.length
})), !0), Op = ({ state: e, dispatch: t }) => (t(e.update({
	selection: {
		anchor: 0,
		head: e.doc.length
	},
	userEvent: "select"
})), !0), kp = ({ state: e, dispatch: t }) => {
	let n = Jp(e).map(({ from: t, to: n }) => E.undirectionalRange(t, Math.min(n + 1, e.doc.length)));
	return t(e.update({
		selection: E.create(n),
		userEvent: "select"
	})), !0;
}, Ap = ({ state: e, dispatch: t }) => {
	let n = Df(e.selection, (t) => {
	...
	return !n.eq(e.selection) && (t(Of(e, n)), !0);
};
function jp(e, t) {
	...
	return i.length != r.ranges.length && (e.dispatch(Of(n, E.create(i, i.length - 1))), !0);
}
var Mp = (e) => jp(e, !1), Np = (e) => jp(e, !0), Pp = ({ state: e, dispatch: t }) => {
	let n = e.selection, r = null;
	return n.ranges.length > 1 ? r = E.create([n.main]) : n.main.empty || (r = E.create([E.cursor(n.main.head)])), r ? (t(Of(e, r)), !0) : !1;
};
function Fp(e, t) {
	...
	let n = "delete.selection", { state: r } = e, i = r.changeByRange((r) => {
		...
		if (i == a) {
			let o = t(r);
			o < i ? (n = "delete.backward", o = Ip(e, o, !1)) : o > i && (n = "delete.forward", o = Ip(e, o, !0)), i = Math.min(i, o), a = Math.max(a, o);
		} else i = Ip(e, i, !1), a = Ip(e, a, !0);
		return i == a ? { range: r } : {
			changes: {
				from: i,
				to: a
...
var Lp = (e, t, n) => Fp(e, (r) => {
	...
	if (n && !t && i > o.from && i < o.from + 200 && !/[^ \t]/.test(s = o.text.slice(0, i - o.from))) {
		...
		let e = Pt(s, a.tabSize) % Cu(a) || Cu(a);
	...
	return c;
}), Rp = (e) => Lp(e, !1, !0), zp = (e) => Lp(e, !0, !1), Bp = (e, t) => Fp(e, (n) => {
	...
	return r;
}), Vp = (e) => Bp(e, !1), Hp = (e) => Bp(e, !0), Up = (e) => Fp(e, (t) => {
...
var Xp = ({ state: e, dispatch: t }) => Yp(e, t, !1), Zp = ({ state: e, dispatch: t }) => Yp(e, t, !0);
function Qp(e, t, n) {
	if (e.readOnly) return !1;
	let r = [];
	for (let t of Jp(e)) n ? r.push({
		from: t.from,
...
var $p = ({ state: e, dispatch: t }) => Qp(e, t, !1), em = ({ state: e, dispatch: t }) => Qp(e, t, !0), tm = (e) => {
	if (e.state.readOnly) return !1;
	let { state: t } = e, n = t.changes(Jp(t).map(({ from: e, to: n }) => (e > 0 ? e-- : n < t.doc.length && n++, {
		from: e,
		to: n
	}))), r = Df(t.selection, (t) => {
		let n;
...
var rm = /*@__PURE__*/ am(!1), im = /*@__PURE__*/ am(!0);
function am(e) {
	return ({ state: t, dispatch: n }) => {
		if (t.readOnly) return !1;
		let r = t.changeByRange((n) => {
			let { from: r, to: i } = n, a = t.doc.lineAt(r), o = !e && r == i && nm(t, r);
			e && (r = i = (i <= a.to ? a : t.doc.lineAt(i)).to);
			let s = new Eu(t, {
				simulateBreak: r,
				simulateDoubleBreak: !!o
			}), c = Tu(s, r);
			for (c ??= Pt(/^\s*/.exec(t.doc.lineAt(r).text)[0], t.tabSize); i < a.to && /\s/.test(a.text[i - a.from]);) i++;
			o ? {from: r, to: i} = o : r > a.from && r < a.from + 100 && !/\S/.test(a.text.slice(0, r)) && (r = a.from);
			let l = ["", wu(t, c)];
			return o && l.push(wu(t, s.lineIndent(a.from, -1))), {
				changes: {
					from: r,
					to: i,
					insert: x.of(l)
...
var sm = ({ state: e, dispatch: t }) => {
	if (e.readOnly) return !1;
	let n = Object.create(null), r = new Eu(e, { overrideIndentation: (e) => n[e] ?? -1 }), i = om(e, (t, i, a) => {
		let o = Tu(r, t.from);
		if (o == null) return;
		/\S/.test(t.text) || (o = 0);
		let s = /^\s*/.exec(t.text)[0], c = wu(e, o);
...
}, cm = ({ state: e, dispatch: t }) => !e.readOnly && (t(e.update(om(e, (t, n) => {
	n.push({
		from: t.from,
		insert: e.facet(Su)
	});
}), { userEvent: "input.indent" })), !0), lm = ({ state: e, dispatch: t }) => !e.readOnly && (t(e.update(om(e, (t, n) => {
	let r = /^\s*/.exec(t.text)[0];
	if (!r) return;
	let i = Pt(r, e.tabSize), a = 0, o = wu(e, Math.max(0, i - Cu(e)));
...
}), { userEvent: "delete.dedent" })), !0), um = (e) => (e.setTabFocusMode(), !0), dm = [
	{
		key: "Ctrl-b",
		run: Mf,
		shift: ap,
	...
	run: cm,
	shift: lm
}, hm = typeof String.prototype.normalize == "function" ? (e) => e.normalize("NFKD") : (e) => e, gm = class {
	constructor(e, t, n = 0, r = e.length, i, a) {
		this.test = a, this.value = {
			from: 0,
			to: 0,
			precise: !1
		}, this.done = !1, this.matches = [], this.buffer = "", this.bufferPos = 0, this.iter = e.iterRange(n, r), this.bufferStart = n, this.normalize = i ? (e) => i(hm(e)) : hm, this.query = this.normalize(t);
	}
	peek() {
	...
	nextOverlapping() {
		for (;;) {
			...
			let t = _e(e), n = this.bufferStart + this.bufferPos;
			this.bufferPos += ve(e);
...
typeof Symbol < "u" && (gm.prototype[Symbol.iterator] = function() {
	return this;
});
var _m = {
	from: -1,
	...
	match: /*@__PURE__*/ /.*/.exec(""),
	precise: !0
}, vm = "gm" + (/x/.unicode == null ? "" : "u"), ym = class {
	constructor(e, t, n, r = 0, i = e.length) {
		if (this.text = e, this.to = i, this.curLine = "", this.done = !1, this.value = _m, /\\[sWDnr]|\n|\r|\[\^/.test(t)) return new Sm(e, t, n, r, i);
		this.re = new RegExp(t, vm + (n?.ignoreCase ? "i" : "")), this.test = n?.test, this.iter = e.iter();
		let a = e.lineAt(r);
		this.curLineStart = a.from, this.matchPos = wm(e, r), this.getLine(this.curLineStart);
	}
	getLine(e) {
	...
	next() {
		for (let e = this.matchPos - this.curLineStart;;) {
			...
			if (t) {
				...
				if (this.matchPos = wm(this.text, r + +(n == r)), n == this.curLineStart + this.curLine.length && this.nextLine(), (n < r || n > this.value.to) && (!this.test || this.test(n, r, t))) return this.value = {
					from: n,
					to: r,
					precise: !0,
					match: t
...
}, bm = /*@__PURE__*/ new WeakMap(), xm = class e {
	constructor(e, t) {
	...
	static get(t, n, r) {
		...
		let { text: a, from: o } = i;
		return o > n && (a = t.sliceString(n, o) + a, o = n), i.to < r && (a += t.sliceString(i.to, r)), bm.set(t, new e(o, a)), new e(n, a.slice(n - o, r - o));
	}
}, Sm = class {
	constructor(e, t, n, r, i) {
		this.text = e, this.to = i, this.done = !1, this.value = _m, this.matchPos = wm(e, r), this.re = new RegExp(t, vm + (n?.ignoreCase ? "i" : "")), this.test = n?.test, this.flat = xm.get(e, r, this.chunkEnd(r + 5e3));
	}
	chunkEnd(e) {
		...
		for (;;) {
			...
			if (t && !t[0] && t.index == e && (this.re.lastIndex = e + 1, t = this.re.exec(this.flat.text)), t) {
				...
				if ((this.flat.to >= this.to || t.index + t[0].length <= this.flat.text.length - 10) && (!this.test || this.test(e, n, t))) return this.value = {
					...
					precise: !0,
					match: t
				}, this.matchPos = wm(this.text, n + +(e == n)), this;
			}
			if (this.flat.to == this.to) return this.done = !0, this;
			this.flat = xm.get(this.text, this.flat.from, this.chunkEnd(this.flat.from + this.flat.text.length * 2));
		}
	}
};
typeof Symbol < "u" && (ym.prototype[Symbol.iterator] = Sm.prototype[Symbol.iterator] = function() {
	return this;
});
function Cm(e) {
	try {
		return new RegExp(e, vm), !0;
	} catch {
		return !1;
	}
}
...
var Tm = (e) => {
	let { state: t } = e, n = String(t.doc.lineAt(e.state.selection.main.head).number), { close: r, result: i } = Ec(e, {
	...
	maxMatches: 100,
	wholeWords: !1
}, Dm = /*@__PURE__*/ D.define({ combine(e) {
	return gt(e, Em, {
...
function Om(e) {
	let t = [Pm, Nm];
	return e && t.push(Dm.of(e)), t;
}
var km = /*@__PURE__*/ R.mark({ class: "cm-selectionMatch" }), Am = /*@__PURE__*/ R.mark({ class: "cm-selectionMatch cm-selectionMatch-main" });
function jm(e, t, n, r) {
...
var Nm = /*@__PURE__*/ V.fromClass(class {
	constructor(e) {
		this.decorations = this.getDeco(e);
	}
	update(e) {
	...
	getDeco(e) {
		let t = e.state.facet(Dm), { state: n } = e, r = n.selection;
		...
		if (i.empty) {
			...
			if (t.wholeWords) {
				if (a = n.sliceDoc(i.from, i.to), o = n.charCategorizer(i.head), !(jm(o, n, i.from, i.to) && Mm(o, n, i.from, i.to))) return R.none;
			} else if (a = n.sliceDoc(i.from, i.to), !a) return R.none;
		}
		let s = [];
		for (let r of e.visibleRanges) {
			let e = new gm(n.doc, a, r.from, r.to);
			for (; !e.next().done;) {
				let { from: r, to: a } = e.value;
				if ((!o || jm(o, n, r, a)) && (i.empty && r <= i.from && a >= i.to ? s.push(Am.range(r, a)) : (r >= i.to || a <= i.from) && s.push(km.range(r, a)), s.length > t.maxMatches)) return R.none;
			}
		}
		return R.set(s);
	}
}, { decorations: (e) => e.decorations }), Pm = /*@__PURE__*/ G.baseTheme({
	".cm-selectionMatch": { backgroundColor: "#99ff7780" },
	".cm-searchMatch .cm-selectionMatch": { backgroundColor: "transparent" }
}), Fm = ({ state: e, dispatch: t }) => {
...
function Im(e, t) {
	...
	for (let n = !1, i = new gm(e.doc, t, r[r.length - 1].to);;) if (i.next(), i.done) {
		if (n) return null;
		i = new gm(e.doc, t, 0, Math.max(0, r[r.length - 1].from - 1)), n = !0;
	} else {
...
var Lm = ({ state: e, dispatch: t }) => {
	...
	if (n.some((e) => e.from === e.to)) return Fm({
		state: e,
		dispatch: t
	});
...
}, Rm = /*@__PURE__*/ D.define({ combine(e) {
	return gt(e, {
		top: !1,
		caseSensitive: !1,
		literal: !1,
	...
	constructor(e) {
		this.search = e.search, this.caseSensitive = !!e.caseSensitive, this.literal = !!e.literal, this.regexp = !!e.regexp, this.replace = e.replace || "", this.valid = !!this.search && (!this.regexp || Cm(this.search)), this.unquoted = this.unquote(this.search), this.wholeWord = !!e.wholeWord, this.test = e.test;
	}
	unquote(e) {
	...
	create() {
		return this.regexp ? new Xm(this) : new Wm(this);
	}
	getCursor(e, t = 0, n) {
		let r = e.doc ? e : j.create({ doc: e });
		return n ??= r.doc.length, this.regexp ? Km(this, r, t, n) : Hm(this, r, t, n);
	}
}, Bm = class {
	constructor(e) {
		this.spec = e;
...
function Hm(e, t, n, r) {
	let i;
	return e.wholeWord && (i = Um(t.doc, t.charCategorizer(t.selection.main.head))), e.test && (i = Vm(e.test, t, i)), new gm(t.doc, e.unquoted, n, r, e.caseSensitive ? void 0 : (e) => e.toLowerCase(), i);
}
function Um(e, t) {
	return (n, r, i, a) => ((a > n || a + i.length < r) && (a = Math.max(0, n - 2), i = e.sliceString(a, Math.min(e.length, r + 2))), (t(qm(i, n - a)) != A.Word || t(Jm(i, n - a)) != A.Word) && (t(Jm(i, r - a)) != A.Word || t(qm(i, r - a)) != A.Word));
}
var Wm = class extends Bm {
	...
	prevMatchInRange(e, t, n) {
		for (let r = n;;) {
			let n = Math.max(t, r - 1e4 - this.spec.unquoted.length), i = Hm(this.spec, e, n, r), a = null;
	...
	matchAll(e, t) {
		let n = Hm(this.spec, e, 0, e.doc.length), r = [];
		for (; !n.next().done;) {
	...
	highlight(e, t, n, r) {
		let i = Hm(this.spec, e, Math.max(0, t - this.spec.unquoted.length), Math.min(n + this.spec.unquoted.length, e.doc.length));
...
function Km(e, t, n, r) {
	let i;
	return e.wholeWord && (i = Ym(t.charCategorizer(t.selection.main.head))), e.test && (i = Gm(e.test, t, i)), new ym(t.doc, e.search, {
...
function Ym(e) {
	return (t, n, r) => !r[0].length || (e(qm(r.input, r.index)) != A.Word || e(Jm(r.input, r.index)) != A.Word) && (e(Jm(r.input, r.index + r[0].length)) != A.Word || e(qm(r.input, r.index + r[0].length)) != A.Word);
}
var Xm = class extends Bm {
	nextMatch(e, t, n) {
		let r = Km(this.spec, e, n, e.doc.length).next();
		return r.done && (r = Km(this.spec, e, 0, t).next()), r.done ? null : r.value;
	}
	prevMatchInRange(e, t, n) {
		for (let r = 1;; r++) {
			let i = Math.max(t, n - r * 1e4), a = Km(this.spec, e, i, n), o = null;
	...
	highlight(e, t, n, r) {
		let i = Km(this.spec, e, Math.max(0, t - 250), Math.min(n + 250, e.doc.length));
		for (; !i.next().done;) r(i.value.from, i.value.to);
	}
}, Zm = /*@__PURE__*/ k.define(), Qm = /*@__PURE__*/ k.define(), $m = /*@__PURE__*/ O.define({
	create(e) {
		return new eh(fh(e).create(), null);
	},
	update(e, t) {
		for (let n of t.effects) n.is(Zm) ? e = new eh(n.value.create(), e.panel) : n.is(Qm) && (e = new eh(e.query, n.value ? dh : null));
		return e;
	},
	provide: (e) => Tc.from(e, (e) => e.panel)
}), eh = class {
	constructor(e, t) {
		this.query = e, this.panel = t;
	}
}, th = /*@__PURE__*/ R.mark({ class: "cm-searchMatch" }), nh = /*@__PURE__*/ R.mark({ class: "cm-searchMatch cm-searchMatch-selected" }), rh = /*@__PURE__*/ V.fromClass(class {
	constructor(e) {
		this.view = e, this.decorations = this.highlight(e.state.field($m));
	}
	update(e) {
		let t = e.state.field($m);
		(t != e.startState.field($m) || e.docChanged || e.selectionSet || e.viewportChanged) && (this.decorations = this.highlight(t));
	}
...
var ah = /*@__PURE__*/ ih((e, { query: t }) => {
	...
	return o && (c = E.single(o.from, o.to).map(d), u.push(Sh(e, o)), u.push(n.facet(Rm).scrollToMatch(c.main, e))), e.dispatch({
		changes: d,
		selection: c,
		effects: u,
		userEvent: "input.replace"
	}), !0;
}), uh = /*@__PURE__*/ ih((e, { query: t }) => {
	if (e.state.readOnly) return !1;
	let n = [];
...
var hh = (e) => {
	...
	if (t && t.panel) {
		...
		if (n && n != e.root.activeElement) {
			...
			r.valid && e.dispatch({ effects: Zm.of(r) }), n.focus(), n.select();
		}
	} else e.dispatch({ effects: [Qm.of(!0), t ? Zm.of(fh(e.state, t.query.spec)) : k.appendConfig.of(wh)] });
	return !0;
}, gh = (e) => {
	let t = e.state.field($m, !1);
	if (!t || !t.panel) return !1;
	let n = xc(e, dh);
	return n && n.dom.contains(e.root.activeElement) && e.focus(), e.dispatch({ effects: Qm.of(!1) }), !0;
}, _h = [
	{
		key: "Mod-f",
		run: hh,
	...
	constructor(e) {
		...
		this.dom = P("div", {
			...
			P("label", null, [this.caseField, yh(e, "match case")]),
			P("label", null, [this.reField, yh(e, "regexp")]),
			P("label", null, [this.wordField, yh(e, "by word")]),
			...e.state.readOnly ? [] : [
				P("br"),
				this.replaceField,
	...
	commit() {
		...
		e.eq(this.query) || (this.query = e, this.view.dispatch({ effects: Zm.of(e) }));
	}
	keydown(e) {
		Qo(this.view, e, "search-panel") ? e.preventDefault() : e.keyCode == 13 && e.target == this.searchField ? (e.preventDefault(), (e.shiftKey ? oh : ah)(this.view)) : e.keyCode == 13 && e.target == this.replaceField && (e.preventDefault(), lh(this.view));
	}
	update(e) {
		for (let t of e.transactions) for (let e of t.effects) e.is(Zm) && !e.value.eq(this.query) && this.setQuery(e.value);
	}
	setQuery(e) {
...
var bh = 30, xh = /[\s\.,:;?!]/;
function Sh(e, { from: t, to: n }) {
	let r = e.state.doc.lineAt(t), i = e.state.doc.lineAt(n).to, a = Math.max(r.from, t - bh), o = Math.min(i, n + bh), s = e.state.sliceDoc(a, o);
	if (a != r.from) {
		for (let e = 0; e < bh; e++) if (!xh.test(s[e + 1]) && xh.test(s[e])) {
			s = s.slice(e);
			break;
		}
	}
	if (o != i) {
		for (let e = s.length - 1; e > s.length - bh; e--) if (!xh.test(s[e - 1]) && xh.test(s[e])) {
			s = s.slice(0, e);
			break;
		}
	}
...
var Ch = /*@__PURE__*/ G.baseTheme({
	...
	matchBefore(e) {
		let t = this.state.doc.lineAt(this.pos), n = Math.max(t.from, this.pos - 250), r = t.text.slice(n - t.from, this.pos - t.from), i = r.search(jh(e, !1));
		return i < 0 ? null : {
			from: n + i,
			to: this.pos,
			text: r.slice(i)
...
function Oh(e) {
	let t = e.map((e) => typeof e == "string" ? { label: e } : e), [n, r] = t.every((e) => /^\w+$/.test(e.label)) ? [/\w*$/, /\w+$/] : Dh(t);
	return (e) => {
...
function Fh(e) {
	...
	let t = Ph.get(e);
	return t || Ph.set(e, t = Oh(e)), t;
}
var Ih = /*@__PURE__*/ k.define(), Lh = /*@__PURE__*/ k.define(), Rh = class {
	constructor(e) {
		...
		for (let t = 0; t < e.length;) {
			...
			this.folded.push(w(a == i ? i.toLowerCase() : a, 0)), t += r;
		}
	...
	match(e) {
		...
		if (t.length == 1) {
			let r = w(e, 0), i = ve(r), a = i == e.length ? 0 : -100;
			if (r != t[0]) {
				if (r == n[0]) a += -200;
				else return null;
			}
	...
	result(e, t, n) {
		let r = [], i = 0;
		for (let e of t) {
			let t = e + (this.astral ? ve(w(n, e)) : 1);
...
var Gh = class {
	constructor(e, t, n) {
		...
		this.optionContent = Uh(o), this.optionClass = o.optionClass, this.tooltipClass = o.tooltipClass, this.range = Wh(i.length, a, o.maxRenderedOptions), this.dom = document.createElement("div"), this.dom.className = "cm-tooltip-autocomplete", this.updateTooltipClass(e.state), this.dom.addEventListener("mousedown", (n) => {
			...
			if (n.target == this.list) {
				...
				t != null && (e.dispatch({ effects: Hh.of(t) }), n.preventDefault());
			}
		}), this.dom.addEventListener("focusout", (t) => {
			let n = e.state.field(this.stateField, !1);
			n && n.tooltip && e.state.facet(Q).closeOnBlur && t.relatedTarget != e.contentDOM && e.dispatch({ effects: Lh.of(null) });
	...
	update(e) {
		...
		if (this.updateTooltipClass(e.state), t != n) {
			...
			(!n.open || n.open.options != r) && (this.range = Wh(r.length, i, e.state.facet(Q).maxRenderedOptions), this.showOptions(r, t.id)), this.updateSel(), a != n.open?.disabled && this.dom.classList.toggle("cm-tooltip-autocomplete-disabled", !!a);
		}
	}
	...
	updateSel() {
		...
		(t.selected > -1 && t.selected < this.range.from || t.selected >= this.range.to) && (this.range = Wh(t.options.length, t.selected, this.view.state.facet(Q).maxRenderedOptions), this.showOptions(t.options, e.id));
		...
		if (n) {
			...
			}).catch((e) => jr(this.view.state, e, "completion info")) : (this.addInfoPane(a, r), n.setAttribute("aria-describedby", this.info.id));
		}
	}
	addInfoPane(e, t) {
		this.destroyInfo();
...
function Yh(e, t) {
	...
	for (let r of e) if (r.hasResult()) {
		...
		if (r.result.filter === !1) for (let t of r.result.options) a(new kh(t, r.source, e ? e(t) : [], 1e9 - n.length));
		else {
			let n = t.sliceDoc(r.from, r.to), s, c = o.filterStrict ? new zh(n) : new Rh(n);
			for (let t of r.result.options) if (s = c.match(t.label)) {
				let n = t.displayLabel ? e ? e(t, s.matched) : [] : s.matched, o = s.score + (t.boost || 0);
				if (a(new kh(t, r.source, n, o)), typeof t.section == "object" && t.section.rank === "dynamic") {
	...
	for (let e of n.sort((e, t) => t.score - e.score || l(e.completion, t.completion))) {
		let t = e.completion;
		!c || c.label != t.label || c.detail != t.detail || c.type != null && t.type != null && c.type != t.type || c.apply != t.apply || c.boost != t.boost ? s.push(e) : Jh(e.completion) > Jh(c) && (s[s.length - 1] = e), c = e.completion;
	}
	return s;
}
var Xh = class e {
	...
	setSelected(t, n) {
		return t == this.selected || t >= this.options.length ? this : new e(this.options, tg(n, t), this.tooltip, this.timestamp, t, this.disabled);
	}
	...
	static start() {
		return new e(ng, "cm-ac-" + Math.floor(Math.random() * 2e6).toString(36), null);
	}
	update(t) {
		let { state: n } = t, r = n.facet(Q), i = (r.override || n.languageDataAt("autocomplete", Ah(n)).map(Fh)).map((e) => (this.active.find((t) => t.source == e) || new ig(e, +!!this.active.some((e) => e.state != 0))).update(t, r));
		i.length == this.active.length && i.every((e, t) => e == this.active[t]) && (i = this.active);
		let a = this.open, o = t.effects.some((e) => e.is(sg));
		a && t.docChanged && (a = a.map(t.changes)), t.selection || i.some((e) => e.hasResult() && t.changes.touchesRange(e.from, e.to)) || !Qh(i, this.active) || o ? a = Xh.build(i, n, this.id, a, r, o) : a && a.disabled && !i.some((e) => e.isPending) && (a = null), !a && i.every((e) => !e.isPending) && i.some((e) => e.hasResult()) && (i = i.map((e) => e.hasResult() ? new ig(e.source, 0) : e));
		for (let e of t.effects) e.is(Hh) && (a &&= a.setSelected(e.value, this.id));
	...
	get attrs() {
		return this.open ? this.open.attrs : this.active.length ? $h : eg;
	}
};
function Qh(e, t) {
	if (e == t) return !0;
...
var $h = { "aria-autocomplete": "list" }, eg = {};
function tg(e, t) {
	let n = {
...
var ig = class e {
	...
	update(t, n) {
		...
		for (let n of t.effects) if (n.is(Ih)) i = new e(i.source, 1, n.value);
		else if (n.is(Lh)) i = new e(i.source, 0);
		else if (n.is(sg)) for (let e of n.value) e.source == i.source && (i = e);
		return i;
	}
	updateFor(e, t) {
	...
	updateFor(t, n) {
		...
		let i = t.changes.mapPos(this.from), a = t.changes.mapPos(this.to, 1), o = Ah(t.state);
		if (o > a || !r || n & 2 && (Ah(t.startState) == this.from || o < this.limit)) return new ig(this.source, n & 4 ? 1 : 0);
		let s = t.changes.mapPos(this.limit);
		return og(r.validFor, t.state, i, a) ? new e(this.source, this.explicit, s, r, i, a) : r.update && (r = r.update(r, i, a, new Th(t.state, o, !1))) ? new e(this.source, this.explicit, s, r, r.from, r.to ?? Ah(t.state)) : new ig(this.source, 1, this.explicit);
	}
	map(t) {
		if (t.empty) return this;
		let n = this.result.map ? this.result.map(this.result, t) : this.result;
		return n ? new e(this.source, this.explicit, t.mapPos(this.limit), n, t.mapPos(this.from), t.mapPos(this.to, 1)) : new ig(this.source, 0);
	}
	touches(e) {
...
function og(e, t, n, r) {
	...
	return typeof e == "function" ? e(i, n, r, t) : jh(e, !0).test(i);
}
var sg = /*@__PURE__*/ k.define({ map(e, t) {
	return e.map((e) => e.map(t));
} }), cg = /*@__PURE__*/ O.define({
	create() {
		return Zh.start();
	},
	update(e, t) {
	...
	provide: (e) => [sc.from(e, (e) => e.tooltip), G.contentAttributes.from(e, (e) => e.attrs)]
});
function lg(e, t) {
	let n = t.completion.apply || t.completion.label, r = e.state.field(cg).active.find((e) => e.source == t.source);
	return r instanceof ag && (typeof n == "string" ? e.dispatch({
		...Nh(e.state, n, r.from, r.to),
		annotations: Mh.of(t.completion)
	}) : n(e, t.completion, r.from, r.to), !0);
}
var ug = /*@__PURE__*/ Kh(cg, lg);
function dg(e, t = "option") {
	return (n) => {
		let r = n.state.field(cg, !1);
		if (!r || !r.open || r.open.disabled || Date.now() - r.open.timestamp < n.state.facet(Q).interactionDelay) return !1;
		let i = 1, a;
		t == "page" && (a = vc(n, r.open.tooltip)) && (i = Math.max(2, Math.floor(a.dom.offsetHeight / a.dom.querySelector("li").offsetHeight) - 1));
		let { length: o } = r.open.options, s = r.open.selected > -1 ? r.open.selected + i * (e ? 1 : -1) : e ? 0 : o - 1;
		return s < 0 ? s = t == "page" ? 0 : o - 1 : s >= o && (s = t == "page" ? o - 1 : 0), n.dispatch({ effects: Hh.of(s) }), !0;
	};
}
var fg = (e) => {
	let t = e.state.field(cg, !1);
	return e.state.readOnly || !t || !t.open || t.open.selected < 0 || t.open.disabled || Date.now() - t.open.timestamp < e.state.facet(Q).interactionDelay ? !1 : lg(e, t.open.options[t.open.selected]);
}, pg = (e) => e.state.field(cg, !1) ? (e.dispatch({ effects: Ih.of(!0) }), !0) : !1, mg = (e) => {
	let t = e.state.field(cg, !1);
	return !t || !t.active.some((e) => e.state != 0) ? !1 : (e.dispatch({ effects: Lh.of(null) }), !0);
}, hg = class {
	constructor(e, t) {
		this.active = e, this.context = t, this.time = Date.now(), this.updates = [], this.done = void 0;
	}
}, gg = 50, _g = 1e3, vg = /*@__PURE__*/ V.fromClass(class {
	constructor(e) {
		this.view = e, this.debounceUpdate = -1, this.running = [], this.debounceAccept = -1, this.pendingStart = !1, this.composing = 0;
		for (let t of e.state.field(cg).active) t.isPending && this.startQuery(t);
	}
	update(e) {
		let t = e.state.field(cg), n = e.state.facet(Q);
		if (!e.selectionSet && !e.docChanged && e.startState.field(cg) == t) return;
		...
		for (let t = 0; t < this.running.length; t++) {
			...
			if (r || n.context.abortOnDocChange && e.docChanged || n.updates.length + e.transactions.length > gg && Date.now() - n.time > _g) {
				for (let e of n.context.abortListeners) try {
					e();
				} catch (e) {
					jr(this.view.state, e);
				}
				n.context.abortListeners = null, this.running.splice(t--, 1);
			} else n.updates.push(...e.transactions);
		}
		this.debounceUpdate > -1 && clearTimeout(this.debounceUpdate), e.transactions.some((e) => e.effects.some((e) => e.is(Ih))) && (this.pendingStart = !0);
	...
	startUpdate() {
		...
		let { state: e } = this.view, t = e.field(cg);
	...
	startQuery(e) {
		let { state: t } = this.view, n = new Th(t, Ah(t), e.explicit, this.view), r = new hg(e, n);
		this.running.push(r), Promise.resolve(e.source(n)).then((e) => {
			r.context.aborted || (r.done = e || null, this.scheduleAccept());
		}, (e) => {
			this.view.dispatch({ effects: Lh.of(null) }), jr(this.view.state, e);
		});
	}
	scheduleAccept() {
	...
	accept() {
		...
		let e = [], t = this.view.state.facet(Q), n = this.view.state.field(cg);
		for (let r = 0; r < this.running.length; r++) {
			let i = this.running[r];
			if (i.done === void 0) continue;
			if (this.running.splice(r--, 1), i.done) {
				let n = Ah(i.updates.length ? i.updates[0].startState : this.view.state), r = Math.min(n, i.done.from + +!i.active.explicit), a = new ag(i.active.source, i.active.explicit, r, i.done, i.done.from, i.done.to ?? n);
		...
		(e.length || n.open && n.open.disabled) && this.view.dispatch({ effects: sg.of(e) });
	}
}, { eventHandlers: {
	blur(e) {
		let t = this.view.state.field(cg, !1);
		if (t && t.tooltip && this.view.state.facet(Q).closeOnBlur) {
			let n = t.open && vc(this.view, t.open.tooltip);
			(!n || !n.dom.contains(e.relatedTarget)) && setTimeout(() => this.view.dispatch({ effects: Lh.of(null) }), 10);
		}
	},
	compositionstart() {
		this.composing = 1;
...
} }), yg = typeof navigator == "object" && /*@__PURE__*/ /Win/.test(navigator.platform), bg = /*@__PURE__*/ ze.highest(/*@__PURE__*/ G.domEventHandlers({ keydown(e, t) {
	let n = t.state.field(cg, !1);
	if (!n || !n.open || n.open.disabled || n.open.selected < 0 || e.key.length > 1 || e.ctrlKey && !(yg && e.altKey) || e.metaKey) return !1;
	...
	return a && a.indexOf(e.key) > -1 && lg(t, r), !1;
} })), xg = /*@__PURE__*/ G.baseTheme({
	...
	before: ")]}:;>",
	stringPrefixes: []
}, Cg = /*@__PURE__*/ k.define({ map(e, t) {
	return t.mapPos(e, -1, be.TrackAfter) ?? void 0;
} }), wg = /*@__PURE__*/ new class extends _t {}();
wg.startSide = 1, wg.endSide = -1;
var Tg = /*@__PURE__*/ O.define({
	create() {
		return M.empty;
	},
	update(e, t) {
		...
		for (let n of t.effects) n.is(Cg) && (e = e.update({ add: [wg.range(n.value, n.value + 1)] }));
		return e;
	}
});
function Eg() {
...
var Dg = "()[]{}<>«»»«［］｛｝";
function Og(e) {
	for (let t = 0; t < 16; t += 2) if (Dg.charCodeAt(t) == e) return Dg.charAt(t + 1);
	return _e(e < 128 ? e : e + 1);
}
function kg(e, t) {
	return e.languageDataAt("closeBrackets", t)[0] || Sg;
}
var Ag = typeof navigator == "object" && /*@__PURE__*/ /Android\b/.test(navigator.userAgent), jg = /*@__PURE__*/ G.inputHandler.of((e, t, n, r) => {
	if ((Ag ? e.composing : e.compositionStarted) || e.state.readOnly) return !1;
	let i = e.state.selection.main;
	if (r.length > 2 || r.length == 2 && ve(w(r, 0)) == 1 || t != i.from || n != i.to) return !1;
	let a = Ng(e.state, r);
	...
	run: ({ state: e, dispatch: t }) => {
		if (e.readOnly) return !1;
		let n = kg(e, e.selection.main.head).brackets || Sg.brackets, r = null, i = e.changeByRange((t) => {
			if (t.empty) {
				let r = Ig(e.doc, t.head);
				for (let i of n) if (i == r && Fg(e.doc, t.head) == Og(w(i, 0))) return {
					changes: {
...
function Ng(e, t) {
	let n = kg(e, e.selection.main.head), r = n.brackets || Sg.brackets;
	for (let i of r) {
		let a = Og(w(i, 0));
		if (t == i) return a == i ? zg(e, i, r.indexOf(i + i + i) > -1, n) : Lg(e, i, a, n.before || Sg.before);
		if (t == a && Pg(e, e.selection.main.from)) return Rg(e, i, a);
	}
	return null;
}
function Pg(e, t) {
	let n = !1;
	return e.field(Tg).between(0, e.doc.length, (e) => {
		e == t && (n = !0);
	}), n;
}
function Fg(e, t) {
	let n = e.sliceString(t, t + 2);
	return n.slice(0, ve(w(n, 0)));
}
function Ig(e, t) {
	let n = e.sliceString(t - 2, t);
	return ve(w(n, 0)) == n.length ? n : n.slice(1);
}
function Lg(e, t, n, r) {
...
function Rg(e, t, n) {
	let r = null, i = e.changeByRange((t) => t.empty && Fg(e.doc, t.head) == n ? {
		changes: {
			from: t.head,
			to: t.head + n.length,
			insert: n
...
function zg(e, t, n, r) {
	let i = r.stringPrefixes || Sg.stringPrefixes, a = null, o = e.changeByRange((r) => {
		if (!r.empty) return {
			changes: [{
				insert: t,
				from: r.from
		...
		} else if (n && e.sliceDoc(o - 2 * t.length, o) == t + t && (c = Hg(e, o - 2 * t.length, i)) > -1 && Bg(e, c)) return {
			changes: {
				insert: t + t + t + t,
				from: o
			},
		...
		else if (e.charCategorizer(o)(s) != A.Word && Hg(e, o, i) > -1 && !Vg(e, o, t, i)) return {
			changes: {
				insert: t + t,
				from: o
			},
...
var Wg = [
	...
	{
		key: "PageDown",
		run: /*@__PURE__*/ dg(!0, "page")
	},
	{
		key: "PageUp",
		run: /*@__PURE__*/ dg(!1, "page")
	},
	{
		key: "Enter",
		run: fg
	}
], Gg = /*@__PURE__*/ ze.highest(/*@__PURE__*/ Yo.computeN([Q], (e) => e.facet(Q).defaultKeymap ? [Wg] : [])), Kg = class {
	constructor(e, t, n) {
...
function Jg(e, t = null, n = 0) {
	...
	return e.between(n, 1e9, (e, n, { spec: i }) => {
		if (!(t && i.diagnostics.indexOf(t) < 0)) {
			if (!r) r = new Kg(e, n, t || i.diagnostics[0]);
			else if (i.diagnostics.indexOf(r.diagnostic) < 0) return !1;
			else r = new Kg(r.from, n, r.diagnostic);
		}
	}), r;
}
function Yg(e, t) {
	let n = t.pos, r = t.end || n, i = e.state.facet(s_).hideOn(e, n, r);
	if (i != null) return i;
	let a = e.startState.doc.lineAt(t.pos);
	return !!(e.effects.some((e) => e.is(Zg)) || e.changes.touchesRange(a.from, Math.max(a.to, r)));
}
function Xg(e, t) {
	return e.field(e_, !1) ? t : t.concat(k.appendConfig.of(b_));
}
var Zg = /*@__PURE__*/ k.define(), Qg = /*@__PURE__*/ k.define(), $g = /*@__PURE__*/ k.define(), e_ = /*@__PURE__*/ O.define({
	create() {
	...
	update(e, t) {
		if (t.docChanged && e.diagnostics.size) {
			...
			!n.size && i && t.state.facet(s_).autoPanel && (i = null), e = new qg(n, i, r);
		}
		for (let n of t.effects) if (n.is(Zg)) {
			let r = t.state.facet(s_).autoPanel ? n.value.length ? p_.open : null : e.panel;
			e = qg.init(n.value, r, t.state);
		} else n.is(Qg) ? e = new qg(e.diagnostics, n.value ? p_.open : null, e.selected) : n.is($g) && (e = new qg(e.diagnostics, e.panel, n.value));
		return e;
	},
	provide: (e) => [Tc.from(e, (e) => e.panel), G.decorations.from(e, (e) => e.diagnostics)]
}), t_ = /*@__PURE__*/ R.mark({ class: "cm-lintRange cm-lintRange-active" });
function n_(e, t, n) {
	let { diagnostics: r } = e.state.field(e_), i, a = -1, o = -1;
	r.between(t - +(n < 0), t + +(n > 0), (e, r, { spec: s }) => {
		if (t >= e && t <= r && (e == r || (t > e || n > 0) && (t < r || n < 0))) return i = s.diagnostics, a = e, o = r, !1;
	});
	let s = e.state.facet(s_).tooltipFilter;
...
function r_(e, t) {
	return P("ul", { class: "cm-tooltip-lint" }, t.map((t) => u_(e, t, !1)));
}
var i_ = (e) => {
	let t = e.state.field(e_, !1);
	(!t || !t.panel) && e.dispatch({ effects: Xg(e.state, [Qg.of(!0)]) });
	let n = xc(e, p_.open);
	return n && n.dom.querySelector(".cm-panel-lint ul").focus(), !0;
}, a_ = (e) => {
	let t = e.state.field(e_, !1);
	return !t || !t.panel ? !1 : (e.dispatch({ effects: Qg.of(!1) }), !0);
}, o_ = [{
	key: "Mod-Shift-m",
	run: i_,
	preventDefault: !0
	...
	run: (e) => {
		let t = e.state.field(e_, !1);
		if (!t) return !1;
		let n = e.state.selection.main, r = Jg(t.diagnostics, null, n.to + 1);
		return !r && (r = Jg(t.diagnostics, null, 0), !r || r.from == n.from && r.to == n.to) ? !1 : (e.dispatch({
			selection: {
				anchor: r.from,
				head: r.to
			},
...
}], s_ = /*@__PURE__*/ D.define({ combine(e) {
	return {
...
var d_ = class extends pn {
	...
	constructor(e, t) {
		this.diagnostic = t, this.id = "item_" + Math.floor(Math.random() * 4294967295).toString(16), this.dom = u_(e, t, !0), this.dom.id = this.id, this.dom.setAttribute("role", "option");
	}
}, p_ = class e {
	constructor(e) {
		...
		let t = (t) => {
			if (!(t.ctrlKey || t.altKey || t.metaKey)) {
				if (t.keyCode == 27) a_(this.view), this.view.focus();
					...
					let { diagnostic: n } = this.items[this.selectedIndex], r = l_(n.actions);
					for (let i = 0; i < r.length; i++) if (r[i].toUpperCase().charCodeAt(0) == t.keyCode) {
						let t = Jg(this.view.state.field(e_).diagnostics, n);
	...
	get selectedIndex() {
		let e = this.view.state.field(e_).selected;
		if (!e) return -1;
		for (let t = 0; t < this.items.length; t++) if (this.items[t].diagnostic == e.diagnostic) return t;
		return -1;
	}
	update() {
		let { diagnostics: e, selected: t } = this.view.state.field(e_), n = 0, r = !1, i = null, a = /* @__PURE__ */ new Set();
		for (e.between(0, this.view.state.doc.length, (e, o, { spec: s }) => {
			for (let e of s.diagnostics) {
				...
				o < 0 ? (s = new f_(this.view, e), this.items.splice(n, 0, s), r = !0) : (s = this.items[o], o > n && (this.items.splice(n, o - n), r = !0)), t && s.diagnostic == t.diagnostic ? s.dom.hasAttribute("aria-selected") || (s.dom.setAttribute("aria-selected", "true"), i = s) : s.dom.hasAttribute("aria-selected") && s.dom.removeAttribute("aria-selected"), n++;
			}
		}); n < this.items.length && !(this.items.length == 1 && this.items[0].diagnostic.from < 0);) r = !0, this.items.pop();
		this.items.length == 0 && (this.items.push(new f_(this.view, {
			from: -1,
			to: -1,
			severity: "info",
...
function h_(e) {
	return m_(`<path d="m0 2.5 l2 -1.5 l1 0 l2 1.5 l1 0" stroke="${e}" fill="none" stroke-width=".7"/>`, "width=\"6\" height=\"3\"");
}
var g_ = /*@__PURE__*/ G.baseTheme({
	".cm-diagnostic": {
	...
	".cm-lintRange-error": { backgroundImage: /*@__PURE__*/ h_("#f11") },
	".cm-lintRange-warning": { backgroundImage: /*@__PURE__*/ h_("orange") },
	".cm-lintRange-info": { backgroundImage: /*@__PURE__*/ h_("#999") },
	".cm-lintRange-hint": { backgroundImage: /*@__PURE__*/ h_("#66d") },
...
var y_ = /*@__PURE__*/ gc(n_, { hideOn: Yg }), b_ = [
	e_,
	/*@__PURE__*/ G.decorations.compute([e_], (e) => {
		let { selected: t, panel: n } = e.field(e_);
		return !t || !n || t.from == t.to ? R.none : R.set([t_.range(t.from, t.to)]);
	}),
	y_,
	g_
], x_ = [
...
function w_(e, t) {
	let n = C_(e.state, e.pos), r = e.matchBefore(/[\w.]+$/), i = r ? r.from : e.pos, a = e.pos, o = (r?.text ?? "").toLowerCase(), s = /^\s*cornerRadius\s*=\s*[\w.]*$/i.test(n), c = /^\s*padding\s*=\s*[\w.]*$/i.test(n) || /^\s*margin\s*=\s*[\w.]*$/i.test(n) || /^\s*inset\s*=\s*[\w.]*$/i.test(n), l = /^\s*width\s*=\s*[\w.]*$/i.test(n) || /^\s*height\s*=\s*[\w.]*$/i.test(n), u = s || c || l;
	...
	for (let e of S_) (!o || e.toLowerCase().startsWith(o)) && p(e, "keyword");
...
function N_(e, t, n) {
	...
	let r = [
		{
			kind: "component",
			re: RegExp(`^\\s*(?:component|page|screen)\\s+${A_(e)}\\b`)
		},
		{
			kind: "primitive",
			re: RegExp(`^\\s*primitive\\s+${A_(e)}\\b`)
		},
		{
			kind: "semantic",
			re: RegExp(`^\\s*semantic\\s+${A_(e)}\\b`)
		},
		{
			kind: "typeStyle",
			re: RegExp(`^\\s*typeStyle\\s+${A_(e)}\\b`)
		},
		{
			kind: "variant",
			re: RegExp(`^\\s*(?:variant|enum)\\s+${A_(e)}\\b`)
		},
		{
			kind: "protocol",
			re: RegExp(`^\\s*protocol\\s+${A_(e)}\\b`)
		},
		{
			kind: "theme",
			re: RegExp(`^\\s*theme\\s+${A_(e)}\\b`)
		},
		{
			kind: "usage",
			re: RegExp(`^\\s*usage\\s+${A_(e)}\\b`)
		},
		{
			kind: "fixtures",
			re: RegExp(`^\\s*fixtures\\s+${A_(e)}\\b`)
		},
		{
			kind: "case",
			re: RegExp(`^\\s*case\\s+${A_(e)}\\b`)
		}
...
function F_(e, t) {
	if (!e || !t) return null;
	let n = [
		RegExp(`^\\s*(component|page|screen)\\s+${z_(t)}\\b`, "m"),
		RegExp(`^\\s*fixtures\\s+${z_(t)}\\b`, "m"),
		RegExp(`^\\s*samples\\s+${z_(t)}\\b`, "m"),
		RegExp(`^\\s*(primitive|semantic)\\s+[\\w.]*${z_(t)}\\b`, "m")
	];
	for (let t of n) {
		let n = t.exec(e);
		if (n) return {
...
function L_(e, t, n) {
	let r = [];
	if (n?.componentFiles) for (let [t, i] of Object.entries(n.componentFiles)) (R_(i) === R_(e) || String(i).endsWith(e)) && r.push(t);
	return r.length ? r : I_(t[e] || "").filter((e) => [
		"component",
		"page",
		"screen"
...
var $ = null, V_ = null, H_ = null, U_ = null, W_ = !1;
function G_() {
	let t = e.catalogue, n = [];
...
function K_() {
	if (!$ || !V_) return !1;
	let t = $.state.selection.main.head, n = j_($.state.doc, t);
	if (!n) return !1;
	let r = P_(n, e.files, V_);
	return r ? (U_?.(r.path, r.line, r.name), !0) : !1;
}
function q_(t, n = {}) {
	return H_ = n.onChange ?? null, U_ = n.onGoto ?? null, $ = new G({
		parent: t,
		state: j.create({
			doc: "",
			extensions: [
				...
				G.domEventHandlers({ click(t, n) {
					...
					if (r == null) return !1;
					let i = j_(n.state.doc, r);
					if (!i) return !1;
					let a = P_(i, e.files, V_ || e.editFile || "");
					return a ? (U_?.(a.path, a.line, a.name), !0) : !1;
				} }),
				G.updateListener.of((t) => {
					if (W_ || !t.docChanged || !V_) return;
					let n = t.state.doc.toString();
					e.files[V_] = n, i(V_), H_?.(V_, n), t.selectionSet && Y_();
				}),
				G.theme({
					"&": { height: "100%" },
					".cm-scroller": {
...
function J_() {
	...
	e && (e.innerHTML = "<option value=\"\">Template…</option>" + T_.map((e) => `<option value="${e.id}">${tv(e.label)}</option>`).join(""));
}
function Y_() {
	let e = document.getElementById("addProperty"), t = document.getElementById("addPropertyKind");
	if (!e || !$) return;
	let n = $.state.selection.main.head, r = O_($.state.doc.toString(), n);
	t && (t.textContent = `Kind: ${r}`);
	let i = D_[r] || D_.unknown, a = e.value;
	e.innerHTML = "<option value=\"\">Property…</option>" + i.map((e) => `<option value="${e.id}">${tv(e.label)}</option>`).join(""), i.some((e) => e.id === a) && (e.value = a);
}
function X_() {
	document.getElementById("insertTemplate")?.addEventListener("change", (e) => {
		let t = e.target.value;
		if (!t || !$) return;
		let n = T_.find((e) => e.id === t);
		if (e.target.value = "", !n) return;
		let r = $.state.selection.main.head, i = E_($.state.doc.toString(), r, n.snippet);
		$.dispatch({
			changes: {
				from: r,
				insert: i
		...
		let t = e.target.value;
		if (!t || !$) return;
		let n = $.state.selection.main.head, r = (D_[O_($.state.doc.toString(), n)] || D_.unknown).find((e) => e.id === t);
		if (e.target.value = "", !r) return;
		let i = k_($.state.doc.toString(), n, r.snippet);
		$.dispatch({
			changes: {
				from: n,
				insert: i
...
function Z_() {
	...
	try {
		...
		let n = e.files[t] ?? "";
		if (V_ === t && $.state.doc.toString() === n) return;
		V_ = t, $.dispatch({ changes: {
			from: 0,
			to: $.state.doc.length,
			insert: n
		} });
...
function ev() {
	!$ || !V_ || (e.files[V_] = $.state.doc.toString());
}
function tv(e) {
...
function nv(t) {
	...
	function o(e, t) {
		return t.length ? `<div class="nav-section"><div class="nav-section-title">${rv(e)}</div>${t.join("")}</div>` : "";
	}
	function s({ id: e, label: t, role: n, selected: r, kind: i, file: a }) {
		let o = n ? `<span class="role">${rv(n)}</span>` : "";
		return `<button type="button" class="nav-item${r ? " is-selected" : ""}" data-kind="${i}" data-name="${iv(e)}" data-file="${iv(a || "")}">${rv(t)}${o}</button>`;
	}
	function c() {
	...
	function l() {
		...
		i.innerHTML = a.length ? `<div class="nav-section">${a.map((e) => e.replace("nav-item", "nav-item nav-file")).join("")}</div>` : "<p class=\"hint\">No files</p>", i.innerHTML = a.length ? `<div class="nav-section">${r.filter((e) => !n || e.toLowerCase().includes(n)).map((t) => `<button type="button" class="nav-item nav-file${e.editFile === t ? " is-selected" : ""}" data-kind="file" data-name="${iv(t)}" data-file="${iv(t)}">${rv(t)}</button>`).join("")}</div>` : "<p class=\"hint\">No files</p>", i.querySelectorAll(".nav-item").forEach((e) => {
			e.addEventListener("click", () => {
				t.onSelect({
					kind: "file",
					name: e.getAttribute("data-name"),
...
function av(t) {
	...
	function s() {
		...
		d.length ? (n.innerHTML = [`<button type="button" class="chip${f ? "" : " is-active"}" data-world="">Default</button>`, ...d.map((e) => `<button type="button" class="chip${f === e ? " is-active" : ""}" data-world="${cv(e)}">${sv(e)}</button>`)].join(""), n.querySelectorAll(".chip").forEach((n) => {
		...
		})) : n.innerHTML = `<span class="hint">No worlds (fixtures) for ${sv(c)}.</span>`;
		let p = B_(f && u[f] ? u[f] : {});
		p.length ? (i.hidden = !1, i.innerHTML = "Samples used " + p.map((e) => `<button type="button" data-sample="${cv(e)}">${sv(e)}</button>`).join(" "), i.querySelectorAll("button").forEach((e) => {
		...
		a.innerHTML = "<div class=\"hint\" style=\"margin-bottom:6px\">Preview only · not saved to world</div>" + g.map((e) => {
			...
			return Array.isArray(t) && t.length ? `<label><span>${sv(e.name)}</span><select data-param="${cv(e.name)}">${t.map((e) => `<option value="${cv(e)}"${String(n) === e || String(n) === `.${e}` ? " selected" : ""}>${sv(e)}</option>`).join("")}</select></label>` : `<label><span>${sv(e.name)}</span><input data-param="${cv(e.name)}" value="${cv(String(n ?? ""))}" /></label>`;
...
function lv(t) {
	...
	function r(t) {
		if (!t) return null;
		for (let [n, r] of Object.entries(e.files)) if (RegExp(`\\b(fixtures|usage|rules|extend)\\s+${fv(t)}\\b`).test(r)) return n;
	...
	function i() {
		...
		let o = a.usageByComponent?.[i], s = a.rulesByComponent?.[i], c = r(i), l = Object.keys(e.files).find((t) => RegExp(`\\b(component|page|screen)\\s+${fv(i)}\\b`).test(e.files[t])) || null, u = [];
		if (u.push(`<div class="notes-title">${uv(i)}</div>`), c || l) {
			if (u.push("<div class=\"notes-actions\">"), l && u.push(`<button type="button" class="btn ghost btn-tiny" data-reveal="${dv(l)}" data-sym="${dv(i)}">Open layout</button>`), c && u.push(`<button type="button" class="btn ghost btn-tiny" data-reveal="${dv(c)}" data-sym="${dv(i)}">Open companions</button>`), c && e.files[c]) {
				let t = F_(e.files[c], i);
				t && u.push(`<span class="hint">${uv(c)}${t.line == null ? "" : `:${t.line + 1}`}</span>`);
			}
			u.push("</div>");
		}
		if (o ? u.push(`<div class="notes-section"><div class="notes-label">Usage</div><pre class="notes-body">${uv(o)}</pre></div>`) : u.push("<div class=\"notes-section\"><div class=\"notes-label\">Usage</div><p class=\"hint\">No usage note for this symbol.</p></div>"), s && (s.rules?.length || s.tagOps?.length)) {
			let e = (s.rules ?? []).map((e) => {
				let t = e.severity || e.level || "should", n = e.message || e.text || JSON.stringify(e);
				return `<li class="rule rule-${dv(String(t))}"><span class="sev">${uv(String(t))}</span> ${uv(String(n))}</li>`;
			}).join("");
		...
		if (Array.isArray(d) && d.length) {
			...
			e.length && u.push(`<div class="notes-section"><div class="notes-label">Host events</div><p class="hint">${uv(e.join(" · "))} — runtime → this component (not parent emits)</p></div>`);
		}
...
var pv = [], mv = null;
function hv(e = {}) {
	mv = e.onGoto ?? null, document.getElementById("btnClearProblems")?.addEventListener("click", () => {
		_v();
	});
}
function gv(e, t = {}) {
...
function yv() {
	...
	if (e) {
		...
		e.hidden = !1, t && (t.hidden = !1), e.innerHTML = pv.map((e, t) => `<div class="prob-row">${e.file && e.line ? `<button type="button" class="prob-loc" data-i="${t}">${xv(bv(e.file))}:${e.line}</button>` : e.file ? `<span class="prob-loc">${xv(bv(e.file))}</span>` : ""}<span class="prob-msg">${xv(e.message || e.raw || "")}</span></div>`).join(""), e.querySelectorAll(".prob-loc[data-i]").forEach((e) => {
			e.addEventListener("click", () => {
				let t = Number(e.getAttribute("data-i")), n = pv[t];
				n && mv?.(n);
			});
		});
	}
...
function Dv(e, t) {
	...
	for (let n of Array.from(t.attributes)) !n.name.startsWith("data-") && n.name !== "style" && n.name !== "class" || Ev.includes(n.name) || e.getAttribute(n.name) !== n.value && e.setAttribute(n.name, n.value);
}
function Ov(e, t) {
	...
	function s(e) {
		let t = e.className || "";
		return r.find((n) => !o.has(n) && !Tv(n) && n.tagName === e.tagName && (n.className || "") === t);
	}
	for (let t of n) {
		let n = Tv(t), r = n ? i.get(n) : null;
		r && o.has(r) && (r = null), !r && !n && (r = s(t) || null), r && r.tagName === t.tagName ? (o.add(r), kv(r, t), a.push(r)) : a.push(e.ownerDocument.importNode(t, !0));
	}
...
function kv(e, t) {
	...
	if (Dv(e, t), e.tagName === "INPUT") return;
...
function Av(e, t) {
	...
	for (let e = 0; e < a.length; e++) {
		...
		let d = jv(t), f = jv(n);
		if (d.length === f.length && d.length > 0) for (let e = 0; e < d.length; e++) kv(d[e], f[e]);
		else Mv(t, n);
	}
	return !0;
}
...
var Nv = null, Pv = 0, Fv = 0, Iv = null, Lv = null;
function Rv(t, n = {}) {
	Nv = t, Iv = n.onStatus ?? null, Lv = n.onError ?? null, document.getElementById("previewPin")?.addEventListener("change", (t) => {
		...
		e.theme = t.target.value, zv();
	}), document.getElementById("btnResetWorld")?.addEventListener("click", () => {
		let t = e.previewRoot;
		t && (e.activeWorld[t] = null, e.paramOverrides[t] = {}), r(), zv();
	});
}
function zv(e = 280) {
	window.clearTimeout(Fv), Fv = window.setTimeout(() => {
		Bv();
	}, e);
}
async function Bv() {
	let t = ++Pv;
	if (!e.root || !e.entry || !Nv) return;
	let n = e.previewRoot;
	if (!n && e.previewMode === "primary") {
		Iv?.("Select a component to preview");
		return;
	}
	ev(), Lv?.(null), Iv?.("Baking…");
	try {
		let r = await wv();
		if (!r) throw Error("WASM bake unavailable — run npm run build:wasm");
		let { filesJson: i, entry: a } = Cv({
			...(await d(e.root, e.entry)).files ?? {},
			...e.files
		}, e.entry), o = e.theme || "", s = (e.catalogue?.hostParams?.length ?? 0) > 0, c = s ? "Default" : "", l = JSON.stringify(s ? e.hostFacts ?? {} : {}), u, f;
		e.previewMode === "gallery" && e.editFile ? (u = L_(e.editFile, e.files, e.catalogue), !u.length && n && (u = [n])) : f = n || void 0;
		let m = performance.now(), h;
		if (u && u.length > 1) {
			let t = { components: {} };
			for (let n of u) {
				let s = Hv(e.paramOverrides[n] ?? {}), u = r.bake_component_sources(i, a, n, o, JSON.stringify(s), c, l, void 0), d = JSON.parse(u);
			...
			let t = f || u?.[0];
			if (!t) {
				Iv?.("Nothing to preview");
				return;
			}
			let n = Hv(e.paramOverrides[t] ?? {}), s = r.bake_component_sources(i, a, t, o, JSON.stringify(n), c, l, void 0);
			h = JSON.parse(s), f = t, u = void 0;
		}
		let g = Math.round(performance.now() - m);
		if (t !== Pv) return;
		let _ = {};
		if (f && e.activeWorld[f] && (_[f] = e.activeWorld[f]), u) for (let t of u) e.activeWorld[t] && (_[t] = e.activeWorld[t]);
		let v = await p({
			bake: h,
			component: f,
			componentNames: u,
		...
		Vv(v.html), Iv?.(`Preview · wasm · bake ${g}ms`), Lv?.(null);
	} catch (e) {
		if (t !== Pv) return;
		let n = e instanceof Error ? e.message : String(e);
		Lv?.(n), Iv?.("Preview failed");
	}
}
function Vv(e) {
	if (!Nv) return;
	let t = Nv.contentDocument;
...
function Wv() {
	...
	t.hidden = !1, t.innerHTML = n.map((e) => {
		...
		return `<label>${Gv(e.name)} <select data-host="${Kv(e.name)}"><option value="">Auto</option>${t.map((e) => `<option value="${Kv(e)}">${Gv(e)}</option>`).join("")}</select></label>`;
	}).join(""), t.querySelectorAll("select").forEach((t) => {
		t.addEventListener("change", () => {
			let n = t.getAttribute("data-host");
			n && (t.value ? e.hostFacts[n] = t.value.startsWith(".") ? t.value : `.${t.value}` : delete e.hostFacts[n], zv());
		});
	});
}
function Gv(e) {
...
//#endregion
//#region src/main.js
var qv = "pdl-studio-recent-v1", Jv = "pdl-studio-last-v1", Yv = document.getElementById("welcome"), Xv = document.getElementById("workspace"), Zv = document.getElementById("openDialog"), Qv = nv({ onSelect: fy }), $v = av({
	onChange: () => {
		$v.renderWorld(), zv();
	},
	onSampleClick: (e) => {
	...
	e.editFile = t, Z_(), n && Q_(n), Qv.renderNavigator(), _y();
} });
hv({ onGoto: (t) => {
	if (!t.file) return;
	let n = Object.keys(e.files).find((e) => e === t.file || e.endsWith(`/${t.file}`) || t.file.endsWith(e)) || t.file;
	e.files[n] && (e.editFile = n, Z_(), t.line && $_(t.line), Qv.renderNavigator(), _y());
} }), q_(document.getElementById("editorMount"), {
	onChange: () => {
		_y(), zv(450);
	},
	onGoto: (t, n, r) => {
		e.files[t] && (e.editFile = t, r && (e.selectedSymbol = r), Z_(), $_(n), Qv.renderNavigator(), ey.renderCompanion(), _y());
	}
}), Rv(document.getElementById("previewFrame"), {
	onStatus: (e) => {
		document.getElementById("statusLeft").textContent = e;
	},
	onError: (t) => {
		gv(t, { file: e.editFile || void 0 });
	}
	...
	e.addEventListener("click", () => {
		...
		}), document.getElementById("dockWorld").hidden = t !== "world", document.getElementById("dockNotes").hidden = t !== "notes", t === "notes" && ey.renderCompanion();
	});
	...
	t.addEventListener("click", () => {
		...
		}), document.getElementById("app").dataset.mode = e.mode, e.mode === "prototype" && dy(), Qv.renderNavigator(), ey.renderCompanion(), zv(), _y();
	});
}), document.getElementById("btnOpen")?.addEventListener("click", () => iy()), document.getElementById("btnWelcomeOpen")?.addEventListener("click", () => iy()), document.getElementById("openCancel")?.addEventListener("click", () => Zv.close()), document.getElementById("btnReload")?.addEventListener("click", () => void ly()), document.getElementById("openForm")?.addEventListener("submit", async (e) => {
	e.preventDefault();
	let t = document.getElementById("openRoot").value.trim(), n = document.getElementById("openEntry").value.trim() || void 0, r = document.getElementById("openError");
	try {
		if (r.hidden = !0, o() && !confirm("Discard unsaved changes and open another project?")) return;
		await cy(t, n), Zv.close();
	} catch (e) {
		r.hidden = !1, r.textContent = e instanceof Error ? e.message : String(e);
	}
}), document.getElementById("btnSave")?.addEventListener("click", () => void hy());
var ty = document.getElementById("btnExport"), ny = document.getElementById("exportMenu");
ty?.addEventListener("click", () => {
	ny.hidden = !ny.hidden;
}), document.addEventListener("click", (e) => {
	!ny || ny.hidden || e.target === ty || ny.contains(e.target) || (ny.hidden = !0);
}), ny?.querySelectorAll("[data-export]").forEach((t) => {
	t.addEventListener("click", async () => {
		...
		try {
			...
			by(t.filename, t.content, t.mime), yy(`Exported ${t.filename}`), _v();
		} catch (t) {
			gv(t instanceof Error ? t.message : String(t), { file: e.editFile || void 0 });
		}
	});
}), window.addEventListener("keydown", (e) => {
	let t = e.metaKey || e.ctrlKey;
	if (t && e.key === "s") e.preventDefault(), hy();
	else if (t && e.key === "o") e.preventDefault(), iy();
	else if (t && e.key === "k") {
		e.preventDefault();
		let t = document.getElementById("navSearch");
		t?.focus(), t?.select();
	} else e.key === "Escape" && (ny.hidden = !0, Zv.open && Zv.close());
}), n(() => {
	_y(), $v.renderWorld(), ey.renderCompanion();
});
async function ry() {
	sy();
	let e = await c(), t = document.getElementById("starterList");
	t.innerHTML = (e.starters ?? []).map((e) => `<li><button type="button" data-root="${e.root}" data-entry="${e.entry}"><strong>${xy(e.label)}</strong><span>${xy(e.description || e.root)}</span></button></li>`).join(""), t.querySelectorAll("button").forEach((e) => {
		e.addEventListener("click", () => {
			cy(e.getAttribute("data-root"), e.getAttribute("data-entry"));
		});
	});
	try {
		let e = localStorage.getItem(Jv);
		if (e) {
			let t = JSON.parse(e);
			t?.root && await cy(t.root, t.entry);
		}
	} catch {}
}
function iy() {
	e.rootDisplay && (document.getElementById("openRoot").value = e.rootDisplay), Zv.showModal(), document.getElementById("openRoot")?.focus();
}
function ay() {
	try {
		let e = localStorage.getItem(qv), t = e ? JSON.parse(e) : [];
...
function oy(e, t, n) {
	let r = [{
		...
		label: n,
		at: Date.now()
	}, ...ay().filter((t) => t.root !== e)].slice(0, 6);
	localStorage.setItem(qv, JSON.stringify(r));
}
function sy() {
	let e = document.getElementById("recentList"), t = document.getElementById("recentHeading"), n = ay();
	if (!n.length) {
		e.hidden = !0, t.hidden = !0;
		return;
	}
	e.hidden = !1, t.hidden = !1, e.innerHTML = n.map((e) => `<li><button type="button" data-root="${Sy(e.root)}" data-entry="${Sy(e.entry || "design.pdl")}"><strong>${xy(e.label || e.root)}</strong><span>${xy(e.root)}</span></button></li>`).join(""), e.querySelectorAll("button").forEach((e) => {
		e.addEventListener("click", () => {
			cy(e.getAttribute("data-root"), e.getAttribute("data-entry"));
		});
	});
...
async function cy(t, n) {
	document.getElementById("statusLeft").textContent = "Opening…", _v();
	let r = await l(t, n);
	e.root = r.root, e.rootDisplay = r.rootDisplay, e.rootLabel = r.rootLabel, e.entry = r.entry, e.files = { ...r.files }, e.baselines = { ...r.files }, e.dirty.clear(), e.activeWorld = {}, e.paramOverrides = {}, e.hostFacts = {}, e.theme = "", e.previewPinned = !1, document.getElementById("previewPin").checked = !1;
	try {
		e.catalogue = await u(e.root, e.entry, gy());
	} catch (t) {
		e.catalogue = null, gv(t instanceof Error ? t.message : String(t));
	}
	Yv.hidden = !0, Xv.hidden = !1, document.getElementById("btnSave").disabled = !1, document.getElementById("btnExport").disabled = !1, document.getElementById("btnReload").disabled = !1, uy(), Uv(), Wv(), Qv.renderNavigator(), Z_(), e.selectedSymbol && e.selectedSymbol !== "__tokens__" && Q_(e.selectedSymbol), $v.renderWorld(), ey.renderCompanion(), _y(), await Bv(), localStorage.setItem(Jv, JSON.stringify({
		root: e.rootDisplay || e.root,
		entry: e.entry
	})), oy(e.rootDisplay || e.root, e.entry, e.rootLabel), sy();
}
async function ly() {
	if (!e.root || o() && !confirm("Discard unsaved changes and reload from disk?")) return;
	let t = e.rootDisplay || e.root, n = e.entry;
	await cy(t, n), yy("Reloaded from disk");
}
function uy() {
	let t = e.catalogue;
	if (!t) return;
	if (e.mode === "prototype") {
		let e = (t.components ?? []).find((e) => t.componentRoles?.[e] === "screen");
		if (e) {
			py(e);
			return;
		}
	}
	let n = L_(e.entry, e.files, t);
	if (n.length === 1) {
		py(n[0]);
		return;
	}
	for (let e of [
		...
		"IosPhone",
		"UsageRulesLab"
	]) if (t.components?.includes(e)) {
		py(e);
		return;
	}
	let r = (t.components ?? []).find((e) => !t.componentRoles?.[e]) || t.components?.[0];
	r ? py(r) : (e.editFile = e.entry, e.previewRoot = null, e.selectedSymbol = null);
}
function dy() {
	let t = e.catalogue, n = (t?.components ?? []).find((e) => t.componentRoles?.[e] === "screen");
	n && !e.previewPinned && py(n);
}
function fy(t) {
	...
	if (t.kind === "foundation" || t.name === "__tokens__") {
		...
		e.selectedSymbol = "__tokens__", e.editFile = n, Z_(), Qv.renderNavigator(), ey.renderCompanion(), _y();
		return;
	}
	if (t.kind === "samples" && t.name) {
		for (let [n, r] of Object.entries(e.files)) if (RegExp(`\\bsamples\\s+${t.name}\\b`).test(r)) {
			e.selectedSymbol = t.name, e.editFile = n, Z_(), Q_(t.name), Qv.renderNavigator(), ey.renderCompanion(), _y();
			return;
		}
	}
	if (t.kind === "theme" && t.name) {
		e.theme = t.name, Uv(), zv();
		return;
	}
	(t.kind === "symbol" || t.kind === "samples") && t.name && py(t.name, t.file);
}
function py(t, n) {
	e.selectedSymbol = t, e.editFile = n || Qv.resolveComponentFile(t) || Object.keys(e.files).find((n) => RegExp(`\\b(component|page|screen)\\s+${t}\\b`).test(e.files[n])) || e.editFile || e.entry, e.previewPinned || (e.previewRoot = t), Z_(), Q_(t), Qv.renderNavigator(), $v.renderWorld(), ey.renderCompanion(), _y(), zv(50);
}
function my(t) {
	if (e.editFile = t, e.selectedSymbol = null, Z_(), !e.previewPinned) {
		let n = L_(t, e.files, e.catalogue);
		n.length === 1 ? (e.previewRoot = n[0], e.selectedSymbol = n[0], Q_(n[0])) : n.length > 1 && (n.includes(e.previewRoot) || (e.previewRoot = n[0]), e.selectedSymbol = e.previewRoot);
	}
	Qv.renderNavigator(), $v.renderWorld(), ey.renderCompanion(), _y(), zv(50);
}
async function hy() {
	if (ev(), !e.root || !e.dirty.size) {
		yy(e.root ? "Nothing to save" : "");
		return;
	}
	let t = [...e.dirty];
	for (let n of t) {
		let t = e.files[n];
		if ((await f(e.root, n, t, e.baselines[n])).conflict) {
			gv(`Conflict saving ${n}: file changed on disk. Use Reload to discard local edits.`, { file: n });
			return;
		}
		e.baselines[n] = t, a(n);
	}
	try {
		e.catalogue = await u(e.root, e.entry, {}), Uv(), Wv(), Qv.renderNavigator(), $v.renderWorld(), ey.renderCompanion(), _v();
	} catch (e) {
		gv(e instanceof Error ? e.message : String(e));
	}
	_y(), yy(`Saved ${t.length} file(s)`);
}
function gy() {
	let t = {};
...
function _y() {
	...
	document.getElementById("statusRight").textContent = e.root ? `${e.mode}${r} · ${e.dirty.size} dirty` : "", vy();
}
function vy() {
	...
	t.hidden = !1, t.innerHTML = `<strong>Host events</strong> ${[...i].map(xy).join(" · ")} <span class="hint">— inbound from the runtime, not parent emits</span>`;
}
function yy(e) {

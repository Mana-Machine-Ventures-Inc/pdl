...
**Programmatic Design Language** — text source of truth for design systems.
...
| **[Doc architecture](./DOC_ARCHITECTURE.md)** | How these docs are maintained |

```bash
npm run docs:gen          # regenerate symbol + error pages
npm run docs:gen:check    # fail if generated docs are stale
```

...
**Stance (2026-08-16):** `<>` receives (host inbound + ancestor sinks). `emits <P>` sends (channels, API params, `[P]` slots). Examples below that write `component C <SubnavItem>` should be read as `emits <SubnavItem>`.  

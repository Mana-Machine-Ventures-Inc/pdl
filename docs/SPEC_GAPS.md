...
| [`PROPOSAL_HOST_ENVIRONMENT.md`](./PROPOSAL_HOST_ENVIRONMENT.md) | **Proposed** 2026-08-16 | Unified `host(params) [mount]`, `<Host>`, `host["k"]` probes; `theme` vs `catalog` (same remap IR, user vs host roles) |

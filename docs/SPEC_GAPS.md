...
| [`PROPOSAL_PDL_STUDIO.md`](./PROPOSAL_PDL_STUDIO.md) | **Proposed** 2026-08-25 — **S1 + Canvas P0/P1** | `apps/studio/` (`npm run studio`): project open/save, System\|Files nav, World panel, modes, WASM→HTML preview, export, **Canvas** layers/inspector with surgical `.pdl` rewrite. S2+ (samples table, Structure overlay, spatial compose) still open. |

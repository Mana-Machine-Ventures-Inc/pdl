...
| [`PROPOSAL_PDL_STUDIO.md`](./PROPOSAL_PDL_STUDIO.md) | **Proposed** 2026-08-25 | Project authoring product: persistence, role navigator, World panel, modes (Design / Prototype / Review), export; reuses Playground bake→HTML stack. Phase S1 MVP scoped; not implemented. |

...
| [`PROPOSAL_PDL_STUDIO.md`](./PROPOSAL_PDL_STUDIO.md) | **Proposed** 2026-08-25 — **S1 scaffold** | `apps/studio/` (`npm run studio`): project open/save, System\|Files nav, World panel, modes, WASM→HTML preview, export. S2+ (companion dock, samples table, Structure) still open. |

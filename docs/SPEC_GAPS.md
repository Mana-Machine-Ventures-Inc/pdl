...
| [`PROPOSAL_ROUTING_PAGES_SCREENS.md`](./PROPOSAL_ROUTING_PAGES_SCREENS.md) | **Proposed** 2026-08-16 | `page` / `screen` roles; prelude `Presenter`; `emits(propagation: .parent \| .ancestors)`; screen-as-parent bare `channel(…) =` (not `Protocol.channel`). Plan: [`IMPLEMENTATION_PLAN_ROUTING_PAGES_SCREENS.md`](./IMPLEMENTATION_PLAN_ROUTING_PAGES_SCREENS.md). |

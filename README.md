...
| `node dist/cli.js catalogue <entry.pdl> [--theme Name] [--out file.json]` | Emit **Component Catalogue** JSON (`full-spec.md` §16): **`tokensByTheme`**, name-keyed **`variantTypes`** / **`components`**, **`variantTypeName`** on variant params, trees, deltas. |
